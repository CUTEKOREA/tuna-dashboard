...
export default function SasKrSuperTuna() {
  return (
    <WidgetCard
      ...
      description="선망 가다랑어를 ULT로 횟감급 전환 — 부가가치 3배·마진 +30%"
      pillar="S2"
      telemetry={{ status: 'STATIC', syncDate: '2018' }}
      cardDesc="동원산업 슈퍼튜나 초저온 동결 기술·수익성 — 아시아경제 2018 단독·국내특허 10-1800430"
      takeaway={{
        ...
        actionPlan: "슈퍼튜나는 한국 원양 선단의 '볼륨→밸류업' 전략 템플릿입니다. ① 대량 선망 어획(가다랑어)의 일부를 ULT 횟감급으로 전환하면 같은 어획량에서 마진을 30%+ 끌어올릴 수 있으므로, 선단의 -45~-60℃ 초저온 동결 capex를 '비용'이 아닌 '마진 레버'로 평가하십시오. ② 통조림 저마진 경쟁(태국 등)을 회피하고 사시미급 프리미엄으로 이동하는 구조 전환의 실증 사례이므로, 신규 선망선 건조·동결설비 투자 시 슈퍼튜나 비중 확대를 밸류업 테제로 삼으십시오. ③ 해외(대만·필리핀·태국) 특허로 기술 해자를 구축한 점은 M&A·라이선스 가치로도 환산됩니다.",
