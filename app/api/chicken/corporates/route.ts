...
export async function GET() {
  const data = {
    ...
    title: '글로벌 Top 티어 양계 기업 지배구조 (Corporate Hegemony)',
    ...
    sit: '[Corporate Telemetry] 브라질의 JBS, BRF 등 빅3는 방대한 자국 사료를 기반으로 수출의 97%를 저가 냉동 원육에 의존합니다. 반면 태국의 CPF, GFPT, Betagro 등 수직계열화 대기업들은 조류인플루엔자 청정국 지위를 무기로 일본/유럽향 고부가가치 조리육(Processed)에 생산 캐파를 올인하고 있습니다.',
    strat: '[Executive Pivot] Silla Co.는 브라질 JBS/BRF의 단순 원물 유통 마진의 한계에서 벗어나, 태국 GFPT(신규 도축장 일 15만수 가동) 및 Betagro(친환경 스마트팩토리) 등 가공 스펙-인(Spec-in)에 특화된 태국 선도 기업들과의 독점 소싱 파트너십을 최우선으로 추진해야 합니다.',
    reliability: 84,
