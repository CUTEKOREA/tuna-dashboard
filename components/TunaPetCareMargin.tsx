...
return (
  ...
  const situation = '원어 가공 시 가식부 비중은 어종·공정별로 40~60% 범위에 분포(Klomklao & Benjakul 2016). 본 위젯은 가식부 48% / 부산물 52% 모델 케이스를 기준으로 합니다. 전통 통조림 마진은 1~9%대 박스권인 반면, 부산물(뼈·내장 등)을 가공한 \'프리미엄 펫케어 및 해양 바이오\' 부문은 28.5%(추정·증권사 리포트 재확인 대기) 매출총이익률을 달성하며 새로운 수익 채널로 부상.';
  const takeaway = '수산 회사의 정체성을 \'식품 통조림 제조사\'에서 \'해양 바이오/헬스케어 원료 공급사\'로 재정의해야 합니다. 부산물(중량 40~55% 범위)을 펫푸드용 고단백 원료나 화장품용 해양 콜라겐으로 전환하기 위한 R&D 시설 투자를 집행하고, 기존 제약/바이오 기업과의 조인트 벤처(JV)를 조속히 추진하여 수율을 현금화해야 합니다.';
