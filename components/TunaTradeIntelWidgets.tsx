    ...
    <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', minHeight: '480px' }}>
      ...
      <div style={{ marginTop: 'auto' }}>
        <TakeawayBox
          ...
          actionPlan="[FTA 극대화] 태국·인도네시아 원산지 원료 사용 시 AKFTA 원산지 증명서 발급으로 관세 0% 확보. 미국 수출 시 KORUS FTA 활용으로 경쟁사 대비 6%p 가격 우위 확보."
    ...
    <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', minHeight: '480px' }}>
      ...
      <div style={{ marginTop: 'auto' }}>
        <TakeawayBox
          ...
          actionPlan="[포지셔닝] 태국 원료 의존도를 에콰도르·인도네시아로 분산하고, 미국·EU·일본 3대 소비 시장에 대한 프리미엄 가공품 수출 파이프라인을 구축하여 밸류체인 상위 이동."
...
export const WitsTradeFlowWidget = React.memo(function WitsTradeFlowWidget() {
  ...
  return (
    <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', minHeight: '480px' }}>
      ...
      <div style={{ marginTop: 'auto' }}>
        <TakeawayBox
          situation="[구조적 적자] 한국 황다랑어 수입액은 5년 연속 증가($285M→$372M), 수출은 $17.5M에 불과. 수입 의존율 95% 이상으로 공급 차질 시 가격 급등 리스크."
          actionPlan="[공급 다변화] 인도네시아·에콰도르 신규 공급선 확보로 태국 의존도 완화. 장기 선물 계약으로 가격 변동성 헤지."
