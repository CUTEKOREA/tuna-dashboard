  ...
  return (
    <div style={{
      ...
      <TakeawayBox
        ...
        actionPlan="단순 H&G 원물 무역에서 벗어나, 선상 가공(Single-Frozen) 능력을 확보하거나 해당 물량을 장기 입도선매하여 최고급 백색육 시장(B2C 프리미엄 마켓)용 필렛 공급망을 확충할 경우 경쟁사 대비 마진율(Premium Spread)을 취할 수 있습니다."
      />
    </div>
  );
}
