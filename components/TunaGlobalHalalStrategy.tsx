    ...
    <div className={styles.card}>
      ...
      <div className={styles.cardBody}>
        ...
        <TakeawayBox 
          ...
          actionPlan="**[Actionable Insight]** 1) 인도네시아/말레이시아 타겟팅을 위한 JAKIM(말레이시아 할랄) 또는 MUI(인도네시아 할랄) 인증 획득을 최우선 추진합니다. 2) 현지 피시소스 1위 브랜드들과 B2B 원료(베이스 액) 납품 계약을 체결하여 마케팅 비용 없이 시장 파이를 확보해야 합니다. (Conviction Buy)" 
