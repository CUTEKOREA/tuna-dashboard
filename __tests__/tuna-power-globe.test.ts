...
const NUMERALS = [
  'Ⅰ', 'Ⅱ', 'Ⅲ', 'Ⅳ', 'Ⅴ', 'Ⅵ', 'Ⅶ', 'Ⅷ', 'Ⅸ', 'Ⅹ',
  'ⅩⅠ', 'ⅩⅡ', 'ⅩⅢ', 'ⅩⅣ', 'ⅩⅤ', 'ⅩⅥ', 'ⅩⅦ', 'ⅩⅧ', 'ⅩⅨ', 'ⅩⅩ', 'ⅩⅩⅠ', 'ⅩⅩⅡ', 'ⅩⅩⅢ', 'ⅩⅩⅣ', 'ⅩⅩⅤ', 'ⅩⅩⅥ', 'ⅩⅩⅦ', 'ⅩⅩⅧ', 'ⅩⅩⅨ', 'ⅩⅩⅩ', 'ⅩⅩⅪ', 'ⅩⅩⅫ', 'ⅩⅩⅩⅢ', 'ⅩⅩⅩⅣ', 'ⅩⅩⅩⅤ', 'ⅩⅩⅩⅥ', 'ⅩⅩⅩⅦ', 'ⅩⅩⅩⅧ', 'ⅩⅩⅩⅨ',
];

describe('좌표 원장', () => {
  it('39편 전부가 본사 핀을 갖는다', () => {
    expect(HQ_POINTS).toHaveLength(39);
