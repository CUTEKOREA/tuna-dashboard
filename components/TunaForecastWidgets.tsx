...
return (
    <div className={styles.insightCard}>
      ...
      <TakeawayBox
        ...
        actionPlan="**[Actionable Insight]** [선제 매입 전략] Q2 내 가다랑어 원어 3개월분 선제 매입을 통해 톤당 $150~200 매입원가(COGS) 절감이 가능합니다. 동시에 태국/에콰도르 대체 공급선 확보와 WCPO 외 인도양(IOTC) 쿼터 확보를 병행하여 공급 리스크를 분산해야 해야 합니다. (Conviction Buy)"
