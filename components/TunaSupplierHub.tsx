...
const COUNTRIES = [
  { code: '태국', flag: '🇹🇭', label: 'Thailand' },
  { code: '베트남', flag: '🇻🇳', label: 'Vietnam' },
  { code: '인도네시아', flag: '🇮🇩', label: 'Indonesia' },
  { code: '중국', flag: '🇨🇳', label: 'China' },
  { code: '에콰도르', flag: '🇪🇨', label: 'Ecuador' },
  { code: '한국', flag: '🇰🇷', label: 'South Korea' },
];
...
const TunaSupplierHub = React.memo(function TunaSupplierHub() {
  ...
  useEffect(() => { fetchFacilities(selectedCountry); }, [selectedCountry]);
            ...
            {facilities.slice(0, 8).map((f, idx) => (
              ...
              >
                <div>
                  ...
                  <div style={{ fontSize: '0.68rem', color: '#4a5568', marginTop: '2px' }}>
