    ...
    <div style={glassContainerStyle}>
      ...
      <div style={{ marginTop: '20px' }}>
        <TakeawayBox
          ...
          actionPlan="글로벌 총 생산량의 Cap(상한선)이 닫혀 있으므로 볼륨(Volume) 확대를 통한 매출 성장은 불가능합니다. 단순 원물(H&G) 수입상 포지션을 즉시 철회하고, 제한된 쿼터에서 명란/연육 등 마진을 극대화하는 고부가가치 가공업체(Value-Adder)로 비즈니스 중심축(Pivot)을 서둘러야 합니다."
    ...
    <div style={glassContainerStyle}>
      ...
      <div style={{ marginTop: '20px' }}>
        <TakeawayBox
          ...
          actionPlan="러시아산 명태의 품질 상향 평준화는 PEF에게 강력한 차익거래(Arbitrage) 기회를 제공합니다. 가성비가 입증된 러시아산 선상급랭(FAS) 필렛 및 연육의 아시아/유럽 제3국 수출 판권을 선점하는 글로벌 무역상사 롤업(Roll-up) 전략이 유효합니다. 기존 북미산 원료 의존도를 다변화하여 러시아산 가공품을 활용한 글로벌 트레이딩 유통망을 공략함으로써 원가 절감 및 글로벌 EBITDA 마진 확장을 도모해야 합니다."
    ...
    <div style={glassContainerStyle}>
      ...
      <div style={{ marginTop: '20px' }}>
        <TakeawayBox
          ...
          actionPlan="미국 알래스카산 정식 인증(MSC) 블록 원료의 세계적 희소성이 치솟고 있습니다. 저가 러시아산에만 의존하던 기존 포트폴리오를 개편하고, 단가 상승 저항 조항을 포함한 미국산 프리미엄 원물 서플라이 체인을 최우선으로 사수하십시오."
