  ...
  return (
    <div style={{
      ...
      <TakeawayBox
        ...
        actionPlan="**[Actionable Insight]** 러시아 제재나 환율 변동 시 국내 물가는 직격탄(명태 연쇄 품귀 현상)을 맞습니다. 알래스카(미국) 및 글로벌 우회루트 다변화를 추진함과 동시에, 조만간 도입될 HSK 10단위 세분화 관리(필레, 연육, 명란 엄격 구분) 및 식약처 방사능 검사에 선제 대비할 규제(Compliance) 민첩성 강화가 필수입니다."
      />
    </div>
  );
}
