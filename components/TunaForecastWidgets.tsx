  ...
  return (
    <div className={styles.insightCard}>
      ...
      <TakeawayBox
        ...
        actionPlan="3중 방어 전략으로 ① 환율 헷지: 3개월 선물환 계약으로 ₩1,400 이하 환율 락인, ② FTA 우회: 한-ASEAN FTA 활용 태국 경유 관세 최적화(0% 적용), ③ ECOS/KCS API 실시간 모니터링 체계 구축으로 환율·관세 변동 즉시 대응 프로토콜을 가동해야 합니다."
