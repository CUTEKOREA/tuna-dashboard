  ...
  <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', height: '100%', flexShrink: 0 }}>
    ...
    <div style={{ flexShrink: 0, marginTop: '12px' }}>
      <TakeawayBox 
        ...
        actionPlan="방어 기제로 '자연산(Wild-Caught) 100%' 프리미엄 헤리티지 마케팅을 강화하거나, 블렌딩용 식물성 단백질 소싱 라인을 선제 구축하십시오." 
      />
    </div>
  </div>
);
  ...
  <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', height: '100%', flexShrink: 0 }}>
    ...
    <div style={{ flexShrink: 0, marginTop: '12px' }}>
      <TakeawayBox 
        ...
        actionPlan="향후 5년 내 배양육 원가가 상업 궤도에 돌입합니다. 당사 어획 할당량(Quota) 자산을 매각하기 전 피보팅(Pivoting) 파트너를 모색하십시오." 
      />
    </div>
  </div>
);
  ...
  <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', height: '100%', flexShrink: 0 }}>
    ...
    <div style={{ flexShrink: 0, marginTop: '12px' }}>
      <TakeawayBox 
        ...
        actionPlan="선상 폐기물을 '마리아나 트렌치(Mariana Trench)'와 같은 펫 영양식 브랜드 라인업으로 업사이클링하여 영업외수익을 극대화하십시오." 
      />
    </div>
  </div>
);
  ...
  <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', height: '100%', flexShrink: 0 }}>
    ...
    <div style={{ flexShrink: 0, marginTop: '12px' }}>
      <TakeawayBox 
        ...
        actionPlan="수작업(Candling)을 전면 폐기하고, $50,000 상당의 초분광 카메라 AI 비전 장비를 도입하면 통과 클레임을 0건으로 소멸시킬 수 있습니다." 
      />
    </div>
  </div>
);
  ...
  <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', height: '100%', flexShrink: 0 }}>
    ...
    <div style={{ flexShrink: 0, marginTop: '12px' }}>
      <TakeawayBox 
        ...
        actionPlan="해조류 배합률을 높인 차세대 에코 사료 원료를 개발하여, 스위스 Nestle/네슬레 등 빅 기업에 탄소저감 명목으로 +12% 할증 프라이싱을 거십시오." 
      />
    </div>
  </div>
);
  ...
  <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', height: '100%', flexShrink: 0 }}>
    ...
    <div style={{ flexShrink: 0, marginTop: '12px' }}>
      <TakeawayBox 
        ...
        actionPlan="단순 선원 복지를 넘어, 본사 서버와 선단의 실시간 고대역폭 연결을 통해 태풍 우회 연비를 월간 $22,000 절감하는 작전사령부를 구축하십시오." 
      />
    </div>
  </div>
);
  ...
  <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', height: '100%', flexShrink: 0 }}>
    ...
    <div style={{ flexShrink: 0, marginTop: '12px' }}>
      <TakeawayBox 
        ...
        actionPlan="거물을 던지기 전 수중자율드론(ROV/소나 탑재)을 미리 투척하여 적중률을 98%로 끌어올리면 연간 유류비를 75% 파괴할 수 있습니다." 
      />
    </div>
  </div>
);
  ...
  <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', height: '100%', flexShrink: 0 }}>
    ...
    <div style={{ flexShrink: 0, marginTop: '12px' }}>
      <TakeawayBox 
        ...
        actionPlan="어선 선단을 추가 매입하는 낡은 관행을 당장 멈추고 현금을 전부 비축하여, 폭락장에 나온 물류AI 기업을 저점 인수(Bolt-on)하십시오." 
      />
    </div>
  </div>
);
  ...
  <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', height: '100%', flexShrink: 0 }}>
    ...
    <div style={{ flexShrink: 0, marginTop: '12px' }}>
      <TakeawayBox 
        ...
        actionPlan="2027년까지 가공 인력의 100%를 무인 오토 핀본 절단기로 오버라이드해야만 글로벌 Top 5 마진 지배력을 유지할 수 있습니다." 
      />
    </div>
  </div>
);
  ...
  <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', height: '100%', flexShrink: 0 }}>
    ...
    <div style={{ flexShrink: 0, marginTop: '12px' }}>
      <TakeawayBox 
        ...
        situation="글로벌 선두 수산기업은 어획 비중을 45% 이하로 강제 억제하고, 대신 고수익 B2C 가공과 헬스케어 바이오매스에서 영업이익을 흡수합니다."
        actionPlan="우리 회사의 정체성을 '어업 회사'에서 '해양 단백질 플랫폼 프로바이더'로 승격하십시오. 이 시각이 향후 10년 생존을 좌우합니다." 
      />
    </div>
  </div>
);
