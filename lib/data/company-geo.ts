...
export const HQ_POINTS: GeoPoint[] = [
  ...
  { company: 'ghana', numeral: 'ⅩⅩⅩⅨ', kind: 'hq', label: '테마 어항 — 두 캐너리 소재지', country: '가나',
    lat: 5.6277, lng: 0.0095,
    basis: 'ⅩⅩⅩⅨ · Tema Fishing Harbour, 테마(테마 어항 단위 근사 좌표) · 이 편은 회사가 둘이고 둘 다 같은 항구에 있다 — 번지가 붙은 쪽은 Pioneer Food Cannery 하나뿐이다(Plot No. 10/11, Fishing Harbour, P.O. Box 40, Tema · 타이유니언 56-1 One Report 2025 자회사 명부) · Cosmo Seafoods 는 공시·유럽연합 목록이 도시(Tema)까지만 적고 인증기관 회사카드가 「Tema Main Harbour」로 적는다',
    note: '핀이 하나인 것은 편이 하나이기 때문이지 법인이 하나여서가 아니다 — 카드 키 ghana 는 Cosmo Seafoods 와 Pioneer Food Cannery 두 법인을 함께 본다 · 두 공장의 정확한 부지 경계는 확정되지 않았다. 유럽연합 제3국 시설 목록은 도시까지만 적고 번지를 적지 않으며, 가나 자유무역지대청 사이트는 2026-09-14 관측 시점 HTTP 500 이었다 · Cosmo 의 「자유무역지대 기업」은 회사 자칭뿐이고 정부 명부로 확인되지 않았다' },
  { company: 'azores', numeral: 'ⅩⅬ', kind: 'hq', label: '아소르스 — 다섯 캔공장(대표 좌표 라부드페이시)', country: '포르투갈',
  ...
  { company: 'mauritius', numeral: 'ⅩⅬⅡ', kind: 'hq', label: 'Princes Tuna (Mauritius) Ltd — 리슈테르', country: '모리셔스',
  ...
  // ── ⅩⅬⅣ Chicken of the Sea — 등기 본사와 공장이 3.000 km 떨어져 있다 ──────
  //    규칙 1 대로 등기 본사를 hq 로, 생산이 일어나는 라이언스를 plant 로 따로 찍는다.
  //    엘세군도에는 사무실만 있고 캔은 조지아에서 채워진다 — 한 핀으로 묶으면
  //    「미국 브랜드가 미국 어디서 만드는가」라는 물음이 지워진다.
  //    피츠버그 사무실(2024-02 개소 · 2026-03 확장)은 생산이 아니라 사무실이라 찍지 않는다.
  { company: 'cosi', numeral: 'ⅩⅬⅣ', kind: 'hq', label: 'Tri-Union Seafoods 등기 본사 — 엘세군도', country: '미국',
    lat: 33.9187, lng: -118.3820,
    basis: 'ⅩⅬⅣ · 발행본 §03 의 등기 본사 「2150 E Grand Ave Suite 500, El Segundo, CA 90245」 · 모회사 연결재무제표 종속기업표도 Tri-Union Seafoods 의 사무실을 엘세군도로 적고 공장만 조지아주 라이언스로 적는다 · 2025-02-07 미국 식품의약국 회수 공고의 발신지도 엘세군도다 · 좌표는 E Grand Ave 의 도로 단위 근사값이고 건물의 정확한 위치가 아니다',
    note: '사무실이 있는 곳이지 캔이 채워지는 곳이 아니다 — 생산 핀은 조지아주 라이언스에 따로 있다 · 브랜드를 가진 법인의 이름은 Chicken of the Sea 가 아니라 Tri-Union Seafoods LLC 이고 Thai Union Group PCL 이 중간 지주 Thai Union North America 를 통해 100 % 든다 · 2024-02 에 연 피츠버그 사무실(2026-03 에 1만 4.000 ft² 로 확장)은 사무실이라 찍지 않았다 · 법인 등기 번호와 설립 주는 이 편이 닫지 못한 여덟 물음 가운데 하나다' },
  // ── ⅩⅬⅤ Kingfisher — 등기 본점은 방콕 사무실, 공장은 세 도(道) ──────────
  //    이 그룹은 흔히 「사뭇사콘 회사」로 불리지만 네 법인의 등기 본점은 방콕 야나와의
  //    사무실 한 층이다. 생산 핀은 사뭇사콘 나디·사뭇쁘라깐 방푸·송클라에 따로 찍는다.
  { company: 'kingfisher', numeral: 'ⅩⅬⅤ', kind: 'hq', label: 'Kingfisher Holdings 등기 본점 — 방콕 야나와', country: '태국',
    lat: 13.6963, lng: 100.5395,
    basis: 'ⅩⅬⅤ · 발행본 §01 의 등기 본점 「방콕 야나와 판자타니 타워 22층」 · 태국 상업등기 네 법인(0105515000918 · 0105516001322 · 0105528040476 · 0105532031214)이 같은 빌딩 같은 층을 본점으로 적는다 · 좌표는 논시로(路) 도로 단위 근사값이고 건물의 정확한 위치가 아니다',
    note: '사무실이 있는 곳이지 참치를 다루는 곳이 아니다 — 생산 핀은 나디·방푸·송클라에 따로 있다 · 일본 상장사 Umios 가 이 법인의 의결권 50,70 %(간접 7,47 %)를 쥐고, 사업회사 SEAPAC·KF Foods 는 100,00 % 전부 간접이다 · 다만 이 법인은 순수 지주회사가 아니다: 일본 공시가 이 법인을 두고 관계회사에 제품을 판다고 적고, 태국 등기 업종은 냉동수산물 제조이며, 송클라에 유럽연합 승인번호 1035 를 가진 자체 공장이 있다 · 사업회사 둘의 주식을 실제로 누가 쥐는지는 태국 주주명부에서만 나오고 그 명부는 유료다' },
  // ── ⅩⅬⅥ CAPSEN — 부두에 사무실만 있고 공장은 없다 ───────────────────
  //    조업 법인이라 **PLANT_POINTS 에 행을 두지 않는다.** 같은 부두의 캔 공장은 이 회사가
  //    아니라 S.C.A(편 ⅩⅩⅩⅧ · 동원산업 60 %)의 것이고 그 핀은 그 편이 따로 갖는다.
  //    두 법인을 같은 점으로 겹쳐 찍으면 조업 49 %와 가공 60 %가 한 회사로 읽힌다.
  { company: 'capsen', numeral: 'ⅩⅬⅥ', kind: 'hq', label: 'CAPSEN 본점 — 다카르 몰 10 부두', country: '세네갈',
    lat: 14.6800, lng: -17.4200,
    basis: 'ⅩⅬⅥ · 발행본 §01 의 본점 「Nouveau Quai de Peche Mole 10 BP 782, Dakar」(동원산업 2025 사업보고서 계열회사 현황) · 국제대서양참치보존위원회 선박 상세도 PONT SAINT LOUIS 의 소유자 주소를 「Quai de Pêche - Môle 10, Dakar」로 적어 같은 부두를 가리킨다 · **좌표는 다카르 어항 구역의 근사값이고 부두·건물의 정확한 위치가 아니다** — 몰 10 의 지번을 적은 공개 문서를 찾지 못했다',
    note: '사무실이 있는 곳이지 캔이 채워지는 곳이 아니다 — 이 회사는 가공 설비를 갖지 않는다. 같은 부두의 캔 공장은 별개 법인 S.C.A(편 ⅩⅩⅩⅧ · 동원산업 60 %)의 것이고 이 편의 핀이 아니다 · 동원산업 지분은 49,00 %(735주 / 1.500주)이고 그 숫자는 세네갈 해상운송법 loi n°2002-22 제91조가 자본의 51 % 이상을 현지 국민 소유로 요구해 생긴 천장이다 — 소수주주라서가 아니다 · 연결 근거는 동원산업 계열 가운데 유일하게 「실질지배력보유」이고, 남은 765주의 주인을 공시는 열한 해 동안 한 번도 적지 않았다 · 「동원산업의 사업부」는 해양관리협의회 보도자료의 표현이고 틀렸다: 별개 세네갈 법인이다' },
  // ── ⅩⅬⅦ Bounty Seafood — 등기 주소는 있고 공장은 없다 ─────────────
  //    **PLANT_POINTS 에 행을 두지 않는다.** 파푸아뉴기니 참치 가공장을 이름으로 적는
  //    명부 넷(유럽연합 제3국 승인시설·해양관리협의회 유통관리·돌고래 안전·수산업협회)
  //    어디에도 이 회사가 없다. 같은 라에 말라항의 캔 공장은 Majestic(편 ⅩⅩⅩⅦ)의 것이고
  //    그 핀은 그 편이 따로 갖는다 — 필지도 다르다(Majestic 640 · 이 회사 679).
  { company: 'bounty', numeral: 'ⅩⅬⅦ', kind: 'hq', label: 'Bounty Seafood 등기 사무소 — 라에 말라항 Portion 679', country: '파푸아뉴기니',
    lat: -6.7050, lng: 147.0100,
    basis: 'ⅩⅬⅦ · 발행본 §02 의 등기 사무소 「PORTION 679, MALAHANG INDUSTRIAL AREA, LAE, MOROBE PROVINCE」(파푸아뉴기니 투자진흥청 공개 등기, 회사 등록 1-80688) · **좌표는 말라항 공단 구역의 근사값이고 679필지의 위치가 아니다** — 필지 경계를 적은 공개 문서를 찾지 못했다(토지청 등기 열람 유료)',
    note: '등기 사무소가 있는 곳이지 캔이 채워지는 곳이 아니다 — **이 회사는 가공 설비를 갖지 않는다.** 회사 등록 1-80688 은 Registered 이고 외국인기업 인증 93137 은 2026-01-11 자로 Cancelled 다: 투자진흥법 제25조 2항이 인증 없는 외국기업의 영업을 금하고 제36조 3항이 취소 뒤 청산 목적의 한시 영업만 남긴다(취소 사유는 공개되지 않는다) · 679필지에 지금 무엇이 있는지는 공개 기록에 없다. 돌아가는 공장들의 필지는 Majestic 640 · IFC 361 · Nambawan 667 로 모두 다른 번호다 · **「동원산업이 파푸아뉴기니에서 사라졌다」로 읽지 않는다** — 수산업협회 회원명부가 `Dongwon Industries Co., Limited — Purse Seine Fishing Operation` 으로 적고, 수산청 2025-02-17 성명은 **마당**의 RD Tuna Canners 재편을 받치는 쪽에 그 이름을 적는다(라에가 아니다). 없는 것은 회사가 아니라 자기 이름의 공장이다' },
  // ── ⅩⅬⅧ RD Corporation — 이 나라에서 실제로 돌아가는 공장이다 ─────
  //    같은 라에·마당 편들과 달리 **PLANT_POINTS 에 행을 둘 수 있는 거점**이지만, 이 시리즈의
  //    공장 핀은 편마다 하나씩만 두므로 HQ 핀으로 마당 공장 자리를 잡는다.
  //    필리핀 탐블러(Philbest)는 별도 핀을 두지 않는다 — 한 편에 두 나라 거점이 있을 때는
  //    그 편의 축이 선 쪽(마당)에 핀을 둔다.
  { company: 'rd', numeral: 'ⅩⅬⅧ', kind: 'hq', label: 'R.D. Tuna Canners — 마당 Portion 1004', country: '파푸아뉴기니',
    lat: -5.2100, lng: 145.7900,
    basis: 'ⅩⅬⅧ · 발행본 §03 의 공장 주소 「Portion 1004, Siar, North Coast Road, Madang」(파푸아뉴기니 투자진흥청 공개 등기, 회사 등록 1-22587) · 유럽연합 제3국 승인시설 목록의 08EPR001 행이 같은 주소를 적는다 · **좌표는 마당 시아르 해안 구역의 근사값이고 15,77 ha 부지의 경계가 아니다**',
    note: '정격 200 t/일에 실제 처리 120 t/일(가동률 60 %)이고 로인 30·캔 90 으로 갈린다. 제관 설비와 어분 플랜트, 자가발전 5,2 MW 를 갖는다 · **유럽연합 승인번호 08EPR001 로 조제품을 실을 수 있다** — 그 통로는 경제동반자협정 원산지 의정서 Ⅱ 제6조 6항 (b)의 전면적 조달 예외를 쓰고 **원료의 국적을 묻지 않는다**(2019년 이 공장에 붙은 어선 15척 중 13척이 현지기반 외국선) · 같은 그룹의 필리핀 탐블러 공장(승인번호 1652)은 GSP+ 로 무관세이되 **어선의 기국·등록·소유를 따진다** · **같은 번지에 2010년 등록된 Niugini Tuna Limited(1-74521)가 연차보고를 한 번도 내지 않고 2023-12-05 말소**됐다 — 등기의 다수주주 칸이 비어 있어 소유는 확인되지 않는다',
    },
  // ── ⅩⅬⅨ SolTuna — 이 나라에 하나 있는 승인 가공공장이다 ─────
  //    등기본점은 호니아라 회계사무소(C/- Abacus)로 옮겨졌지만 공장과 회사장부는 노로에 남아 있다.
  //    지구본은 **돌아가는 공장 자리**를 잡는다. 선단 법인 NFD 는 같은 편이라 별도 핀을 두지 않는다.
  { company: 'soltuna', numeral: 'ⅩⅬⅨ', kind: 'hq', label: 'SolTuna — 노로 1 Tuna Drive', country: '솔로몬제도',
    lat: -8.2380, lng: 157.1990,
    basis: 'ⅩⅬⅨ · 발행본 §01 의 유럽연합 명부 공장 주소 「1 Tuna Drive, Noro」(유럽연합 제3국 승인시설 목록, 승인번호 SI-02-01-001 · 활동 PP) · 회사등기 1000021 · **좌표는 뉴조지아섬 노로 시가의 근사값이고 공장 필지의 경계가 아니다**',
    note: '유럽연합이 이 나라에서 가공공장으로 승인한 시설은 이곳 하나다 · **2021~2025년 유럽연합이 들여온 솔로몬제도산 참치 조제품은 해마다 조리 로인 100,00 %**이고 캔·소매 세목은 0이다(Comext CN8) — 캔은 역내·태평양 매대로 간다 · 지분은 Tri-Marine International 51,0000 %와 국가·공공 세 곳 48,999995 %(SINPF·ICSI·서부주)이고 **선단 법인 NFD 에는 국가 몫이 0 %**다 · **한 마을에 계통이 두 개다** — 공장 디젤 자가발전 2,4 MW(3 × 800 kW) 옆에 Solomon Power 노로 계통(고객 973호, 2025-12)이 따로 있다 · 竿釣는 2024년에 멈췄고(국가 어획 1.283 t → 0) 채낚기 인증 범위는 남아 있다',
    },
  // ── Ⅼ PAFCO — 정부가 99,6 %를 쥔 레부카 캐너리 ─────
  //    본사 사무소는 수바 Laucala Beach 에도 있지만 공장과 유럽연합 승인 주소는 레부카다. 지구본은 공장 자리를 잡는다.
  { company: 'pafco', numeral: 'Ⅼ', kind: 'hq', label: 'PAFCO — 레부카 Beach Street', country: '피지',
    lat: -17.6830, lng: 178.8350,
...
export const PLANT_POINTS: GeoPoint[] = [
  ...
  // ── ⅩⅩⅩⅨ 가나 테마 — 공장 둘. 같은 어항이고 법인이 다르다 ─────
  //    크기 축에 능력을 올리지 않는다. **두 공장 다 면적·라인·능력이 0건**이다.
  //    올릴 수 있는 값은 PFC 쪽 고용 하나뿐이고, 그것도 공장이 아니라 모회사가
  //    나라 단위로 낸 수치다(가나에 그 그룹 법인이 이 공장 하나라 공장 값으로 읽는다).
  //    Cosmo 쪽은 고용조차 2020년 현지 매체의 한 점이 전부라 크기를 비워 둔다 —
  //    한쪽만 점이 크게 찍히는 것은 규모 차이가 아니라 **공시 양식의 차이**다.
  { company: 'ghana', numeral: 'ⅩⅩⅩⅨ', kind: 'plant', label: '테마 어항 캔공장(Pioneer Food Cannery)', country: '가나',
    lat: 5.6252, lng: 0.0068, sizeValue: 1289, sizeUnit: '명',
    basis: 'ⅩⅩⅩⅨ · Plot No. 10/11, Fishing Harbour, P.O. Box 40, Tema(테마 어항 단위 근사 좌표) · 유럽연합 승인 GS/SF/EF038(캔) · GS/SF/E061(어유 추출 · 2021-10 발행본부터 신규 등재) · 가나 자유무역지대 허가 1996-11-07 「FOOD PROCESSING (TUNA CANNING)」 · 크기 값 1,289명은 **능력이 아니라 FY2025 고용**이다(타이유니언 지속가능성 데이터북의 나라별 인원 — 가나에 그 그룹 법인이 이 공장 하나다)',
    note: '고용은 FY2022 951 → FY2023 1,252 → FY2024 1,576 → FY2025 1,289명이다 · 부지·건물 면적과 라인 수·속도는 원문 0건이고, 능력은 과거값(1997년 관측 39,000 t/년)과 계획값만 있어 크기 축에 올리지 않았다 · **「건물은 갖고 땅은 갖지 않는다」** — 2024-08-04 타이유니언 유럽 운영이사가 건물 구조물은 소유지만 토지·냉동창고·창고·지게차·트럭이 없고 쓰는 기계조차 리스라고 말했다(냉동창고는 2024-08 자사 8,000 t 개장) · 자유무역지대청 기업 페이지의 국적 칸이 American 인데 지금의 소유 사슬과 맞지 않는다 — 1996년 등록 당시 값이 갱신되지 않은 것으로 읽히지만 원문이 그렇게 적지는 않는다 · 1959년경 테마 가공공장과 이 공장을 동일시한 원문은 없다' },
  { company: 'ghana', numeral: 'ⅩⅩⅩⅨ', kind: 'plant', label: '테마 어항 캔공장(Cosmo Seafoods)', country: '가나',
    lat: 5.6304, lng: 0.0128,
    basis: 'ⅩⅩⅩⅨ · 테마(Tema) — 신라교역 「계열회사 개요」가 「가나공화국 테마에 위치」까지만 적고, 유럽연합 제3국 시설 목록도 City Tema / Greater Accra 까지만 적는다(테마 어항 단위 근사 좌표) · 유럽연합 승인 GS/SF/E070(2013-09-04) · GS/SF/E103(2014-01-08 · 2019-08-05 발행본부터 시설명이 Ichiban Seafoods 에서 이 회사로 바뀐다) · 인증기관 회사카드는 「Tema Main Harbour」로 적는다',
    note: '크기가 없다 — **면적·라인·능력·생산 실적이 전부 원문 0건**이고 고용은 2020년 현지 매체의 한 점이 전부다. 신라교역은 관계기업의 요약재무만 싣고 인원을 적지 않는다(지분 23.84% 라 연결 대상이 아니다) · **승인번호가 둘이라고 공장이 지금 둘이라고 쓰지 않는다** — 2016-01-01 에 Ichiban Seafoods 를 흡수합병했고 목록에는 시설명 변경으로만 남았는데, 목록이 도시까지만 적어 한 부지인지 두 부지인지 확정되지 않는다. 「합병했으니 공장도 합쳤다」도 원문에 없다 · 회사 자칭 주소는 GAFCO Industrial Park, Tema Main Harbour, PMB 85 이고 「자유무역지대 기업」도 회사 자칭뿐이다 — 가나 자유무역지대청 사이트가 2026-09-14 관측 시점 HTTP 500 이라 정부 명부로 확인하지 못했다' },

  // ── ⅩⅬ 아소르스 — 공장 다섯 + 본토 대조군 하나 ─────────────────────
  //    크기 축은 **2024년 보전 대상 역내산 톤수**(역내산 신청액 ÷ 171 €/t)다. 처리 능력이 아니다.
  //    다섯 공장 다 면적·라인·능력이 공개 자료 0건이라 능력으로는 크기를 줄 수 없고,
  //    다섯이 같은 산식으로 잰 값은 이것 하나다. 그래서 신청액이 가장 큰 COFACO 가
  //    가장 작은 점으로 찍힌다 — 그것이 이 편의 축이지 공장 규모의 순서가 아니다.
  //    ⚠ 같은 '톤/년' 단위의 다른 편 값(능력·생산 실적)과 성격이 다르다. 전역 최댓값
  //    108,000 톤/년 으로 나뉘어 다섯 점이 거의 최소 크기로 보인다.
  //    공동체산은 한도가 신청액에서 되살아나지 않아 톤으로 바꾸지 않았다.
  { company: 'azores', numeral: 'ⅩⅬ', kind: 'plant', label: '라부드페이시 캔공장(COFACO Açores)', country: '포르투갈',
    lat: 37.8140, lng: -25.5850, sizeValue: 245.8, sizeUnit: '톤/년',
    basis: 'ⅩⅬ · Rua Heróis da Faína do Bacalhau, Rabo de Peixe, Ribeira Grande(상미겔섬 · 도로 단위 근사 좌표) · 승인시설 목록(SIPACE) C 211 2 P · 크기 값 245.8 t 은 **처리 능력이 아니라 2024년 보전 대상 역내산 톤수**다(역내산 신청액 42,028.72 € ÷ 171 €/t · 다섯 중 최소)',
    note: '보전 대상 역내산 톤수이지 처리 능력이 아니다 · 2021~2024 신청액 5,382,219 € 가 나머지 넷의 합보다 크고 그 가운데 5,167,254 € 가 공동체산 코드다(승인액 기준 역내산 비중 8.72 %) · 면적·라인은 공개 자료 0건이고 처리량은 회사 사이트의 「연 5천만 캔」(전사인지 불명)뿐이다 · 2023-12-19 피쿠 어업회사 COMPICO(NIPC 512018081)를 흡수했다 · 2018년 6월 피쿠 공장을 닫았다(162명)' },
  { company: 'azores', numeral: 'ⅩⅬ', kind: 'plant', label: '칼례타 캔공장(Santa Catarina · SCA 운영)', country: '포르투갈',
    lat: 38.6010, lng: -28.0200, sizeValue: 949.5, sizeUnit: '톤/년',
    basis: 'ⅩⅬ · Fajã Grande, Calheta(상조르즈섬 · 도로 단위 근사 좌표) · 승인시설 목록 C 213 1 P(운영사 SCA – Sociedade Conserveira Açoriana, Lda 명의) · 크기 값 949.5 t 은 **처리 능력이 아니라 2024년 보전 대상 역내산 톤수**다(역내산 신청액 162,363.82 € ÷ 171 €/t · 다섯 중 최대)',
    note: '보전 대상 역내산 톤수이지 처리 능력이 아니다 · 소유는 아소르스 공기업 Lotaçor(2009-01-20 지분 99.73 % 를 1 € 에 취득)이고 2022-08-01 부터 SCA 가 임차 운영한다 — 계약서 초안 10년 + 5년, 지분 매수옵션 5,000,000 € · 승인액 기준 역내산 비중 57.50 %, 2024년 한 해 신청액 기준 35.13 % · 처리량은 「연 약 2,000 t」 자칭·언론 수치뿐이고 면적·라인은 0건이다(설비형 사업 적격 지출 102만 € 를 받고도 그렇다)' },
  { company: 'azores', numeral: 'ⅩⅬ', kind: 'plant', label: '카부다프라이아 캔공장(Pescatum)', country: '포르투갈',
    lat: 38.7080, lng: -27.0560, sizeValue: 342.3, sizeUnit: '톤/년',
    basis: 'ⅩⅬ · Cabo da Praia, Praia da Vitória(테르세이라섬 · 도로 단위 근사 좌표) · 승인시설 목록 AAF 107 · 크기 값 342.3 t 은 **처리 능력이 아니라 2024년 보전 대상 역내산 톤수**다(역내산 신청액 58,534.67 € ÷ 171 €/t)',
    note: '보전 대상 역내산 톤수이지 처리 능력이 아니다 · 2021~2024 신청액 2,133,771 € 로 다섯 중 둘째, 승인액 기준 역내산 비중 23.00 % · 주주 미공시 · 면적·라인·능력은 공개 자료 0건 · 해마다 비중이 5 %에서 100 %까지 오가고 한 해치 행은 날짜 기재가 의심스럽다' },
  { company: 'azores', numeral: 'ⅩⅬ', kind: 'plant', label: '빌라프랑카두캄푸 캔공장(Sociedade Corretora)', country: '포르투갈',
    lat: 37.7150, lng: -25.4340, sizeValue: 445.5, sizeUnit: '톤/년',
    basis: 'ⅩⅬ · Vila Franca do Campo(상미겔섬 남쪽 해안 · 도로 단위 근사 좌표) · 승인시설 목록 C 215 1 P(명의 Sociedade Correctora, Lda.) · 크기 값 445.5 t 은 **처리 능력이 아니라 2024년 보전 대상 역내산 톤수**다(역내산 신청액 76,174.52 € ÷ 171 €/t)',
    note: '보전 대상 역내산 톤수이지 처리 능력이 아니다 · 승인액 기준 역내산 비중 100.00 % — 공동체산 신청 0 · 네 해 신청액 498,075 € 는 전체 규모로는 작지만 역내산만 떼면 COFACO 네 해 역내산 214,965 € 의 두 배가 넘는다 · 처리량은 「연 약 2천 t」 자칭뿐이고 면적·라인은 0건 · 라부드페이시 COFACO 와 같은 섬이고 직선거리로 20 km 가 안 된다' },
  { company: 'azores', numeral: 'ⅩⅬ', kind: 'plant', label: '마달레나 캔공장(Conseran)', country: '포르투갈',
    lat: 38.5300, lng: -28.5270, sizeValue: 547.4, sizeUnit: '톤/년',
    basis: 'ⅩⅬ · Madalena do Pico(피쿠섬 · 도로 단위 근사 좌표) · 승인시설 목록 A 3718(신선 + 냉동·가공) · 크기 값 547.4 t 은 **처리 능력이 아니라 2024년 보전 대상 역내산 톤수**다(역내산 신청액 93,609.50 € ÷ 171 €/t)',
    note: '보전 대상 역내산 톤수이지 처리 능력이 아니다 · 2023년분부터 명부에 나타나 네 해가 아니라 두 해다(신청액 220,195 € · 승인액 기준 역내산 비중 71.20 %) · 2023년경 약 1,500만 € 로 세운 공장으로 보도됐고 전직 COFACO 직원 40명을 뽑았다고 보도됐다 — COFACO 가 2018년 같은 섬의 공장을 닫은 뒤다 · 면적·라인·능력은 공개 자료 0건' },
  // Ramirez 는 이 편의 대조군이다. 아소르스 다섯과 지분·운영 관계가 없고 보전금 제도의 대상도 아니다.
  // 그래도 「캔은 어디서 만들어지는가」 층에 답하는 실제 캔공장이고 주소가 승인시설 목록으로 확정돼 찍는다.
  // 크기는 비운다 — 다섯의 크기 축(역내산 톤수)이 본토 공장에는 정의되지 않고, 설비 수치는 보도뿐이다.
  { company: 'azores', numeral: 'ⅩⅬ', kind: 'plant', label: '라브라 캔공장(Ramirez · 본토 대조군)', country: '포르투갈',
  ...
  // ── ⅩⅬⅡ 모리셔스 — PTM 사업장 둘, 크기 없음 ──────────────────────
  //    크기를 비운다. 하루 240 t·220 t 도 면적·라인도 전부 **회사 자칭**이고, 같은 회사
  //    팩트시트의 합산(하루 430 t)이 사업장별 값의 합(460 t)과 맞지 않는다.
  //    Mer des Mascareignes(프리포트 구역)는 찍지 않는다 — 2024년 폐쇄·청산이다.
  //    Indico Canning(DVS/FP8/MU)도 찍지 않는다 — PTM 의 DVS/FP4/MU 와 같은 Marine Road
  //    주소에 승인만 따로 올라 있고, 물리적으로 다른 건물인지를 말하는 원문이 없다.
  { company: 'mauritius', numeral: 'ⅩⅬⅡ', kind: 'plant', label: 'PTM 리슈테르 (캔)', country: '모리셔스',
    lat: -20.1425, lng: 57.5310,
    basis: 'ⅩⅬⅡ · 발행본 §01 표 승인 DVS/TF/1 「New Trunk Road, Riche Terre, Pamplemousses · 조리·캔 어류 · 2014-10-24」(러시아 수의당국 수입허가 명부 · 도로 단위 근사 좌표) · 발행본 §08 설비표가 이 사업장을 캔(스테이크·청크·샌드위치·플레이크) 전용으로 적고 1999년 신공장이라 적는다',
    note: '크기가 없다 — 하루 240 t · 캔 라인 7(소매 6 · 급식 1) · 하루 100만 캔 이상 · 부지 29.254 m² · 공장 15.732 m² 는 전부 회사 페이지 값이고, 같은 회사 팩트시트의 합산(하루 430 t · 연 103.000 t · 면적 33.000 m²)이 두 사업장 값의 합(460 t · 공장 23.332 m² · 부지 50.479 m²)과 맞지 않는다 · 사업장 단위 유형자산 장부가·전력·용수·폐수 사양·부지 소유 여부는 어느 공개 문서에도 없다 · 2024-10-29 임금 재조정분 미지급을 이유로 이 사업장에서 연좌 농성이 있었다' },
  { company: 'mauritius', numeral: 'ⅩⅬⅡ', kind: 'plant', label: 'PTM 마린로드 메르루즈 (로인·파우치·캔)', country: '모리셔스',
    lat: -20.1538, lng: 57.4985,
    basis: 'ⅩⅬⅡ · 발행본 §01 표 승인 DVS/FP4/MU 「Marine Road, Mer Rouge, Port Louis · 냉동 어류 · 조리·캔 어류 · 2020-04-24(캔)」(러시아 수의당국 수입허가 명부 · 도로 단위 근사 좌표) · 발행본 §08 설비표가 프리쿡 냉동 로인·급식 파우치·병·벤트레스카 캔으로 적고 2015년 3월 Thon des Mascareignes 합병으로 편입됐다고 적는다',
    note: '크기가 없다 — 하루 220 t · 부지 21.225 m² · 공장 7.600 m² 는 회사 페이지 값이다. 합병 전 Thon des Mascareignes 의 「하루 최대 250 t · 1.623명」은 연도 표기가 없는 업계 회사정보라 220 t 과 나란히 쓰면 같은 대상을 두 번 세게 된다 · 같은 Marine Road 주소에 Indico Canning(DVS/FP8/MU · 영국 Princes 간접 68 %의 별개 법인)의 승인이 따로 올라 있으나 건물이 나뉘는지는 원문에 없어 핀을 따로 찍지 않았다 · 2026-02-20 노동조합 CTSP 가 이 공장 앞에서 집회를 열었고 노조는 한 곳에 1.000명 넘게 일한다고 말했다' },
  // ── ⅩⅬⅣ Chicken of the Sea — 미국 공장 하나, 크기 없음 ────────────────
  //    크기를 비운다. 인력 값 넷(2009 약정 200 · 2014 업계지 350 · 2021 회사 발언 280 초과 ·
  //    2025 일간지 250)은 한 기관이 같은 방식으로 센 것이 아니라 시계열이 아니고,
  //    명판 능력·라인 대수·부지 면적은 어느 공개 문서에도 없다. 실적성 수치 셋도
  //    단위와 기간이 달라(연 400만 케이스 · 하루 3만 6.000 케이스 · 2.600만 캔) 한 자에 못 놓는다.
  { company: 'cosi', numeral: 'ⅩⅬⅣ', kind: 'plant', label: '라이언스 캔공장 (조지아주 툼스 카운티)', country: '미국',
    lat: 32.2046, lng: -82.3221,
    basis: 'ⅩⅬⅣ · 발행본 §05 설비표의 위치 「조지아주 툼스 카운티 라이언스 · 전에 창호회사가 쓰던 건물」(2009-05-04 주지사 발표 · 2009-10 가동) · 모회사 연결재무제표 종속기업표도 Tri-Union Seafoods 의 공장 소재지를 조지아주 라이언스로 적는다 · 좌표는 라이언스 시 단위 근사값이고 부지의 정확한 위치가 아니다 — 부지 면적과 번지는 공개 문서에서 확인되지 않는다',
    note: '크기가 없다 — 인력 값 넷(2009년 약정 200 · 2014년 업계지 350 · 2021년 회사 발언 280 초과와 창고 25 · 2025년 일간지 약 250)은 세는 방식이 달라 한 자로 잰 시계열이 아니고, 명판 능력·라인 대수·분당 속도·부지 면적은 어느 공개 문서에도 없다 · 이 공장은 배를 대지 않고 자숙 설비도 두지 않는다. 주 환경보호국 허가의 공정 목록은 입고 → 해동 → 손질·조미 → 캔 충전 → 레토르트 → 출고이고 원료는 프리쿡 로인이다 — 통마리를 로인으로 바꾸는 공정은 이 공장 밖, 대개 다른 나라에서 끝난다 · 규모를 재는 유일한 공개 자는 폐수 허가(살포 최대 0,42 MGD · 공공처리장 방류 최대 0,30 MGD)이고 그것은 물의 양이지 참치의 양이 아니다 · 2025년 관세 뒤 주 5일에서 주 4일로 내려갔고 모회사는 일부 품목을 태국·가나로 옮긴다고 적었다' },
  // ── ⅩⅬⅤ Kingfisher — 세 도(道)에 흩어진 공장 ────────────────────────
  //    일본 유가증권보고서의 주요 설비 표는 세 줄 모두 소재지를 사뭇사콘으로 적는다.
  //    방푸(사뭇쁘라깐)는 그 표에 행이 없다 — 값이 섞인 것이 아니라 실리지 않았다.
  //    그래서 나디에만 장부가·인원을 달고 방푸·송클라는 크기를 비운다.
  { company: 'kingfisher', numeral: 'ⅩⅬⅤ', kind: 'plant', label: '나디 공장 (사뭇사콘)', country: '태국',
    lat: 13.5570, lng: 100.2980,
    basis: 'ⅩⅬⅤ · 발행본 §04 설비표 · 증서 주소 「1 Moo 4, Baan-plaiklongkru Rd., Nadee, Muang, Samutsakorn 74000」(BRCGS BRCFD 694136 · MSC-C-53413) · 유럽연합 제3국 승인번호 KF Foods 1283 · SEAPAC 2050 · 일본 제82기 유가증권보고서 주요 설비 표의 「サムットサコン県」 세 줄 · 좌표는 나디 면(面) 단위 근사값이고 부지의 정확한 위치가 아니다',
    note: '한 부지에 법인 셋이 겹친다 — 땅과 설비를 지주회사가 갖고(토지 16만 6.000 ㎡ · 장부가 15억 3.300만 엔) SEAPAC·KF Foods 에 빌려준다 · 2026년 3월 31일 장부가는 SEAPAC 33억 3.000만 엔, KF Foods 19억 6.300만 엔이다(줄마다 백만 엔 단위로 반올림해 세 줄 합이 표시 합계와 2백만 엔 어긋난다) · 인원은 SEAPAC 정사원 1.028명[임시 3.287명], KF Foods 572명[2.070명], 지주회사 9명 · 같은 부지의 1/24 나디에 어분·어유 공장이 있고 그 설비는 SEAPAC 줄의 「缶詰・ミール生産設備」에 들어 있다고 읽힌다 · 라인 대수·분당 속도·명판 능력은 어느 공개 문서에도 없다' },
  { company: 'kingfisher', numeral: 'ⅩⅬⅤ', kind: 'plant', label: '방푸 공장 SP-1 (사뭇쁘라깐)', country: '태국',
    lat: 13.5250, lng: 100.6470,
    basis: 'ⅩⅬⅤ · 발행본 §08 · 증서 주소 「233 Moo.4, Bangpoo Industrial Estate, Sukhumvit Road, Muang, Samutprakarn 10280」(BRCGS BRCFD 692930 · 사업장 코드 9936124) · 같은 주소가 2014-05-15 미국 식품의약국 경고장의 수신지다 · 좌표는 방푸 공업단지 단위 근사값이다',
    note: '크기가 없다 — 일본 유가증권보고서의 주요 설비 표는 세 줄 모두 사뭇사콘이라 이 공장은 그 표에 행이 아예 없고, 장부가·인원·면적을 적은 공개 문서가 없다 · 대신 감사 범위가 또렷하다: 2025-04-02 발행 증서(등급 A+ · 무예고 자발 감사 · 만료 2026-06-15)의 생산범위가 캔·파우치·스파우트파우치·플라스틱 컵에 담는 펫푸드로 끝나고 제외 항목 칸이 「없음」이다 · 같은 부지에 제관(K-CAN) 이 있다 · 옛 유럽연합 승인번호 2003 은 현행 목록에 행이 없다' },
  { company: 'kingfisher', numeral: 'ⅩⅬⅤ', kind: 'plant', label: '송클라 공장 (지주회사 지점)', country: '태국',
    lat: 7.1980, lng: 100.5950,
    basis: 'ⅩⅬⅤ · 발행본 §08 · 태국 수산청의 유럽연합 승인시설 목록(2026-07-16판) 112행 「1035 · Kingfisher Holdings · Mueang Songkhla · PP · 공표 2023-09-06」 · 러시아 검역당국 제3국 공장 등록(2022-08-31)에도 같은 번호로 오른다 · 좌표는 송클라 무앙 단위 근사값이다',
    note: '지주회사의 지점이지 별도 법인이 아니다 — 이 공장이 있기 때문에 지주회사를 순수 지주회사로 읽을 수 없다 · 냉동 오징어와 현지 어를 다루고, 장부가·인원·면적·라인은 어느 공개 문서에도 없다(일본 유가증권보고서의 주요 설비 표에 송클라 행이 없다)' },
];
...
export const FLAG_STATES: {
  ...
  { company: 'capsen',
    flags: [{ country: '세네갈', count: 4 }],
    basis: 'ⅩⅬⅥ · 국제대서양참치보존위원회 활성 선박명부(2026-09-16 추출) — 기국 세네갈·어구 선망 전 7척 가운데 소유자 칸에 이 회사 이름이 적힌 넷: GRANADA(IMO 8102907·6WLH·1,349) · WESTERN KIM(8003242·6WLN·1,525) · XIXILI(7413828·6WMG·2,201) · ORIENTAL KIM(7827495·6WNE·1,725). 톤수 합 6,800 은 세네갈 선망 7척 합 12,252 의 55.5 %',
    note: '**「배 넷」과 「선망 넷」은 다른 말이다** — 세네갈 수산가공검사국 승인 명부는 채낚기 CAP ATLANTIQUE(2020년 승인·741 GT)까지 이 회사 소속으로 적어 그 명부 기준으로는 다섯이다 · 톤수는 단위가 섞인 단순합이다: 원문이 GRANADA 만 총톤수(GT)로, 나머지 여섯은 옛 방식 총톤수(GRT)로 적는다 · **분모가 둘이다** — 55.5 %는 인증에 들지 않은 SEA BREEZE 까지 넣은 7척 기준이고 인증 시점 6척(10,323) 기준으로는 65.9 %다 · Grand Bleu 소유 둘(SEA DEFENDER·PONT SAINT LOUIS)은 같은 해양관리협의회 증서 MSC-F-31638 의 인증 단위에 들지만 이 회사 배가 아니라 여기 세지 않았다. PONT SAINT LOUIS 의 소유자는 명부가 Senegalaise de thon, 증서가 GRAND BLEU 로 갈려 둘 다 1차라 어느 쪽도 지우지 않는다 · **COSMOS KIM 은 세지 않았다** — 현행 증서 1.2판(최종 개정 2025-12-03)이 일곱째로 기국 Senegal·소유자 CAPSEN·적격일 2025-12-03 으로 적고 AIS·IRCS 칸을 비워 두는데, 국제대서양참치보존위원회 세네갈 명부에는 없다(중서부태평양 명부에서는 기국 투발루·등록소유자 TUDO Fisheries 로 있다가 2026-06-15 기국 자격 상실로 삭제). 두 문서가 어긋나는 동안에는 기국 척수에도 톤수 분모에도 넣지 않는다 — 다만 「인증 선박은 여섯」이라고만 적지도 않는다: 인증 시점이 여섯이고 현행 증서는 일곱이다' },
];
...
export const NO_FLEET: { company: string; basis: string }[] = [
  ...
  { company: 'ghana', basis: 'ⅩⅩⅩⅨ · 두 공장 다 가공사이고 선박 기재가 한 줄도 없다. 배는 같은 항구의 조업사 Panofi Company Limited(신라교역 45.00% · 2002-09-27 설립)가 갖는다 — 선상 냉동이라 배가 개별로 유럽연합 승인을 받고 Commander·Forerunner·Pathfinder·Discoverer·Master·Volunteer 가 냉동선으로 각각 번호를 단다. 2026-01-21 가나참치협회 선망 인증(MSC-F-31670)의 적격 선박 17척 가운데 Panofi 이름을 단 배가 일곱이지만 **담보로 잡힌 척수와 같은 수일 뿐 같은 배들인지는 확정되지 않는다**(담보 주석이 선명을 적지 않는다). Pioneer Food Cannery 쪽 선박은 이 편의 자료에 없다' },
  ...
  { company: 'kingfisher', basis: 'ⅩⅬⅤ · 자사 선단 기재가 한 줄도 없다. 일본 제82기 유가증권보고서의 관계회사·주요 설비 표에 선박 계정이 없고, 태국 등기 네 법인의 업종은 모두 가공·유통이다. 회사 사이트가 적는 「연안선 위치추적 검증」은 태국 국적 연안선을 사들일 때의 검증이지 소유가 아니며, 캔에 들어가는 원어 대부분은 원양에서 사 온다 · 2015년 통신사 보도도 선박 소유를 적지 않았다' },
  // ⅩⅬ azores 는 NO_FLEET 에도 FLAG_STATES 에도 넣지 않는다 — 「선단 정보 없음」 칸이다.
  //   0척이 아니다: COFACO Açores 가 2023-12-19 피쿠 어업회사 COMPICO(NIPC 512018081)를 흡수했다.
