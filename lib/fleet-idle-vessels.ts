...
export const FLEET_IDLE_NOTES: Record<string, FleetIdleNote> = {
  MOAMARI: {
    asOf: '2026-09-07',
    headline: '프로펠러 볼트 3개 파손(선장 보고서 8/18 확정) 수리차 젠산 예인 중 · 계약 항해 24~26일 · 9/7 보고에서 도착이 9/28 → 10/4 로 6일 밀림 · 항해 34일 예상 · 예인료 계약 일 $41,000, 34일 가정 시 약 139만불(19.4억원)으로 계약 대비 8~10일·$32.8~41.0만 초과 예상 · 복귀 10/14~11/8 예상 · 조업손실 약 890~1,250 MT 예상',
    lines: [
      ...
      { label: '예인 진행 (예상)', text: '8/31 출발은 확정. 도착 예정이 9/2 보고 9/29 → 9/3·9/4 보고 9/28 로 이틀 유지되다, 9/7 보고에서 10/4 로 6일 밀렸다. 항해 34일, 평균 5.7노트 환산이다(9/28 기준이던 6.7노트에서 1노트 떨어졌다). 계약 상한(26일)보다 8일·하한(24일)보다 10일 늦다. 주말 사이 속도가 더 떨어졌다는 뜻이라, 남은 구간에서 회복되지 않으면 더 밀릴 수 있다.' },
      { label: '예인료 (계약 확정 / 총액 예상)', text: '일 $41,000은 계약 확정. 총액은 항해일수에 달려 있어 예상치다 — 계약 24~26일이면 $98.4만~106.6만, 10/4 도착 기준 34일이면 약 $139만(19.4억원)이다. 9/28 기준이던 $119만에서 6일치 $24.6만(3.4억원)이 늘었다. 자금팀 추산 「약 123만불(일 5,700만원·30일 약 17억원)」은 9/29 도착 기준이라 이제 $16만가량 낮게 잡혀 있다(내포 환율 1,390원/$, 당시 시장 1,363원/$). 계약 초과 8~10일분 $32.8만~41.0만(약 4.6~5.7억원)의 부담 주체가 용선 계약서상 누구인지 확인이 먼저다.' },
      ...
      { label: '조업손실', text: '마지막 어획 8/13부터 어장 복귀까지 62~87일이다. 보고 주기(150보고일 / 235달력일)로 환산하면 40~56보고일이고, 일평균 22.43 MT를 곱해 약 890~1,250 MT다. 8/14 이후 이미 발생한 분을 포함한 값이며 MOAMARI 연간 실적 3,365 MT의 26~37%에 해당한다.' },
      { label: '확정 / 예상 구분', text: '확정은 사고 경위(8/17 접안 중 로프 감김)·프로펠러 볼트 3개 파손·출발지·도착지·일 $41,000·계약 항해 24~26일·8/31 출발이다. 프로펠러 추가 손상 여부, 도착 10/4, 항해 34일, 총 예인료 약 139만불, 수리 3~28일, 복귀 10/14~11/8, 조업손실 890~1,250 MT은 전부 예상치 또는 미확인이다. 도착 예정일은 일일보고에서 바뀐다 — 9/2 보고 9/29 → 9/3·9/4 보고 9/28 → 9/7 보고 10/4(6일 후퇴). 잠수부 점검 결과·젠산 조선소 견적·실제 도착일이 나오면 갱신한다.' },
    ],
  },
};
