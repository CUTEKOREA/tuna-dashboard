...
export const W27_KoreaFTABenefit = () => {
  ...
  return (
    <WidgetCard title="FTA 무관세 파괴력 베네핏 뷰어" icon={ShieldCheck} term="Tariff Defense" desc="국가별 관세 장벽이 수입 마진에 미치는 충격" source="관세청 수출입 무역 통계 코드(0306)" situation="[Tariff Shield Monopoly] 대한민국 새우 수입 생태계 1위 헤게모니를 베트남이 철옹성처럼 방어하는 유일무이한 핵심 무기(Moat)는 VKFTA 발효에 따른 '관세 0% 프리미엄'의 극단적 비대칭성(Asymmetry) 덕분입니다." actionPlan="[SECA Option Contingency Plan] 에콰도르와의 SECA 협상이 최종 타결될 경우 20% 관세 족쇄가 풀리며 베트남 카르텔은 붕괴(Bloodbath)됩니다. 관세 철폐 즉시 실행 가능한 남미산 대량 선물 매입 콜옵션(Call Option)을 즉각 세팅하여 사태 반전에 선제 대응하십시오.">
      <SafeResponsiveContainer width="100%" height="100%">
