      ...
      <div className={styles.card}>
        ...
        <div className={styles.cardBody}>
          ...
          <TakeawayBox 
            ...
            actionPlan="[Geopolitical Supply Hedging] 단일 어종 세계 최대 생산량(350만 톤)임에도 불구하고 공급망이 미국·러시아에 독점된 극도의 '병목(Bottleneck) 디스카운트' 상황입니다. 러-우 전쟁에 따른 서구권의 러시아산 해산물 금수 제재(Sanctions) 리스크 및 알래스카 쿼터 감축 쇼크에 대비, 아시아 제3국 경유 우회 물량의 70% 이상을 2~3년 장기 선도계약(Forward Contract)으로 즉시 락인(Lock-in)하고, 12개월분 이상의 안전 재고 비축을 위한 창고 금융(Inventory Financing) 크레딧 라인을 즉각 확대하십시오." 
          />
        </div>
      </div>
      ...
      <div className={styles.card}>
        ...
        <div className={styles.cardBody}>
          ...
          <TakeawayBox 
            ...
            actionPlan="[Margin Defense & Premiumization] 자원 회복에 대한 환상을 폐기하고, 원자재 수입 의존형 비즈니스의 치명적 약점인 '수입 물가 폭등 쇼크'를 상쇄할 B2C 마진 방어(Margin Defense)에 전사적 자원을 집중하십시오. 원가 상승분(Inflation)을 소비자 판가로 즉시 전가(Pass-through)할 수 있도록, 기존의 저단가 탕거리/통마리 유통을 폐기하고 100% '초프리미엄 HMR(저염 명란, 영유아용 뼈없는 필레, 펫푸드 연육)' 중심으로 프로덕트 믹스(Product Mix)를 전면 강제 전환해야 합니다." 
          />
        </div>
      </div>
      ...
      <div className={styles.card}>
        ...
        <div className={styles.cardBody}>
          ...
          <TakeawayBox 
            ...
            actionPlan="[Dual-Hub Tolling Strategy] 단순 중간 무역상(Trader) 지위를 탈피하여, 중국 거대 가공 밸류체인에 직접 침투(Penetration)하십시오. 중국 현지 대형 가공장과의 독점적 톨링(Tolling, 위탁가공) 계약을 체결해 프라이빗 라벨(PB) 연육 및 필레 수출 물량을 락인함과 동시에, 거시적 '미중 디커플링(De-coupling) 관세 리스크' 폭발에 대비하여 베트남/인도네시아에 30%의 대체 가공 허브(Alt-Hub) 물량을 분산 배치하는 '투-트랙 리스크 헤징'을 즉각 이사회에 상정해야 합니다." 
          />
        </div>
      </div>
      ...
      <div className={styles.card}>
        ...
        <div className={styles.cardBody}>
          ...
          <TakeawayBox 
            ...
            situation="[Value-Add Spread Extraction] 수입 대비 수출 단가 차액인 '가공 스프레드(Processing Margin Spread)' 스캐닝 결과, 독일·네덜란드 등 2차 가공 승자(Spread Winners)들은 자동화 설비를 통한 첨단 필레팅/수리미 추출로 원물 대비 톤당 $1,000~$2,500의 초과수익(Alpha)을 창출하고 있습니다. 이익의 핵심 축이 '1차 조업(Fishing)'에서 '수율 극대화 가공(High-Yield Processing)'으로 완전히 전이되었습니다."
            actionPlan="[Smart Factory Capex] 재래식 내수용 동태·코다리 유통 모델은 마진 한계(Cap)에 봉착했습니다. 저숙련 인력 기반의 국내 영세 가공 인프라를 전면 폐기하고, Baader社 등 유럽형 초정밀 자동화 필레 머신 및 AI 광학 선별기 기반의 '하이엔드 스마트 팩토리' 건립을 위한 대규모 CAPEX를 승인하십시오. 가공 수율을 단 3%만 끌어올려도 B2B 더블프로즌 블록 수출 루트를 개척하여 부가가치를 서구 리테일 체인으로 전이시켜야 합니다." 
          />
        </div>
      </div>
