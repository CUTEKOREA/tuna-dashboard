  ...
  return (
    <div className={styles.insightCard}>
      ...
      <TakeawayBox
        ...
        actionPlan="**[Actionable Insight]** [3단계 진입 전략] ① 나이지리아: 현지 캔 브랜드 라이센싱으로 마켓 선점(3년 내 점유율 5% 목표), ② UAE: 할랄 인증 + 프리미엄 라인 전개로 kg당 $2 추가 마진 확보, ③ 베트남: OEM 가공 허브로 활용하여 현지 인건비 사익을 극대화해야 해야 합니다. (Conviction Buy)"
