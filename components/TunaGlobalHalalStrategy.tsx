  ...
  return (
    <div className={styles.card}>
      ...
      <div className={styles.cardBody}>
        ...
        <TakeawayBox 
          situation="한국 참치액 시장(약 700~1,000억원 — 출처별 편차, 식약처/aT FIS 단일화 대기)은 내수 포화 단계에 진입 중이나, 글로벌 피시소스 시장($4.5B)과 할랄 시장($1.2B)은 여전히 구시대적 발효 공정과 특유의 비린내 한계를 겪고 있습니다. 참치액은 훈연 공정으로 비린내를 완화한 프리미엄 'K-피시소스'로서 품질 차별화 우위를 갖습니다."
