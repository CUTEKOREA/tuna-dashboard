    ...
    <div className={styles.card}>
      ...
      <div className={styles.cardBody}>
        ...
        <TakeawayBox 
          ...
          actionPlan="1) '산지 1차 가공 → 국내 고도화 숙성'의 글로벌 분업 모델(Global Arbitrage)을 적극 활용해 국내 중소규모 경쟁사(한라식품 등)가 따라올 수 없는 근본적인 매입원가 진입장벽을 구축해야 합니다. 2) PNG 허브를 동남아/호주로 직수출하는 전초 기지로 격상시킵니다." 
