    ...
    <div className={styles.insightCard} ref={containerRef}>
      ...
      <div style={{ marginTop: '20px' }}>
        <TakeawayBox
          ...
          actionPlan="어획(자연산) 중심의 수산업은 엄격한 글로벌 쿼터 규제로 성장이 완벽하게 차단되었습니다. 이제 성장의 유일한 돌파구는 양식/축양 비즈니스입니다. 기존 하드웨어(원양어선) 투자를 중단하고, 완전양식(Closed-cycle) 원천 기술 R&D 및 해상 가두리 인프라에 전사적 자본을 재배치해야 합니다. 특히 천연 치어 쿼터가 삭감될 경우 종묘 가격이 폭등하므로, 핵심 종묘장(Hatchery)과의 합작법인 혹은 강한 지분 투자를 통해 원물 소스를 먼저 장악해야 살아남을 수 있습니다."
        />
      </div>
    </div>
  );
