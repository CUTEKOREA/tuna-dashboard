    ...
    <div style={{
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1rem' }}>
        <div>
          <h3 style={{ 
            ...
            [Live 🟢] [판매] 인플레이션 대체 단백질 가격 (Trade-Down)
            {activeTab === 'kr' ? (
      ...
      {activeTab === 'eu' ? (
        <TakeawayBox 
          ...
          actionPlan="인플레이션 국면에서는 프리미엄 통연어 유통을 과감히 축소하고, 가격 방어력이 압도적인 소포장(Convenience) 및 PB 가공 포트폴리오를 즉각 런칭하여 판매량(Volume) 하락을 이익률(Margin)로 상쇄하는 전략이 필수적입니다."
        ...
        <TakeawayBox 
          ...
          actionPlan="단가 상승을 방어하기 위한 단순 B2B 도매 경쟁은 한계에 달했습니다. EU의 사례처럼 B2C 소포장(Convenience) 및 초밥/샐러드용 필렛(Fillet)으로 제품군을 파편화하여, 물량(Volume) 감소를 마진(Margin) 확대로 상쇄하는 가치 창출 전환이 시급합니다."
