...
/* ── 경매 가격발견 vs 직거래 부두값 — 글로벌 참치 가치배분 2층위 ──
   ...
   PNA VDS 입어료 ~$60M(2010)→2018 ~$500M(부두/렌트 가치포착 상승; 2016은 ~$350M대로 $500M은 2018 도달치).
...
export default function SasPrAuctionDirect() {
  return (
    <WidgetCard
      ...
      takeaway={{
        situation: "글로벌 참치 가격은 두 층위로 형성됩니다. 상층은 도요스(도쿄) 경매로, 일일 생물 약 200미·냉동 약 1,000미가 거래되며 신선 블루핀의 투명한 가격참조 시장 역할을 합니다(냉동 BFT는 대부분 경매를 거치지 않고 직판되어 간접 영향에 그칩니다 — PLOS One 2019는 도요스의 글로벌 가격선도를 실증하지 않으며 분석시장도 쓰키지·오타입니다). 하층은 산지 부두값·입어료(렌트)로, PNA 도서국 입어수입이 약 $60M(2010)에서 2018년 약 $500M으로 급증하며(2016년은 ~$350M대) 원물 단계 가치포착이 커졌습니다. 즉 직거래 부두값과 경매 신호는 상호 참조되며, 가치는 경매(소비지)와 부두/렌트(산지) 양 끝에서 배분됩니다.",
        ...
        source: "Nippon.com(도요스 일일 생물 ~200미·냉동 ~1,000미) / PLOS One 2019 pone.0221147(쓰키지·오타 신선 BFT 경매가 분석; 도요스 글로벌 가격선도 실증 아님 — 본 위젯은 신선 가격참조로만 인용) / PNA·FFA(VDS 입어료 ~$60M(2010)→2018 ~$500M)",
      }}
      customBody={
