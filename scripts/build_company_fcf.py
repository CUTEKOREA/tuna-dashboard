...
GROUP = [
    ...
    {"국가": "미국", "법인": "Bumble Bee Seafood · ANOVA", "분류": "자회사", "비고": "2020년 인수 · 중간지주 4개를 거친다"},
    {"국가": "캐나다", "법인": "Clover Leaf Seafood", "분류": "자회사", "비고": "Bumble Bee 그룹 하위"},
    {"국가": "파나마", "법인": "Thalassic Tuna Team", "분류": "자회사", "비고": "공식 거점 목록에 없던 법인"},
    {"국가": "일본", "법인": "FCN International Co., Ltd.", "분류": "지사", "비고": "시미즈 · 연결 보고범위"},
    {"국가": "싱가포르", "법인": "FCS Trading Fishery", "분류": "지사", "비고": "연결 보고범위"},
]
...
def main() -> int:
    ...
    must = [
        ...
        "2,296억원", "9.3억", "14.54", "15.40", "10.77", "5.98", "5.32", "4.97", "3.24",
