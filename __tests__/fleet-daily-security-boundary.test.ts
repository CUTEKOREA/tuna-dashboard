  ...
  it('publishes only aggregate values and derived quality counts', () => {
    expect(fleetDailyPublic).toEqual({
      ...
      latest: {
        ...
        asOf: '2026-08-17',
        pacific: { asOf: '2026-08-17', dailyMt: 72, monthlyMt: 2_321, annualMt: 47_153.8 },
        atlantic: { asOf: '2026-08-17', dailyMt: 175, monthlyMt: 2_940, annualMt: 29_665 },
        carrier: { loadedTotalMt: 11_492.3, expectedRemainingMt: 6_317.7 },
      },
      deltas: { pacificDailyMt: -58, atlanticDailyMt: -30, totalDailyMt: -88 },
      reconciliation: {
        pacificDaily: { reportedMt: 72, rowsMt: 72, matches: true, missingCount: 0 },
        atlanticDaily: { reportedMt: 175, rowsMt: 175, matches: true, missingCount: 0 },
