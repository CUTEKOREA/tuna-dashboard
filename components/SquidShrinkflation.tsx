    ...
    <div className={styles.glassCard}>
      ...
      <div style={{ marginTop: '20px' }}>
        <TakeawayBox
          ...
          actionPlan="**[Actionable Insight]** 물량 쿼터 달성 중심의 박리다매 전략에서 전면 탈피하여, 한정된 원물을 최고가로 전환하는 '가치 부가(Value-Adding)' 체제로 전환해야 합니다. 소형어 비중 증가에 대응해 내장/먹물을 활용한 소스, 펫푸드 상품 개발을 서두르고 중대형어 판관 단가를 극대화하기 위해 글로벌 하이엔드 어장(스시/통구이) 유통 파이프라인의 수율(Yield) 최적화 공정을 도입하여 잉여현금흐름(FCF)을 극대화하십시오. (Strong Buy)"
        />
      </div>
    </div>
  );
