...
export default function FishStatBlackholeBar() {
  return (
    <div style={{ background: 'rgba(0, 20, 40, 0.6)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px', padding: '24px', color: 'white' }}>
      ...
      <div style={{ padding: '16px', background: 'rgba(var(--w-amber-500-rgb), 0.1)', borderLeft: '4px solid var(--w-amber-500)', borderRadius: '4px', marginBottom: '24px', display: 'flex', gap: '12px' }}>
