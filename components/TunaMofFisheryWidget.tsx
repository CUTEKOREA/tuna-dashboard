    ...
    <div className={styles.insightCard}>
      ...
      <div style={{ padding: '0 20px 20px 20px' }}>
        <TakeawayBox 
          ...
          actionPlan="**[Actionable Insight]** [Premium Margin Strategy] 부산에 집중된 범용 물량은 B2B 가공용 고정 단가 계약으로 가격 변동 리스크를 헷지하십시오. 동시에, 제주 한림 위판장의 고단가 프리미엄 눈다랑어 물량은 최고가 일본 수출 및 국내 오마카세 직거래 채널로 전량 스위칭하여 마진율을 극대화해야 해야 합니다. (Conviction Buy)" 
...
export function MofTradeBalanceWidget() {
  ...
  return (
    <div className={styles.insightCard}>
      ...
      <div style={{ padding: '0 20px 20px 20px' }}>
        <TakeawayBox
          situation="[구조적 적자 지속] 참치 무역수지 월평균 -$147M 적자가 지속되고 있습니다. 12월 수입이 $210M으로 연중 최대치를 기록했으며(연말 재고 확보 수요), 수출은 $42~55M 수준에 머물러 원어 수입 의존도(Exposure)가 가속화되고 있습니다."
          actionPlan="**[Actionable Insight]** [적자 축소 전략] ① 가공 참치캔 자체 브랜드(프리미엄 라인) 수출 전환으로 톤당 부가가치 +$800 확보, ② 중동/아프리카 신시장 수출 확대로 수출액 $80M 목표, ③ 원양산 원어 직수출 비중 확대를 병행해야 해야 합니다. (Conviction Buy)"
