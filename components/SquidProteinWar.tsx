    ...
    <div className={styles.glassCard} ref={containerRef}>
      <div className={styles.cardHeader}>
        <h3 className={styles.cardTitle}>
          <Skull size={20} /> 글로벌 단백질 체급 100% 스택 전쟁 (Protein War)
          
        </h3>
        <p className={styles.cardSubtitle}>대중적 소비재에서 &apos;서민이 접근 불가능한 하이엔드 희소 자원&apos;으로의 격상</p>
      </div>
