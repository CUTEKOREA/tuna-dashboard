    ...
    <div className={styles.glassCard} style={{ borderColor: 'rgba(59, 130, 246, 0.3)', marginTop: '20px' }}>
      ...
      <div style={{ marginTop: '20px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
        ...
        <TakeawayBox
          ...
          situation="[지정학적 OPEX 리스크] 2024년 원양산업 전체가 지불한 입어료(Fishing Rights Fee)는 약 8,969만 달러(약 1,200억 원)에 달합니다. 특히 참치 선망의 경우 파푸아뉴기니(2,226만 불), 키리바시(1,991만 불) 등 태평양 도서국(PNA)에만 약 6,600만 달러(900억 원)를 지불하고 있어 최우선 원가(OPEX) 부담으로 작용합니다. 명태는 러시아에 1,129만 불, 오징어는 포클랜드에 879만 불을 지불하며 특정 연안국에 대한 극단적 의존도를 보이고 있습니다."
          actionPlan="[VDS(조업일수제도) 헤징 및 원가 통제 전략] 연간 1,200억 원의 입어료는 어획 여부와 무관한 매몰 비용(Sunk Cost) 성격을 지닙니다. 따라서 타사의 유휴 쿼터(Quota)를 인수하여 우리 측의 '척당 어획 효율(CPUE)'을 극대화하는 통폐합(Consolidation)이 유일한 원가 절감 돌파구입니다. 향후 기후변화(엘니뇨/라니냐)로 인한 어군 이동에 대비해 입어 수역을 다변화하는 헷징 플랜이 동반되어야 합니다."
        />
      </div>
    </div>
  );
