  ...
  it('publishes only aggregate values and derived quality counts', () => {
    expect(fleetDailyPublic).toEqual({
      _meta: {
        ...
        latestAsOf: '2026-08-18',
        detailSha256: expect.stringMatching(/^[a-f0-9]{64}$/),
      },
      latest: {
        reportDate: '2026-08-19',
        asOf: '2026-08-18',
        pacific: { asOf: '2026-08-18', dailyMt: 13, monthlyMt: 2_334, annualMt: 47_166.8 },
        atlantic: { asOf: '2026-08-18', dailyMt: 170, monthlyMt: 3_110, annualMt: 29_835 },
        carrier: { loadedTotalMt: 11_492.3, expectedRemainingMt: 6_317.7 },
      },
      deltas: { pacificDailyMt: -59, atlanticDailyMt: -5, totalDailyMt: -64 },
      reconciliation: {
        pacificDaily: { reportedMt: 13, rowsMt: 13, matches: true, missingCount: 0 },
        atlanticDaily: { reportedMt: 170, rowsMt: 170, matches: true, missingCount: 0 },
        carrierLoaded: { reportedMt: 11_492.3, rowsMt: 11_492.3, matches: true, missingCount: 0 },
        carrierExpectedRemaining: { reportedMt: 6_317.7, rowsMt: 6_317.7, matches: true, missingCount: 0 },
        valid: true,
        unavailableCount: 0,
        issueCount: 0,
      },
      quality: {
        counts: {
          reconciliationChecks: 548,
          reconciliationCompleteChecks: 548,
