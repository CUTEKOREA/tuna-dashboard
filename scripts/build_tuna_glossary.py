...
FOOD_SAFETY = [
    ...
    {"항목": "셀레늄", "구분": "지표", "값": "건강편익값 가다랑어 20 · 황다랑어 16 · 눈다랑어 11 · 날개다랑어 10",
     "설명": "셀레늄이 수은보다 많으면 양수, 적으면 음수다. 미국 환경보호청 지원으로 개발된 지표이며 어류 1.4만여 종을 쟀다"},
    {"항목": "셀레늄", "구분": "대조", "값": "둥근머리돌고래 고기 −82",
     "설명": "지금까지 측정된 가장 낮은 값이다. 참치와 정반대로 수은이 셀레늄보다 훨씬 많다"},
    {"항목": "셀레늄", "구분": "해석 주의", "값": "업계 매체의 주장이 섞여 있다",
     "설명": "이 지표를 근거로 「페로제도 연구가 바다생선을 잘못 지목했다」는 해석이 함께 실린다. 학계에서 합의된 결론이 아니므로 지표값과 해석을 나눠 읽어야 한다"},
