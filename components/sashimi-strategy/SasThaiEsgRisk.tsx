...
const ESG = [
  { rc: '#f59e0b', badge: 'EU IUU', title: '옐로카드 이력 (해제됨)', value: '2015.4 → 2019.1',
    desc: 'EU 불법어업(IUU) 옐로카드 3.7년 부여 후 해제. 어선 모니터링·VMS 의무화로 규제 인프라는 정비됐으나 재발 시 레드카드(EU 수출 금지) 리스크 상존.' },
  { rc: '#ef4444', badge: 'US TIP', title: '인신매매 등급 Tier 2', value: '4년 연속',
    desc: '미국 국무부 인신매매보고서(TIP) Tier 2 유지 — NGO의 Tier 3 강등 요구에도 불구. 어선 강제노동·인신매매 잔존 신호로 평가됨.' },
  ...
  return (
    <WidgetCard
      ...
      takeaway={{
        ...
        source: "EU 집행위 IP-19-61(옐로카드 해제 2019.1.8) / 美 국무부 2025 Trafficking in Persons Report(태국 Tier 2·처벌완화 법안 계류) / SeafoodSource",
      }}
      customBody={
