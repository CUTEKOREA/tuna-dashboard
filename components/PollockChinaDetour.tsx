  ...
  return (
    <div style={{
      ...
      <TakeawayBox
        ...
        actionPlan="중국 내 가공 공장을 통한 우회 물량은 서방의 '원산지 추적 법규(Traceability)'가 강화될 경우 치명적인 컴플라이언스 리스크를 안게 됩니다. 당사는 중국발 우회 명태 대신 순수 알래스카산(미국) 직반입 비중을 높이거나, 컴플라이언스가 증명된 한국/베트남 내 가공 라인 확보를 통해 서방 바이어들의 ESG 요구에 선제 대응 가능한 공급망 프리미엄을 구축해야 합니다."
      />
    </div>
  );
}
