    ...
    <div className={styles.insightCard} ref={containerRef}>
      ...
      <div style={{ marginTop: '20px' }}>
        <TakeawayBox
          ...
          actionPlan="**[Actionable Insight]** 한국은 아시아 최대의 고급 Omakase 미식 시장으로 부상했으며 수입 규모의 증가 추세가 단가 상승을 입증합니다. 매입원가 상승 압박(환율, 물류비) 방어를 위해 선물환(FX Forward) 헷징 계약 체결이 필수적입니다. 또한 일본으로의 단순 중계를 넘어 사시미/초밥 세트 가공 설비에 신규 자본을 투입하고 국내 하이엔드 호레카(HoReCa) 직납 비중을 40% 이상으로 공격적으로 끌어올려 중간 유통 부가가치를 전격 내재화해야 합니다."
        />
      </div>
    </div>
  );
