    ...
    <div className={styles.insightCard}>
      ...
      <div style={{ padding: '0 20px 20px 20px' }}>
        <TakeawayBox
          ...
          actionPlan="에콰도르 가공 자산의 밸류에이션을 재산정 필요. 중국 메가 캐너리 본격 가동(2027~) 시 에콰도르향 투자 IRR이 3~5%p 하락할 수 있습니다. 대안으로 PNG/솔로몬 제도의 EU-RoO 특혜 가공 거점을 선제 확보."
    ...
    <div className={styles.insightCard}>
      ...
      <div style={{ padding: '0 20px 20px 20px' }}>
        <TakeawayBox
          ...
          actionPlan="인도양 공급 붕괴는 '블랙스완'이 아닌 '그레이 코뿔소'입니다. 6개월 선물 계약을 체결로 매입원가를 $1,800/t 이하로 락인하십시오. 동시에 서아프리카(가나 Tema 허브) 대체 소싱 파이프라인을 즉각 가동하여 IO 의존도(Exposure)를 30% 이하로 분산해야 합니다."
