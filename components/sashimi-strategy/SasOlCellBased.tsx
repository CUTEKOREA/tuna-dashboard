...
const ITEMS = [
  ...
  { rc: '#ef4444', title: '美 배양육 판매금지 州', value: '7개주', desc: '플로리다·앨라배마·미시시피·인디애나·몬태나·네브래스카·텍사스 - 단 인디애나·텍사스는 2년 한시(2025-07~2027-06) 모라토리엄. 규제 역풍이 상업화 속도의 핵심 변수.' },
];
...
export default function SasOlCellBased() {
  return (
    <WidgetCard
      ...
      takeaway={{
        situation: "전통 참치에 대한 대체 기술이 2030을 향해 움직입니다. 식물성 참치(캔 대체) 시장은 2023년 $945.3M에서 2030년 $1.59B(연평균 7.8%, 단 그랜드뷰리서치(GVR) 단일 출처 상단추정)로 전망되고, 세포배양 수산물은 2025년 5월 Wildtype 코호 연어가 미국 FDA 'no questions' 승인을 받아 수산물 최초로 상업 경로를 열었습니다. BlueNalu는 미쓰비시상사·풀무원·타이유니온과 APAC 동맹(2023-10)을 맺어 배양 블루핀 토로를 겨냥합니다(자체 총이익률 75%는 가동 전 조건부 추정). 반면 미국 7개 주(플로리다·앨라배마·미시시피·인디애나·몬태나·네브래스카·텍사스)가 배양육 판매를 제한했는데, 인디애나·텍사스는 2년 한시(2025-07~2027-06) 모라토리엄이고 플로리다·앨라배마(2024)는 영구 금지로 주별 강도·존속기간이 갈리는 등 규제 역풍이 상업화 속도의 핵심 변수입니다.",
        ...
        source: "Grand View Research(식물성 참치 $945.3M→$1.59B CAGR 7.8% - 단일·유료 출처 상단추정, 타 기관 교차검증 미확보) / FDA·Food Dive(Wildtype 연어 2025-05-28 첫 승인) / BlueNalu·SeafoodSource(APAC MOU 미쓰비시·풀무원·타이유니온) / Food Safety Mag(배양육 금지 7개주)",
      }}
      customBody={
