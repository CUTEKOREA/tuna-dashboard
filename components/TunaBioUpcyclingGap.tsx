  ...
  return (
    <div className={styles.card}>
      ...
      <div className={styles.cardBody}>
        ...
        <TakeawayBox 
          situation="FAO 통계 및 수산과학원 조사에 따르면, 한국의 수산 부산물 업사이클링(Up-cycling) 비율은 19.5%로 글로벌 평균(40%)의 절반에도 못 미치며, 아이슬란드(95%)·노르웨이(99%)와는 5배 이상의 격차가 존재합니다. 참고로 2020년 기준 글로벌 어분 생산의 27%, 어유 생산의 48%가 이미 어획 부산물로부터 생산되고 있습니다. 참치 원물의 약 50%(내장 12~18%, 뼈 9~15%, 머리 9~12% 등)가 폐기물로 버려지고 있어, 역으로 막대한 '미회수 가치(Unrealized Value)'가 잠재해 있는 블루오션입니다. EU는 CFP(공동어로정책)의 '하역 의무화(Landing Obligation)'로 해상 투기를 전면 금지하여, 부산물 자원화가 규제적 의무로 전환되고 있습니다." 
          actionPlan="1) 아이슬란드의 'Nothing is Waste' 모델을 벤치마킹하여, 참치 가공 공장의 부산물 전량을 제약/건기식/펫푸드 B2B 원료로 전환하는 전사적 '제로 웨이스트 로드맵'을 수립해야 합니다. 2) 단기적으로는 자숙액→액젓(19.5%→40% 수준)을, 중장기적으로는 심장·뼈→기능성 추출물/칼슘보충제(40%→80%+ 수준)로 업사이클링(Up-cycling) 비율을 단계적으로 끌어올리는 것이 목표입니다. 3) EU 하역 의무화 정책을 활용한 '규제 준수 + 순환경제' 이중 가치 마케팅으로 유럽 시장 진출 시 프리미엄을 확보할 수 있습니다." 
