  ...
  it('publishes only aggregate values and derived quality counts', () => {
    expect(fleetDailyPublic).toEqual({
      _meta: {
        ...
        latestReportDate: '2026-09-08',
        latestAsOf: '2026-09-07',
      ...
      latest: {
        ...
        asOf: '2026-09-07',
        pacific: { asOf: '2026-09-07', dailyMt: 25, monthlyMt: 815, annualMt: 49_055.8 },
        atlantic: { asOf: '2026-09-07', dailyMt: 50, monthlyMt: 1_040, annualMt: 34_500 },
        carrier: { loadedTotalMt: 7_684.1, expectedRemainingMt: 3_821.7 },
      },
      deltas: { pacificDailyMt: -75, atlanticDailyMt: -25, totalDailyMt: -100 },
      reconciliation: {
        pacificDaily: { reportedMt: 25, rowsMt: 25, matches: true, missingCount: 0 },
        atlanticDaily: { reportedMt: 50, rowsMt: 50, matches: true, missingCount: 0 },
        ...
        carrierExpectedRemaining: { reportedMt: 3_821.7, rowsMt: 3_821.7, matches: true, missingCount: 0 },
        valid: true,
        unavailableCount: 0,
        issueCount: 0,
      },
      ...
      quality: {
        counts: {
          reconciliationChecks: 604,
          reconciliationCompleteChecks: 604,
