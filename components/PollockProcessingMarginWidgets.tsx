...
import { ComposedChart, AreaChart, Area, BarChart, Bar, LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip as RechartsTooltip, ResponsiveContainer, Legend, ScatterChart, Scatter, ZAxis } from 'recharts';
import SafeResponsiveContainer from './SafeResponsiveContainer';
import { Layers, CandlestickChart, Activity, ShieldCheck, Cpu, Snowflake, Users, Banknote } from 'lucide-react';
  ...
  return (
    <div className={styles.card} style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      <CardHeader 
        ...
        term="Roe D2C vs B2B Margin Spread" 
        desc="저관세 0303.91 수입 어란을 조제 명란(1604)으로 국내에서 전환했을 때의 부가가치 폭발점 계산" 
      />
  ...
  return (
    <div className={styles.card} style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      <CardHeader 
        ...
        icon={Activity} 
        term="Price Transfer Resistance" 
        desc="원가 급등분을 납품 단가에 가산(전가)할 때 발생하는 소비자 구매량(수요) 감소의 마지노선" 
      />
      <div className={styles.cardBody} style={{ flexGrow: 1, display: 'flex', flexDirection: 'column', gap: '1rem' }}>
         <div style={{ height: '260px', width: '100%', flexShrink: 0 }}>
          <SafeResponsiveContainer width="100%" height="100%">
  ...
  return (
    <div className={styles.card} style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      <CardHeader 
        ...
        icon={ShieldCheck} 
        term="MSC Premium Spread" 
        desc="글로벌 ESG 의무화 트렌드에 따른 MSC(해양관리협의회) 인증 명태의 가격 프리미엄 벌어짐 현상" 
      />
      <div className={styles.cardBody} style={{ flexGrow: 1, display: 'flex', flexDirection: 'column', gap: '1rem' }}>
         <div style={{ height: '260px', width: '100%', flexShrink: 0 }}>
          <SafeResponsiveContainer width="100%" height="100%">
  ...
  return (
    <div className={styles.card} style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      <CardHeader 
        ...
        icon={Cpu} 
        term="Automation BEP Crossover" 
        desc="최저임금 인상 및 숙련공 노령화에 따른 수작업 비용과 로봇 기반 절단/해동 자동화 설비 도입의 손익분기점" 
      />
      <div className={styles.cardBody} style={{ flexGrow: 1, display: 'flex', flexDirection: 'column', gap: '1rem' }}>
         <div style={{ height: '260px', width: '100%', flexShrink: 0 }}>
          <SafeResponsiveContainer width="100%" height="100%">
  ...
  return (
    <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', height: '100%', flexShrink: 0 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px', flexShrink: 0 }}>
        ...
        <h3 style={{ margin: 0, fontSize: '1.2rem', color: '#f8fafc', fontWeight: 700 }}>[Cost] 콜드체인(Reefer) 가동률 및 보관료 폭주</h3>
      </div>
  ...
  return (
    <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', height: '100%', flexShrink: 0 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px', flexShrink: 0 }}>
        ...
        <h3 style={{ margin: 0, fontSize: '1.2rem', color: '#f8fafc', fontWeight: 700 }}>[Cost] 선단 선원 노령화 및 인건비 타격</h3>
      </div>
...
export const WidgetFXHedging = () => {
  return (
    <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', height: '100%', flexShrink: 0 }}>
      {/* Title Area */}
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px', flexShrink: 0 }}>
        <Banknote size={18} color="var(--color-success)" />
        <h3 style={{ margin: 0, fontSize: '1.2rem', color: '#f8fafc', fontWeight: 700 }}>[Cost] 강달러 환차손 임계점 방어 시뮬레이션</h3>
      </div>
...
import { Cpu as CpuIcon, Activity as ActivityIcon, Anchor, Bot, PlaneTakeoff } from 'lucide-react';

export const WidgetAITimePredict = () => (
  <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', height: '100%', flexShrink: 0 }}>
    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px', flexShrink: 0 }}>
      <CpuIcon size={18} color="#06b6d4" />
      <h3 style={{ margin: 0, fontSize: '1.2rem', color: '#f8fafc', fontWeight: 700 }}>[Cost] 선박 AI 예지보전 도입 운휴 회피율</h3>
    </div>
    <div style={{ flex: 1, minHeight: 0, position: 'relative' }}>
      <div style={{ position: 'absolute', inset: 0, border: '1px solid rgba(255,255,255,0.05)', borderRadius: '8px', background: 'rgba(0, 0, 0, 0.2)', padding: '16px' }}>
        <SafeResponsiveContainer width="100%" height={260} style={{ flexShrink: 0 }}>
...
export const WidgetPortTurnaround = () => (
  <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', height: '100%', flexShrink: 0 }}>
    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px', flexShrink: 0 }}>
      {/* Fallback to Activity if ClockCounterClockwise isn't available from lucide-react */}
      <ActivityIcon size={18} color="#eab308" />
      <h3 style={{ margin: 0, fontSize: '1.2rem', color: '#f8fafc', fontWeight: 700 }}>[Cost] 만재흘수 조업-하역 턴어라운드 진단기</h3>
    </div>
    <div style={{ flex: 1, minHeight: 0, position: 'relative' }}>
      <div style={{ position: 'absolute', inset: 0, border: '1px solid rgba(255,255,255,0.05)', borderRadius: '8px', background: 'rgba(0, 0, 0, 0.2)', padding: '16px' }}>
        <SafeResponsiveContainer width="100%" height={260} style={{ flexShrink: 0 }}>
...
export const WidgetVesselCapex = () => (
  <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', height: '100%', flexShrink: 0 }}>
    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px', flexShrink: 0 }}>
      <Anchor size={18} color="var(--color-danger)" />
      <h3 style={{ margin: 0, fontSize: '1.2rem', color: '#f8fafc', fontWeight: 700 }}>[Cost] 선박 폐선 및 대체 CAPEX 투하 압박도</h3>
    </div>
    <div style={{ flex: 1, minHeight: 0, position: 'relative' }}>
      <div style={{ position: 'absolute', inset: 0, border: '1px solid rgba(255,255,255,0.05)', borderRadius: '8px', background: 'rgba(0, 0, 0, 0.2)', padding: '16px' }}>
        <SafeResponsiveContainer width="100%" height={260} style={{ flexShrink: 0 }}>
...
export const WidgetRobotTCO = () => (
  <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', height: '100%', flexShrink: 0 }}>
    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px', flexShrink: 0 }}>
      ...
      <h3 style={{ margin: 0, fontSize: '1.2rem', color: '#f8fafc', fontWeight: 700 }}>[Cost] 공장 자동화(ROBOT) TCO 크로스오버</h3>
    </div>
    <div style={{ flex: 1, minHeight: 0, position: 'relative' }}>
      <div style={{ position: 'absolute', inset: 0, border: '1px solid rgba(255,255,255,0.05)', borderRadius: '8px', background: 'rgba(0, 0, 0, 0.2)', padding: '16px' }}>
        <SafeResponsiveContainer width="100%" height={260} style={{ flexShrink: 0 }}>
...
export const WidgetAirVsOcean = () => (
  <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', height: '100%', flexShrink: 0 }}>
    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px', flexShrink: 0 }}>
      <PlaneTakeoff size={18} color="var(--color-success)" />
      <h3 style={{ margin: 0, fontSize: '1.2rem', color: '#f8fafc', fontWeight: 700 }}>[Cost] 모달 쉬프트(Air vs Ocean) 선도 마진</h3>
    </div>
    <div style={{ flex: 1, minHeight: 0, position: 'relative' }}>
      <div style={{ position: 'absolute', inset: 0, border: '1px solid rgba(255,255,255,0.05)', borderRadius: '8px', background: 'rgba(0, 0, 0, 0.2)', padding: '16px' }}>
        <SafeResponsiveContainer width="100%" height={260} style={{ flexShrink: 0 }}>
