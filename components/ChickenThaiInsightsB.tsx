...
<p>실측: <strong>태국 표준 1.8~2.3kg 소형닭은 일본 수출 특화 → 한국 프랜차이즈 스펙(3kg+) 불충족. 그러나 코리아 스페셜 2.5kg+ 라인은 수율 74% (브라질 78% 대비 -4%p), FCR 1.72로 생산효율 브라질 대비 우위</strong>. 사이즈 갭은 단순 스펙 문제가 아닌 전체 가공·유통 시스템의 재설계 필요.</p>
</div>`,
        actionPlan: `<div>
