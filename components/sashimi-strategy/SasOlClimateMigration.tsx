...
/* ── 기후 어장 이동 정량: 가다랑어·황다랑어 동·극지 이동 (Bell 2021·FAO) ──
   ...
   EPO 공해 자원 +23.3%(673,000t), 도서국 EEZ 선망 -20%.
...
const SHIFT = [
  ...
  { region: '동태평양 공해 자원', pct: 23, color: '#10b981' },
];
...
export default function SasOlClimateMigration() {
  return (
    <WidgetCard
      ...
      description="도서국 EEZ 자원 -13%, 동태평양 공해 +23% (2050 RCP8.5)"
      pillar="S5"
      telemetry={{ status: 'STATIC', syncDate: '2025' }}
      cardDesc="해수온 상승에 따른 다랑어 어장 동향·도서국 입어료 충격 — Bell 2021·FAO·Frontiers"
      takeaway={{
        situation: "기후변화가 참치 어장 지도를 다시 그립니다. 해수온 상승으로 가다랑어·황다랑어가 따뜻한 서태평양에서 동·극지 공해로 이동하면서, 2050년(RCP8.5) 도서국(10개 SIDS) EEZ 내 3종 다랑어 자원량은 -13%(범위 -5~-20%), 선망 어획량은 -20% 감소가 전망됩니다. 반대로 동태평양 공해(EPO) 자원량은 +23.3%(673,000톤) 증가하며 어획은 2050년 +125%(2001-10 대비)까지 늘 수 있습니다. 이 이동은 도서국에 연 -US$90M(범위 40~140M)의 입어료 수입 손실을 안기며, 공해 어업국의 비중을 키웁니다.",
        actionPlan: "어장 이동은 한국 원양의 조달 지정학을 바꿉니다. ① 가다랑어가 도서국 EEZ(입어료)에서 동태평양 공해(입어료 無)로 이동하면 장기적으로 입어료 부담이 줄지만, 공해 조업은 RFMO 규제·관할 불확실성이 커지므로 EEZ↔공해 조업 포트폴리오를 시나리오별로 재배분하십시오. ② 도서국 입어료 수입 급감(-$90M)은 도서국이 단기 입어료 인상으로 방어할 유인이 되므로, 어장이 빠지기 전 장기 입어계약을 락인하거나 동태평양 조업 역량을 선제 확보하십시오.",
