...
/* ── 한국 원양 참치 선단 경제성·구조 리스크 (해수부 1차) ──
   검증(solid): 노후선 30년+ 64.4%(214중138, 2019), 평균선령 ~30년→2025 25년 목표, 해기사 50세+ 78.9%.
...
export default function SasKrFleetEconomics() {
  return (
    <WidgetCard
      ...
      description="원양어선 64%가 선령 30년+, 해기사 79%가 50세 이상"
      pillar="S1"
      telemetry={{ status: 'STATIC', syncDate: '2024' }}
      cardDesc="한국 원양어선 선령 분포·인력 고령화 구조 리스크 — 해양수산부(2019 기준)·원양산업협회"
      takeaway={{
        situation: "한국 원양 참치 선단은 자본·노동 양면의 구조적 노후화에 직면했습니다. 2019년 기준 원양어선 214척 중 64.4%(138척)가 선령 30년을 초과(26척은 40년 이상)하고 신조선(10년 미만)은 8.9%에 불과해 평균 선령이 약 30년에 달합니다(해수부 목표는 2025년 25년). 인력 측면에서는 원양 해기사의 78.9%가 50세 이상으로 고령화가 임계점에 도달했고, 외국인 선원 의존(원양 전체 45.7%, 참치 연승선은 이보다 높음)이 심화됐습니다. Science Advances(2018) 분석상 보조금·저임금 노동이 없으면 공해 어장의 최대 54%가 적자로, 한국 다수 선대가 정부 보조에 의존하는 구조입니다.",
        ...
        source: "해양수산부 원양어선 안전·복지 대책(노후선 64.4%·평균선령 30년·2025 25년 목표, 2019/2020) / 외국인선원 고용실태조사(해기사 78.9% 50세+) / Science Advances 2018(공해어장 54% 적자)",
      }}
      customBody={
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', width: '100%' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '14px', fontSize: '0.62rem', color: '#94a3b8', flexWrap: 'wrap' }}>
            <span>해기사 50세+ <span style={{ color: '#ef4444', fontWeight: 700 }}>78.9%</span></span>
            <span>외국인 선원 의존(원양) <span style={{ color: '#f59e0b', fontWeight: 700 }}>45.7%+</span></span>
