...
/* ── 엔저가 가른 일본 참치 수입 — 買い負け (수산청·Nippon.com) ──
   검증(solid): 수산물 물량 정체(~220만t) vs 금액 +2.2%→¥2.1조, 엔저 USD/JPY 161.6(2024.7 37년 최저)→150중반,
   지중해 BFT 도매 ¥1,500(2024저점)→¥1,900~1,950(2025), 蓄養 BFT ~4만t·90%+ 일본 유입.
...
export default function SasJpImportYen() {
  return (
    <WidgetCard
      ...
      cardDesc="엔저·일본 수산물 수입 물량/금액 디커플링·지중해 BFT 도매가 — 수산청·Nippon.com·Tridge"
      takeaway={{
        situation: "엔저가 일본 참치 수입 구조를 갈랐습니다. 일본 수산물 수입은 물량이 약 220만 톤으로 정체된 반면 금액은 +2.2%로 ¥2.1조까지 올라(상위 3대 품목에 가다랑어·참치 포함) '물량은 그대로인데 비싸게 산다'는 디커플링이 나타났습니다. USD/JPY가 2024년 7월 161엔대(약 37년 반 최저)까지 치솟았다가 2025년 150엔대 중반으로 일부 회복됐으나, 엔저로 일본이 글로벌 사들이기 경쟁에서 밀리는 '買い負け(가이마케)' 현상이 지속됩니다. 일본 의존도 90%+인 지중해 양식 블루핀(약 4만 톤) 도매가도 2024년 저점 ¥1,500/kg에서 2025년 ¥1,900~1,950/kg으로 회복했습니다.",
        ...
        source: "Nippon.com(일본 수산물 수입 물량 정체·금액 +2.2%·¥2.1조) / USD/JPY 161.6(2024.7 37년 최저) / SeafoodSource·Tridge(지중해 BFT 도매 ¥1,500→¥1,900~1,950, 蓄養 ~4만t 90%+ 일본)",
      }}
      customBody={
