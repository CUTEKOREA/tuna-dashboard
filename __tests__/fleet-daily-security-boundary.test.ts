  ...
  it('publishes only aggregate values and derived quality counts', () => {
    expect(fleetDailyPublic).toEqual({
      _meta: {
        ...
        latestReportDate: '2026-09-03',
        latestAsOf: '2026-09-02',
      ...
      latest: {
        ...
        asOf: '2026-09-02',
        pacific: { asOf: '2026-09-02', dailyMt: 175, monthlyMt: 350, annualMt: 48_590.8 },
        atlantic: { asOf: '2026-09-02', dailyMt: 195, monthlyMt: 315, annualMt: 33_775 },
        carrier: { loadedTotalMt: 5_834.1, expectedRemainingMt: 5_771.7 },
      },
      deltas: { pacificDailyMt: 0, atlanticDailyMt: 75, totalDailyMt: 75 },
      reconciliation: {
      ...
      quality: {
        counts: {
          reconciliationChecks: 592,
          reconciliationCompleteChecks: 592,
          reconciliationUnavailableChecks: 0,
          reconciliationUnavailableDocuments: 0,
          reconciliationIssues: 18,
          reconciliationDocuments: 16,
          reconciliationPartialDifferences: 18,
          reconciliationPartialDifferenceDocuments: 16,
