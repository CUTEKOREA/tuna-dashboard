    ...
    <div className={styles.glassCard} style={{ marginTop: '2rem' }}>
      ...
      <div style={{ marginTop: '20px' }}>
        <TakeawayBox
          ...
          situation="차익 마진(Spread) 레이더를 통해, 인도네시아·페루 등 생산기지에서 가공 원료로 매입한 뒤, 1차 가공(할복·탈피)을 거쳐 일본·중국 등 주요 소비국으로 재수출할 때 발생하는 톤당 $200~$410 수준의 '차익거래(Arbitrage) 밴드'가 실시간 포착됩니다. 특히 인도네시아-일본(Sashimi Grade) 라우트는 운송비를 제하고도 톤당 $410의 초과 이익 구간을 보여 단순 원물 무역 대비 높은 이익 구조를 입증합니다."
