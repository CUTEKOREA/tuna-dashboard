  ...
  it('publishes only aggregate values and derived quality counts', () => {
    expect(fleetDailyPublic).toEqual({
      _meta: {
        ...
        latestReportDate: '2026-09-10',
        latestAsOf: '2026-09-09',
      ...
      latest: {
        ...
        asOf: '2026-09-09',
        pacific: { asOf: '2026-09-09', dailyMt: 79, monthlyMt: 965, annualMt: 49_205.8 },
        atlantic: { asOf: '2026-09-09', dailyMt: 25, monthlyMt: 1_205, annualMt: 34_665 },
        carrier: { loadedTotalMt: 7_684.1, expectedRemainingMt: 3_556.7 },
      },
      deltas: { pacificDailyMt: 8, atlanticDailyMt: -115, totalDailyMt: -107 },
      reconciliation: {
        pacificDaily: { reportedMt: 79, rowsMt: 79, matches: true, missingCount: 0 },
        atlanticDaily: { reportedMt: 25, rowsMt: 25, matches: true, missingCount: 0 },
      ...
      quality: {
        counts: {
          reconciliationChecks: 612,
          reconciliationCompleteChecks: 612,
