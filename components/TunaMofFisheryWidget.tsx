...
return (
    <div className={styles.insightCard}>
        ...
        <div className={styles.chartContainer} style={{ height: 280 }}>
          <SafeResponsiveContainer width="100%" height="100%">
            <ComposedChart data={data} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
              ...
              <XAxis dataKey="market" stroke="#94a3b8" tick={{ fill: '#cbd5e1', fontSize: 12, fontWeight: 500 }}  angle={0} textAnchor="middle" height={60} tickFormatter={truncateXAxis}/>
      ...
      <div style={{ padding: '0 20px 20px 20px' }}>
        <TakeawayBox 
          situation="2026년 1분기 기준, 국내 냉동 눈다랑어 물량의 43%가 부산공동어시장(12,450MT)에 집중되며 물류 병목 현상이 발생하고 있습니다. 반면, 제주 한림 위판장은 거래량은 적으나(3,200MT) 선도 프리미엄이 반영되어 전국 최고가인 ₩9,100/kg을 기록하며 하이엔드 횟감 시장을 주도하고 있습니다." 
          actionPlan="**[Actionable Insight]** [Premium Margin Strategy] 부산에 집중된 범용 물량은 B2B 가공용 고정 단가 계약으로 가격 변동 리스크를 헷지하십시오. 동시에, 제주 한림 위판장의 고단가 프리미엄 눈다랑어 물량은 최고가 일본 수출 및 국내 오마카세 직거래 채널로 전량 스위칭하여 마진율을 극대화해야 합니다." 
...
export function MofTradeBalanceWidget() {
  ...
  return (
    <div className={styles.insightCard}>
      ...
      <div className={styles.cardBody} style={{ paddingBottom: 0 }}>
        <div className={styles.chartContainer} style={{ height: 280 }}>
          <SafeResponsiveContainer width="100%" height="100%">
            <ComposedChart data={data} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
              <CartesianGrid strokeDasharray="3 3" stroke="rgba(255,255,255,0.05)" vertical={false} />
              <XAxis dataKey="month" stroke="#94a3b8" tick={{ fill: '#cbd5e1', fontSize: 12, fontWeight: 500 }}  angle={0} textAnchor="middle" height={60} tickFormatter={truncateXAxis}/>
      ...
      <div style={{ padding: '0 20px 20px 20px' }}>
        <TakeawayBox
          situation="참치 무역수지 월평균 -$147M 적자가 지속되고 있습니다. 12월 수입이 $210M으로 연중 최대치를 기록했으며(연말 재고 확보 수요), 수출은 $42~55M 수준에 머물러 원어 수입 의존도(Exposure)가 가속화되고 있습니다."
          actionPlan="**[Actionable Insight]** [적자 축소 전략] ① 가공 참치캔 자체 브랜드(프리미엄 라인) 수출 전환으로 톤당 부가가치 +$800 확보, ② 중동/아프리카 신시장 수출 확대로 수출액 $80M 목표, ③ 원양산 원어 직수출 비중 확대를 병행해야 합니다."
...
export function MofShippingCostWidget() {
  ...
  return (
    <div className={styles.insightCard}>
      ...
      <div style={{ padding: '0 20px 20px 20px' }}>
        <TakeawayBox
          situation="부산→LA 노선 $2,200/20ft(+15% YoY)로 홍해 분쟁 여파가 지속되고 있습니다. 반면 부산→오사카 $620/20ft(+1%)로 아시아 노선은 상대적으로 안정적이며, 부산→로테르담은 $1,900(-3%)으로 소폭 하락 추세입니다."
          actionPlan="① 방콕 직항 물류에 물량을 집중하여 단위당 운임 절감, ② LA행 장기계약(TAC) 체결로 운임 $1,800 이하 락인, ③ 로테르담 하락 추세 활용 EU 수출 확대를 실행해야 합니다."
