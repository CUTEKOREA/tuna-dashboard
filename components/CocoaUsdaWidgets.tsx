...
const ICONS: Record<string, any> = {
  w_civ_production_5y: Globe,
  w_ghana_production_recovery: MapPin,
  w_civ_domestic_processing: Factory,
  w_cocoa_international_price_8y: TrendingUp,
  w_ghana_us_export_surge: ShoppingBag,
};

/**
 * USDA FAS GAIN 기반 코코아 인텔리전스 위젯.
 *
 * - filterPillar='S1': 코트디부아르·가나 생산
 * - filterPillar='S2': 코트디부아르 국내 가공률 정책
 * - filterPillar='S4': 국제·국내 가격 8년 + 가나 대미 수출 급증
 */
export default function CocoaUsdaWidgets({ filterPillar }: { filterPillar?: 'S1' | 'S2' | 'S4' } = {}) {
