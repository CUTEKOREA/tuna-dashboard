    ...
    <div className={styles.card}>
      ...
      <div className={styles.cardBody}>
        ...
        <TakeawayBox 
          ...
          actionPlan="**[Actionable Insight]** 1) 아이슬란드의 'Nothing is Waste' 모델을 벤치마킹하여, 참치 가공 공장의 부산물 전량을 제약/건기식/펫푸드 B2B 원료로 전환하는 전사적 '제로 웨이스트 로드맵'을 수립해야 합니다. 2) 단기적으로는 자숙액→액젓(19.5%→40% 수준)을, 중장기적으로는 심장·뼈→기능성 추출물/칼슘보충제(40%→80%+ 수준)로 업사이클링(Up-cycling) 비율을 단계적으로 끌어올리는 것이 목표입니다. 3) EU 하역 의무화 정책을 활용한 '규제 준수 + 순환경제' 이중 가치 마케팅으로 유럽 시장 진출 시 프리미엄을 확보할 수 있습니다." 
