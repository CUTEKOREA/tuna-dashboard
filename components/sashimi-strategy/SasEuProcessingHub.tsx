...
/* ── EU 참치 가공 허브: 스페인 (Pillar 2 가공·생산) ──
   ...
   스페인 참치산업 매출 ~€1.1B·직간접 고용 62,000명(97% 갈리시아·바스크, SeafoodSource·ANFACO).
...
export default function SasEuProcessingHub() {
  return (
    <WidgetCard
      ...
      cardDesc="스페인 EU 캔참치 가공 점유·산업 규모·고용 — FAO GLOBEFISH·Eurofish·ANFACO"
      takeaway={{
        ...
        source: "FAO GLOBEFISH·Eurofish·SeafoodSource(스페인 EU 캔 생산 ~70%·세계 2위) / SeafoodSource·WeAreAquaculture·ANFACO(매출 ~€1.1B·고용 62,000명)",
      }}
      customBody={
