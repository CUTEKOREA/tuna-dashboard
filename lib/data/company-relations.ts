...
> = {
  ...
  'external:nfd': { label: 'National Fisheries Developments', country: '솔로몬제도', lat: -9.43, lng: 159.95,
    basis: 'ⅩⅩⅠ · WCPFC 등록부 소유자 칸 · ⅩⅬⅨ 가 노로에 SolTuna 본사 핀을 찍으면서 옛 자리(노로 기지, -8.22, 157.20)가 그 핀과 겹쳤다 — 아크가 남의 핀에서 출발하므로 ⅩⅬⅨ 회사등기(20111635)의 현 등기본점인 호니아라 City Centre Building 으로 옮겼다. 좌표는 호니아라 시가의 근사값이다' },
