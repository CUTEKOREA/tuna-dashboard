...
return (
    <div className={styles.insightCard}>
      ...
      <TakeawayBox
        ...
        actionPlan="**[Actionable Insight]** [2단계 상용화 로드맵] Phase 1 (즉시): DHA/EPA 추출 라인 증설(마진 65%) 및 해양 콜라겐 펩타이드 생산 시설 구축(마진 72%)으로 연간 ₩50억+ 추가 매출 확보. Phase 2 (3년 내): KFAS/NIFS 공동 R&amp;D를 통해 ACE 억제 기능성 펩타이드(마진 80%) 상용화 파이프라인 구축. 부산물 10% 고부가 전환 시 연매출 $50M+ 창출 가능해야 합니다. (Conviction Buy)"
  ...
  return (
    <div className={styles.insightCard}>
      ...
      <TakeawayBox
        ...
        actionPlan="**[Actionable Insight]** [우선순위 투자 전략] ① 즉시 수익: 해양 콜라겐 펩타이드 라인 증설(마진 72% × 시장 $12.8B = 최적 ROI). ② 중기 성장: 칼슘제 양산화(마진 45%, 성장기 — 경쟁사 대비 원료 자급 우위). ③ 장기 고수익: KFAS/NIFS 공동 R&amp;D로 기능성 펩타이드(ACE 억제 활성 82%) 상용화 3년 파이프라인 구축. 바이오사료(마진 25%)는 대량 부산물 처리용으로 투트랙 유지해야 합니다. (Dual-track Strategy)"
