  ...
  return (
    <div className={styles.card} style={{ display: 'flex', flexDirection: 'column', minHeight: '480px' }}>
      ...
      <div style={{ marginTop: 'auto' }}>
        <TakeawayBox
          situation="IOTC는 눈다랑어(BET) TAC를 80,583톤(2025), ICCAT은 73,011톤(2025)으로 제한하고, 황다랑어(YFT)는 기준 연도 대비 13~20% 감축을 의무화했습니다. 초과 시 100~125% 페이백 페널티가 부과됩니다. FAO SOFIA 2022에 따르면 공급 제한과 수요 증가가 맞물려 2030년까지 국제 거래 수산물 가격이 2020년 대비 명목(nominal) 기준 약 33% 상승할 전망입니다(*실질 가격은 하락 예상*이라는 단서 포함). IOTC FAD 72일 조업 제한 시 통조림 수출 물량이 12% 하락하고, 공장 가동이 연간 2~6주 중단될 리스크가 존재합니다."
