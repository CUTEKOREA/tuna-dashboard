...
/* ── 글로벌 참치 공급: WCPO 어획·어종구성 (SPC/WCPFC 1차) ──
   검증(solid): 2024 WCPO 어획 3,059천t(사상최대 +15%), 가다랑어 2,046천t(67%·+24%),
   WCPO 글로벌 비중 ~52%(2023), 선망 70%·연승 8%. */
const SPECIES = [
  { sp: '가다랑어', t: 2046, pct: 67, color: '#38bdf8' },
  { sp: '황다랑어', t: 700, pct: 23, color: '#10b981' },
...
export default function SasGlWcpoSupply() {
  return (
    <WidgetCard
      ...
      takeaway={{
        situation: "세계 참치 공급의 절반(2023년 약 52%)을 책임지는 중서부태평양(WCPO)은 2024년 어획량이 3,059천 톤으로 사상 최대(전년比 +15%)를 기록했습니다. 이 중 가다랑어가 2,046천 톤으로 역대 최고(총량의 67%, +24%)를 차지하며, 어법별로는 선망(purse seine)이 70%, 연승 8%입니다. 즉 글로벌 참치 원료가는 사실상 WCPO 가다랑어 선망 어획 동향에 의해 결정되며, 2024년 풍어가 원료가 하방 압력으로 작용했습니다.",
        actionPlan: "원료 조달은 WCPO 가다랑어 사이클을 핵심 신호로 추적하십시오. ① 2024년 사상 최대 어획은 단기 원료가 하방이나, 엘니뇨/라니냐에 따라 어장이 동·서로 이동하면 어획효율과 가격이 급변하므로 풍어기 저가 원물을 -60℃ 비축으로 락인하는 카운터-사이클 조달이 유효합니다. ② 가다랑어 67% 집중은 사시미급(황다랑어·눈다랑어 28%) 원료의 상대적 희소성을 의미 — 사시미 라인은 풍어와 무관하게 어종 프리미엄이 유지되므로 어종별 조달 전략을 분리하십시오.",
