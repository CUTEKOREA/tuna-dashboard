...
const PILLARS = [
  { id: 'P1', num: '❶', label: '원료 수급', title: '🐷 Pillar I - 원료 수급', desc: '글로벌 생산량 모니터링 및 ASF 질병 헤징 전략', color: 'var(--w-rose-500)', widgets: ['W1', 'W5', 'W6', 'W9'] },
  ...
  { id: 'P4', num: '❹', label: '판매·수요', title: '📈 Pillar IV - 판매 및 수요', desc: '한국 수급 구조 분석 및 자급률 갭 공략', color: 'var(--w-orange-500)', widgets: ['W7', 'W11'] },
