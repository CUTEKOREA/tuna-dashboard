...
export function InsightRiskNexus() {
  return (
    <div className={styles.insightCard}>
      ...
      <div style={{ padding: '0 20px 20px 20px' }}>
        <TakeawayBox
          situation="[Risk Correlation Matrix] 6축 리스크 중 태국이 열위인 것은 '중국산 덤핑(13~14% 저가)'과 '환율(KRW/THB)' 뿐입니다. 반면 해상운임(태국 10~14일 vs 브라질 56일), HPAI(태국 19년 청정 vs 브라질 2025 발발)에서 압도적 우위. CBOT $4.15 저점은 태국 사료비(원가 60~70%) 역대 최저를 의미합니다."
