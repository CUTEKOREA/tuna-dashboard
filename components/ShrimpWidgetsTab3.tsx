...
export const W21_KoreaImpTimeline = () => (
  <WidgetCard title="한국 새우 연간 수입 톤수 추이" icon={Target} term="Korea Import Yield" desc="1994년 이후 국내 도입 물량선 (톤)" source="FAOSTAT 수산 무역 — 한국 수입 물량 시계열(1994~2023)" situation="대한민국 새우 수입 물량은 2000년대 이후 구조적 성장기를 거치며 우상향 추세를 보였고, 2023년 기준 약 96,299톤 수준입니다." actionPlan="[조달 규모 우위 확보] 자본력 기반의 바잉 파워(Buying Power)를 활용해 프랜차이즈·대형 외식 B2B 공급 라인을 확대하고, 물량 기반 협상력으로 안정적 매입 단가를 확보하는 것을 검토하십시오." telemetry={{ status: 'STATIC', syncDate: '2026-05-29' }}>
...
export const W22_KoreaSelfSuff = () => (
  <WidgetCard title="대한민국 자급률 (Self-sufficiency)" icon={ShieldCheck} term="Korea Self-Sufficiency" desc="국내 생산 / (국내 생산 + 수입) 산출 (%)" source="FAOSTAT 한국 생산량·수입량 기반 자체 산출 (2023: 생산 27,906톤 / 수입 96,299톤)" situation={`[자급 기반 취약] 2023년 기준 국내 새우 자급률은 ${koreaSelfSufficiency}%로, 소비 물량의 대부분을 수입에 의존하고 있어 환율·해외 산지 가격 변동에 대한 노출도가 높은 구조입니다.`} actionPlan="[자급 기반 투자 검토] 수입 의존도를 낮추기 위해 스마트 바이오플락(Bio-floc) 육상 양식 R&D 투자와 국내 무균 프리미엄(SPF) 라인업의 부분적 수직 자립화를 단계적으로 검토하십시오." telemetry={{ status: 'STATIC', syncDate: '2026-05-29' }}>
