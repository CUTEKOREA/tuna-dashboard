...
/* ── 도요스 너머: 일본 사시미 유통 구조·상사 수직지배 (MAFF·기업공시) ──
   ...
   사시미 참치 점유 1위·-50℃ 초저온 일관(8영업거점/9가공장), 중앙도매 수산 34곳(29개 도시).
...
const ITEMS = [
  ...
  { rc: '#ef4444', title: '상사 수직계열 지배', value: '미쓰비시', desc: '도요레이조(TOREI, 미쓰비시상사 계열)가 일본 사시미 참치 점유 1위 — 운반선·가공선·-50℃ 냉장창고·가공장(8영업거점/9가공장) 일관 밸류체인.' },
...
export default function SasJpDistribution() {
  return (
    <WidgetCard
      ...
      takeaway={{
        situation: "도요스는 일본 사시미의 상징이자 가격선도 시장이지만, 실제 물류는 그 너머에서 재편되고 있습니다. 도매시장 경유율은 20년 전 대비 약 3할 하락해 2018년 약 47%까지 떨어졌고, 산지 직거래·시장외 유통이 경매 비중을 잠식합니다. 동시에 종합상사가 밸류체인을 수직 지배합니다 — 미쓰비시상사 계열 도요레이조(TOREI)가 일본 사시미 참치 점유 1위로 운반선·가공선·-50℃ 초저온 냉장창고·가공장(8영업거점/9가공장)을 일관 운영합니다. 즉 도요스 경매가는 가격 신호일 뿐, 물량과 마진은 상사 수직계열로 흘러갑니다.",
        ...
        source: "MAFF 수산백서(도매시장 경유율 ~47%, 2018·20년 전 대비 ~3할 하락) / 미쓰비시상사·도요레이조 공시(사시미 참치 1위·-50℃ 일관·8영업거점/9가공장) / 농림수산성(중앙도매 수산 34곳)",
      }}
      customBody={
