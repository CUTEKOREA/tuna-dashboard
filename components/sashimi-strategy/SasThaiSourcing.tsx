...
/* ── 태국 원료조달 + EU 관세후 경쟁력 (미국 축은 SasUsTariffLadder/CompetitorMap에 위임) ──
   검증: 원료 수입의존 50.5%(IOM 2023), 가다랑어 수입 $1,013.5M·670.4천t(+38.7%, IndexBox 2024),
   EU 캔참치 24% MFN(2015 GSP 상실) vs 에콰도르 0%(EU 무역협정 경유). */
const EU_TARIFF = [
  { origin: '🇹🇭 태국', rate: 24, note: 'GSP 상실(2015)', color: '#ef4444' },
  { origin: '🇻🇳 베트남', rate: 0, note: 'EVFTA 쿼터 무관세', color: '#38bdf8' },
...
export default function SasThaiSourcing() {
  return (
    <WidgetCard
      ...
      cardDesc="태국 가공 허브의 원료 수입 의존·EU 관세 경쟁력 — IndexBox 2024·IOM·EU 관세"
      takeaway={{
        situation: "태국은 세계 최대 가공 허브이나 원료의 절반(수산 투입 50.5%)을 수입에 의존하며, 2024년 냉동 가다랑어 수입만 $1,013.5M·670.4천톤(물량 +38.7% YoY)에 달합니다. 핵심 약점은 EU 시장 관세입니다 — 2015년 GSP 특혜 철회로 EU 캔참치에 24% MFN 관세를 부담하는 반면, 경쟁국 에콰도르는 EU 무역협정으로 0%, 베트남은 EVFTA 쿼터로 무관세입니다. 저원가 가공 우위가 EU 관세 24%p 핸디캡에 상쇄되며 에콰도르·베트남에 추격당하는 구조입니다.",
        ...
        source: "IndexBox Thailand Frozen Skipjack 2024($1,013.5M·670.4천t) / IOM 'In the Shadow of the Ships' 2023(수입의존 50.5%) / EU 관세(태국 24% MFN·에콰도르·베트남 0%)",
      }}
      customBody={
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', width: '100%' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '8px' }}>
            {[
              { k: '원료 수입 의존도', v: '50.5%', s: '국내 어획만으로 가공 불충족', c: '#f59e0b' },
