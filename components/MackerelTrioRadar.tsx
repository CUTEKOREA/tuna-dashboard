    ...
    <div className={styles.glassCard} style={{ borderColor: 'rgba(99, 102, 241, 0.3)' }}>
      ...
      <div style={{ marginTop: '20px' }}>
        <TakeawayBox
          ...
          actionPlan="**[Actionable Insight]** 한국의 '기형적 소비-중계' 모델에서 완전히 탈피하여, 칠레의 '가공 산업(Processing)' 포지션으로 전환해야 합니다. 노르웨이산 H&G를 대량 보세 수입하여 영남권(부산/감포) 단지에 집중 투입하고, 고부가가치 순살/양념 제품으로 전환한 뒤 내수 방어 및 글로벌 C/S 채널(미국 한인마트, 아시안 슈퍼)에 역수출(Export)하여 수출 축 레이더를 인위적으로 비대화시키는 수익 모델을 강제 가동하여 잉여현금흐름(FCF)을 극대화하십시오. (Strong Buy)"
        />
      </div>
    </div>
  );
