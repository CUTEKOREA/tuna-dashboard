    ...
    <div className={styles.glassCard} style={{ borderColor: 'rgba(34, 197, 94, 0.3)' }}>
      ...
      <div style={{ marginTop: '20px' }}>
        <TakeawayBox
          ...
          actionPlan="**[Actionable Insight]** 한국 내수 시장의 저가 원물 수입 후 단순 유통하는 방식에서 벗어나, 고부가가치 창출 구조로 전환해야 합니다. 이탈리아·스페인의 타파스(Tapas)용 HMR이나 일본의 세븐일레븐 편의점용 프리미엄 안주류 패키징을 벤치마킹하여 'K-안주(K-Snack)' 형태의 고단가 가공품으로 전환, 수익성(Profitability)이 검증된 수출 시장 및 일본 내수 시장 진입을 모색하여 잉여현금흐름(FCF)을 극대화하십시오. (Strong Buy)"
        />
      </div>
    </div>
  );
