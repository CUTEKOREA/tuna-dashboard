...
> - 파생: 전배 IN 이 열리는 3단계까지 올리려면 989 → 1,355일로 **366일·$3,843,000**(협회 전체), 신라 27.2% 몫이면 약 **100일·$1,045,800**. 2026 구매 1,325일도 그 해 고정할당 2,209일의 60%라 같은 규칙이면 지금도 최초 할당 구간이다(`valatopTierOf(1325)` 로 고정).
