...
export const WidgetBlockVsIQF = () => (
  <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', height: '100%', flexShrink: 0 }}>
    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px', flexShrink: 0 }}>
      ...
      <h3 style={{ margin: 0, fontSize: '1.2rem', color: '#f8fafc', fontWeight: 700 }}>[Sales] 블록 vs IQF 패스 마진 스프레드</h3>
    </div>
...
export const WidgetRoeMarginSpread = () => (
  <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', height: '100%', flexShrink: 0 }}>
    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px', flexShrink: 0 }}>
      ...
      <h3 style={{ margin: 0, fontSize: '1.2rem', color: '#f8fafc', fontWeight: 700 }}>[Sales] 명란 경매가 및 소매 방어력 투시도</h3>
    </div>
    <div style={{ flex: 1, minHeight: 0, position: 'relative' }}>
      <div style={{ position: 'absolute', inset: 0, border: '1px solid rgba(255,255,255,0.05)', borderRadius: '8px', background: 'rgba(0, 0, 0, 0.2)', padding: '16px' }}>
        <SafeResponsiveContainer width="100%" height={260} style={{ flexShrink: 0 }}>
...
export const WidgetInventoryCycle = () => (
  <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', height: '100%', flexShrink: 0 }}>
    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px', flexShrink: 0 }}>
      ...
      <h3 style={{ margin: 0, fontSize: '1.2rem', color: '#f8fafc', fontWeight: 700 }}>[Sales] 미-일 내수 시장 재고 사이클 투시도</h3>
    </div>
    <div style={{ flex: 1, minHeight: 0, position: 'relative' }}>
      <div style={{ position: 'absolute', inset: 0, border: '1px solid rgba(255,255,255,0.05)', borderRadius: '8px', background: 'rgba(0, 0, 0, 0.2)', padding: '16px' }}>
        <SafeResponsiveContainer width="100%" height={260} style={{ flexShrink: 0 }}>
...
export const WidgetSurimiBlendElasticity = () => (
  <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', height: '100%', flexShrink: 0 }}>
    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px', flexShrink: 0 }}>
      <Shuffle size={18} color="#eab308" />
      <h3 style={{ margin: 0, fontSize: '1.2rem', color: '#f8fafc', fontWeight: 700 }}>[Sales] 연육(Surimi) 공급 충격 대체 탄력성</h3>
    </div>
    <div style={{ flex: 1, minHeight: 0, position: 'relative' }}>
      <div style={{ position: 'absolute', inset: 0, border: '1px solid rgba(255,255,255,0.05)', borderRadius: '8px', background: 'rgba(0, 0, 0, 0.2)', padding: '16px' }}>
        <SafeResponsiveContainer width="100%" height={260} style={{ flexShrink: 0 }}>
...
export const WidgetB2BContractPipeline = () => (
  <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', height: '100%', flexShrink: 0 }}>
    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px', flexShrink: 0 }}>
      <ClipboardSignature size={18} color="#0ea5e9" />
      <h3 style={{ margin: 0, fontSize: '1.2rem', color: '#f8fafc', fontWeight: 700 }}>[Sales] 패스트푸드 B2B 갱신 파이프라인</h3>
    </div>
    <div style={{ flex: 1, minHeight: 0, position: 'relative' }}>
      <div style={{ position: 'absolute', inset: 0, border: '1px solid rgba(255,255,255,0.05)', borderRadius: '8px', background: 'rgba(0, 0, 0, 0.2)', padding: '16px' }}>
        <SafeResponsiveContainer width="100%" height={260} style={{ flexShrink: 0 }}>
...
export const WidgetWholesaleArbitrage = () => (
  <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', height: '100%', flexShrink: 0 }}>
    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px', flexShrink: 0 }}>
      ...
      <h3 style={{ margin: 0, fontSize: '1.2rem', color: '#f8fafc', fontWeight: 700 }}>[Sales] 도매시장 일별 경락 아비트리지</h3>
    </div>
    <div style={{ flex: 1, minHeight: 0, position: 'relative' }}>
      <div style={{ position: 'absolute', inset: 0, border: '1px solid rgba(255,255,255,0.05)', borderRadius: '8px', background: 'rgba(0, 0, 0, 0.2)', padding: '16px' }}>
        <SafeResponsiveContainer width="100%" height={260} style={{ flexShrink: 0 }}>
...
export const WidgetClimateClause = () => (
  <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', height: '100%', flexShrink: 0 }}>
    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px', flexShrink: 0 }}>
      ...
      <h3 style={{ margin: 0, fontSize: '1.2rem', color: '#f8fafc', fontWeight: 700 }}>[Sales] B2B '기후변화 유닛 클로즈' 전가 비중</h3>
    </div>
    <div style={{ flex: 1, minHeight: 0, position: 'relative' }}>
      <div style={{ position: 'absolute', inset: 0, border: '1px solid rgba(255,255,255,0.05)', borderRadius: '8px', background: 'rgba(0, 0, 0, 0.2)', padding: '16px' }}>
        <SafeResponsiveContainer width="100%" height={260} style={{ flexShrink: 0 }}>
...
export const WidgetHolidayPremium = () => (
  <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', height: '100%', flexShrink: 0 }}>
    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px', flexShrink: 0 }}>
      <CalendarClock size={18} color="#ec4899" />
      <h3 style={{ margin: 0, fontSize: '1.2rem', color: '#f8fafc', fontWeight: 700 }}>[Sales] 명절 연휴 D-Day 델리 전진배치 매출</h3>
    </div>
    <div style={{ flex: 1, minHeight: 0, position: 'relative' }}>
      <div style={{ position: 'absolute', inset: 0, border: '1px solid rgba(255,255,255,0.05)', borderRadius: '8px', background: 'rgba(0, 0, 0, 0.2)', padding: '16px' }}>
        <SafeResponsiveContainer width="100%" height={260} style={{ flexShrink: 0 }}>
...
export const WidgetSpeciesSwap = () => (
  <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', height: '100%', flexShrink: 0 }}>
    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px', flexShrink: 0 }}>
      <Replace size={18} color="#d946ef" />
      <h3 style={{ margin: 0, fontSize: '1.2rem', color: '#f8fafc', fontWeight: 700 }}>[Sales] 대체재(틸라피아) 가격 교차탄력성</h3>
    </div>
    <div style={{ flex: 1, minHeight: 0, position: 'relative' }}>
      <div style={{ position: 'absolute', inset: 0, border: '1px solid rgba(255,255,255,0.05)', borderRadius: '8px', background: 'rgba(0, 0, 0, 0.2)', padding: '16px' }}>
        <SafeResponsiveContainer width="100%" height={260} style={{ flexShrink: 0 }}>
...
export const WidgetD2CRoi = () => (
  <div className={styles.insightCard} style={{ display: 'flex', flexDirection: 'column', height: '100%', flexShrink: 0 }}>
    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px', flexShrink: 0 }}>
      <Store size={18} color="#84cc16" />
      <h3 style={{ margin: 0, fontSize: '1.2rem', color: '#f8fafc', fontWeight: 700 }}>[Sales] D2C 이커머스 전향 플랫폼 취소율 극복 ROI</h3>
    </div>
    <div style={{ flex: 1, minHeight: 0, position: 'relative' }}>
      <div style={{ position: 'absolute', inset: 0, border: '1px solid rgba(255,255,255,0.05)', borderRadius: '8px', background: 'rgba(0, 0, 0, 0.2)', padding: '16px' }}>
        <SafeResponsiveContainer width="100%" height={260} style={{ flexShrink: 0 }}>
