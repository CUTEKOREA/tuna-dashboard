    ...
    <div className={styles.insightCard}>
        ...
        <div className={styles.chartContainer}>
          <SafeResponsiveContainer width="100%" height="100%">
            <BarChart data={byproductData} margin={{ top: 20, right: 30, left: 20, bottom: 30 }}>
              ...
              <XAxis dataKey="part" stroke="#94a3b8" tick={{ fill: '#cbd5e1', fontSize: 11, fontWeight: 500 }} angle={0} textAnchor="middle" interval={0} height={50} />
      ...
      <div style={{ padding: '0 20px 20px 20px' }}>
        <TakeawayBox
          ...
          actionPlan="**[Actionable Insight]** 부산물 폐기 비용(톤당 $50~80)을 바이오 소재 매출로 전환하십시오. ① 콜라겐 추출(껍질 28.5%): 화장품·건강기능식품 원료($15~25/kg) ② 어유(Roe DHA/EPA): 고급 오메가-3 원료($30~50/kg) ③ ACE 억제 펩타이드: 기능성 식품 소재($80~120/kg). 연간 부산물 87~174천톤의 10%만 고부가 전환 시 연매출 $50M+ 창출 가능해야 합니다. (Conviction Buy)"
    ...
    <div className={styles.insightCard}>
        ...
        <div className={styles.chartContainer}>
          <SafeResponsiveContainer width="100%" height="100%">
            <ComposedChart data={longlineData} margin={{ top: 20, right: 30, left: 20, bottom: 20 }}>
              <CartesianGrid strokeDasharray="3 3" stroke="rgba(255,255,255,0.1)" />
              <XAxis dataKey="period" stroke="#94a3b8" tick={{ fill: '#cbd5e1', fontSize: 11, fontWeight: 500 }} interval={0}  angle={0} textAnchor="middle" height={60} tickFormatter={truncateXAxis}/>
      ...
      <div style={{ padding: '0 20px 20px 20px' }}>
        <TakeawayBox
          ...
          actionPlan="**[Actionable Insight]** ① 연승어업의 '소수정예 고단가' 전환을 전략적 자산으로 재평가하십시오(척당 생산성 127t→129t 유지). ② MSC 미끼자원 인증 준비를 선제 착수하세요 — 인도네시아 풀가라지 MSY 대비 어획률(52.8%) 검증이 핵심입니다. ③ 태평양 조업 거점의 남위 이동(기후변화 적응)에 대비한 VDS 입어 포트폴리오를 재편하여 잉여현금흐름(FCF)을 극대화하십시오. (Strong Buy)"
    ...
    <div className={styles.insightCard}>
      ...
      <div style={{ padding: '0 20px 20px 20px' }}>
        <TakeawayBox
          ...
          actionPlan="**[Actionable Insight]** 인도양 소싱 시 자망 어획 원물을 회피하고 연승 어획물 비중을 확대하십시오. ① 연승 어획물은 전 지표에서 Low Risk(1.0~1.9)로 ESG 컴플라이언스 최적 ② IOTC TAC 강화(2027 예상) 시 자망 퇴출로 공급 15~20% 감소 가능 → 선제적 장기계약 필요 ③ t-RFMO 5개 기구의 해양포유류 보존관리조치(CMM) 준수 여부를 소싱 체크리스트에 즉시 반영하여 잉여현금흐름(FCF)을 극대화하십시오. (Strong Buy)"
    ...
    <div className={styles.insightCard}>
        ...
        <div className={styles.chartContainer}>
          <SafeResponsiveContainer width="100%" height="100%">
            <ComposedChart data={elderlyFoodData} margin={{ top: 20, right: 30, left: 20, bottom: 40 }}>
              <CartesianGrid strokeDasharray="3 3" stroke="rgba(255,255,255,0.1)" />
              <XAxis dataKey="product" stroke="#94a3b8" tick={{ fill: '#cbd5e1', fontSize: 11, fontWeight: 500 }} angle={0} textAnchor="middle" interval={0} height={60} />
              <YAxis yAxisId="left" stroke="#94a3b8" tick={{ fill: '#cbd5e1', fontSize: 12, fontWeight: 500 }} />
      ...
      <div style={{ padding: '0 20px 20px 20px' }}>
        <TakeawayBox
          ...
          actionPlan="**[Actionable Insight]** ① 눈다랑어 연화식 3종을 '실버 프리미엄' 라인으로 즉시 상품화하십시오(학교급식 + 요양시설 B2B 우선). ② 참치-황새치 40:60 어육패티를 HMR 채널로 출시 — 기존 육류 패티 대비 단백질 동등·지방 50% 저감을 USP로 활용. ③ 대서양참다랑어 양식 사료에 아마인유(Linseed Oil) 15% 대체가 성장률 무영향으로 검증되어(KFAS 2023) 사료비 절감 카드로 활용 가능해야 합니다. (Conviction Buy)"
