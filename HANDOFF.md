...
> - 남은 14.970 MT 는 MOAMARI #3-C 분이다 — 9/27 에 항차가 끝난다. **9/27 계획(사용자 전달)은 CMC #3-C MOAMARI 80 MT 인데 잔량은 14.970 MT 뿐이라 65.030 MT 어긋난다** — 계획값을 잔량에 맞추지 않고 둘 다 적었다(원문 메시지 날짜 「7/SEP」은 27일 오기로 보인다). 종료 시 최종 하역보고 메일(본부 1통 + 원선 MOAKONA·MOAMARI 2통) 준비.
