...
export default function SasPrGradeSystem() {
  return (
    <WidgetCard
      ...
      cardDesc="참치 사시미 등급 판정 기준·부위 지방함량·등급별 단가 배수 — 업계 관행(공식 표준 없음). 출처는 횟감 업계 통념 종합으로 1차 문헌·게시일 추적성 제한적, 수치는 참고치"
      takeaway={{
        situation: "참치 사시미 가격은 어종·중량보다 '등급(그레이드)'이 가릅니다. 등급은 #1(선홍색·투명감·고지방·탄력 — 최상급)부터 #3(적갈색·저지방 — 가열용)까지 색·지방·탄력으로 매겨지며, 꼬리 노치 절단면과 아가미 뒤 코어샘플(사시보)을 스포트라이트로 보고 황다랑어·눈다랑어는 색, 참다랑어는 지방으로 판정합니다. 부위별 지방은 오토로 25~30%(겨울 40%)·추토로 15~20%로, 소매가는 오토로가 아카미의 약 1.5배입니다. 단 이 등급은 법정 표준이 아니라 유통사별 편차가 있는 업계 관행·일본식 척도입니다.",
        ...
        source: "카탈리나 오프쇼어(Catalina Offshore)·새뮤얼스(Samuels)·BD아웃도어스(등급 #1~#3 판정 기준·사시보 코어샘플) / 스시 유니버시티(Sushi University)·우마미 인사이더(오토로 25~30%·추토로 15~20% 지방) / 후쿠야(Fukuya) 소매(오토로=아카미 약 1.5배). ※횟감 업계 통념 종합 — 1차 문헌·게시일 추적성 제한적, 공식 법정표준 아닌 업계 관행",
      }}
      customBody={
