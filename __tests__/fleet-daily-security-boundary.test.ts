...
describe('fleet daily public and private DTO boundary', () => {
  it('publishes only aggregate values and derived quality counts', () => {
    expect(fleetDailyPublic).toEqual({
      ...
      reconciliation: {
        pacificDaily: { reportedMt: 130, rowsMt: 130, matches: true, missingCount: 0 },
        atlanticDaily: { reportedMt: 205, rowsMt: 205, matches: true, missingCount: 0 },
        carrierLoaded: { reportedMt: 9_922.3, rowsMt: 9_922.3, matches: true, missingCount: 0 },
        carrierExpectedRemaining: { reportedMt: 7_887.7, rowsMt: 7_887.7, matches: true, missingCount: 0 },
        valid: true,
        unavailableCount: 0,
        issueCount: 0,
      },
