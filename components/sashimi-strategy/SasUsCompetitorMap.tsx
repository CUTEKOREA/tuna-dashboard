...
/* ── 미국 참치 수입·유통 경쟁 구도 (업계 2차 매체 종합) ──
   ...
   FCF(대만) 연매출 약 17억달러(2020 추정) + Bumble Bee 인수 기업가치 9.256억달러(2020, 파산법원 19-12502 Dkt.17 ¶66 — 현금 2.75억),
...
const PLAYERS = [
  ...
  { flag: '🇹🇼', name: 'FCF (대만)', tag: '글로벌 참치 트레이딩 + 캔 수직계열', rc: '#38bdf8',
    stats: [['연매출', '약 17억달러 (2020 추정)'], ['Bumble Bee 인수', '기업가치 9.256억달러 (2020)'], ['지배력', '원물 조달~브랜드 통합']] },
  ...
  return (
    <WidgetCard
      ...
      takeaway={{
        ...
        source: "공개 2차 매체 종합(1차 교차검증 미실시) - True World Foods 공식·Wikipedia·SeafoodSource(글로벌 23센터·8,200레스토랑·TWF 연매출 5억달러+ 2020) / Undercurrent·Food Dive(FCF 연매출 약 17억달러 2020 추정) / Bumble Bee 인수가는 파산법원 19-12502 Dkt.17 ¶66(기업가치 9.256억달러·현금 2.75억) / 시장조사 2차(StarKist 47.5% 2022; 동원 IR 공식 약 46%)",
      }}
      customBody={
