...
export default function FleetOperationStatus() {
  ...
  const carrierFleet = [
    { name: 'SEIN PHOENIX (7,100)', load: '6,955t', note: 'NT-1,080, MK-750, S-420, J-1,030, P-1,080, H-930, MI-485, S-1,180 | BKK 하역 완료' },
    ...
    { name: 'SHIN FUJI (3,200)', load: '3,096t', note: 'MI-950, NS-670, E-306, NT-900, P-270 | BKK 하역 중' },
