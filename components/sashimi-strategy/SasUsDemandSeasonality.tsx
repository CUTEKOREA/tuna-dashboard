...
/* ── 미국 참치 수요 드라이버 + 계절성 ──
   검증: NFI 1인당 캔참치 2.2lb/년, IFIC 단백질 추구 67%→71%(2025),
   FMI Power of Seafood 해산물 섭취 증가 응답 54%.
...
const DRIVERS = [
  { label: '1인당 캔참치 소비', value: '2.2', unit: 'lb/년', sub: 'NFI Top10 수산물', color: '#38bdf8' },
  { label: '단백질 추구 소비자', value: '71', unit: '% (2025)', sub: 'IFIC 67%→71% 상승', color: '#10b981' },
  { label: '해산물 섭취 증가 응답', value: '54', unit: '%', sub: 'FMI 2025 · 2년전 대비', color: '#f59e0b' },
];
...
export default function SasUsDemandSeasonality() {
  return (
    <WidgetCard
      ...
      cardDesc="수요 구조 — NFI 1인당 소비·IFIC 단백질 트렌드·FMI 해산물 섭취 + 계절 수요 정성 인덱스"
      takeaway={{
        situation: "미국 참치 수요는 구조적 단백질 전환이 견인합니다. 단백질을 적극 추구하는 소비자가 2022년 59%→2025년 71%로 늘었고(IFIC), 1인당 캔참치 소비는 2.2lb/년(NFI 상위 수산물), 2년 전 대비 해산물 섭취가 늘었다는 응답이 54%(FMI 2025)입니다. 계절적으로는 여름 그릴링 시즌(6~8월)과 연말(12월) 스시·외식 수요가 피크를 이루며, 정성 수요 인덱스는 7월 100·2월 70으로 약 1.4배 변동합니다.",
        ...
        source: "NFI Top 10 Seafood(1인당 2.2lb) / IFIC Food & Health Survey 2025(단백질 71%) / FMI Power of Seafood 2025(54%). 계절 인덱스는 그릴링·연말 수요 패턴 기반 정성 추정",
      }}
      customBody={
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', width: '100%' }}>
          ...
          <div style={{ textAlign: 'center', fontSize: '0.62rem', color: '#94a3b8', marginTop: '-4px' }}>
            🔥 여름 그릴링(7월 100) · 🎄 연말(12월 93) 피크 · 비수기 2월 70
          </div>
