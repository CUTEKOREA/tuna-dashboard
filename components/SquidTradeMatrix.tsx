      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'minmax(280px, 1fr) 2fr', gap: '20px', marginTop: '16px' }}>
        ...
        <div style={{ display: 'flex' }}>
          <TakeawayBox
            ...
            actionPlan="**[Actionable Insight]** 대중국 원물 집중화에 대응하기 위해, 중국 칭다오 가공 거점을 단순히 경유하는 기존 소싱을 우회할 루트를 찾아야 합니다. 중국의 태국 및 동남아시아향 가공 수출 물량을 파악하고, 베트남(가공 단가 유리)이나 인도네시아(원물 조달 유리)에 자체 가공/물류 스포크를 배치함으로써 중국 수출 통제 리스크와 중간 마진을 최소화하는 다이렉트 소싱 파트너십을 구축해야 합니다. (Conviction Buy)"
          />
        </div>
      </div>
    </div>
