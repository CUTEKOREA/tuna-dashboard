...
return (
    <div className={styles.insightCard}>
      ...
      <TakeawayBox
        ...
        actionPlan="**[Actionable Insight]** [리스크 헷지 실행] ① KORUS FTA 관세차익 활용으로 미국 관세 리스크 제로화, ② 블록체인 기반 이력추적 시스템 구축으로 강제노동법 컴플라이언스 확보, ③ EU CBAM 대비 탄소배출 인벤토리 선제 구축을 즉각 실행해야 해야 합니다. (Conviction Buy)"
  ...
  return (
    <div className={styles.insightCard}>
      ...
      <TakeawayBox
        ...
        actionPlan="**[Actionable Insight]** [FTA 최적화 실행] ① 원산지 증명서 자동화 시스템 구축으로 FTA 특혜관세 적용률 95% 이상 달성, ② 한-ASEAN FTA 활용 태국 경유 가공 루트로 EU 수출 시 추가 관세 절감, ③ WITS API 실시간 모니터링으로 관세 변동 즉시 대응 체계를 가동해야 해야 합니다. (Conviction Buy)"
