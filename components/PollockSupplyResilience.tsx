  ...
  return (
    <div className={styles.card}>
      <div className={styles.cardHeader}>
        ...
        <h3 className={styles.cardTitle}>W-SR1 · 명태 수입원 집중도(HHI) 위기 추적기</h3>
      </div>
      <div style={{ background: 'rgba(239,68,68,0.08)', border: '1px solid rgba(239,68,68,0.2)', padding: '8px 12px', borderRadius: '8px', marginBottom: '12px', fontSize: '0.75rem', color: '#fca5a5' }}>
        📋 근거: (일반 2023-10) 전략품목 관리 | HHI 2,500+ 고집중, 6,000+ 극단적 집중 | KCS + Comtrade
      </div>
  ...
  return (
    <div className={styles.card}>
      <div className={styles.cardHeader}>
        ...
        <h3 className={styles.cardTitle}>W-SR2 · 대체 소싱 옵션 레이더</h3>
      </div>
      <div style={{ background: 'rgba(59,130,246,0.08)', border: '1px solid rgba(59,130,246,0.2)', padding: '8px 12px', borderRadius: '8px', marginBottom: '12px', fontSize: '0.75rem', color: '#93c5fd' }}>
        📋 근거: (일반 2024-05) 공급망 관리 개선 | 5개국 6축 평가 (원가/품질/신뢰성/ESG/장벽)
      </div>
...
export function PollockSubstituteElasticity() {
  ...
  return (
    <div className={styles.card}>
      <div className={styles.cardHeader}>
        <Anchor size={18} color="#8b5cf6" />
        <h3 className={styles.cardTitle}>W-SR3 · 수리미 대체 어종 교차탄력성</h3>
      </div>
      <div style={{ background: 'rgba(139,92,246,0.08)', border: '1px solid rgba(139,92,246,0.2)', padding: '8px 12px', borderRadius: '8px', marginBottom: '12px', fontSize: '0.75rem', color: '#c4b5fd' }}>
        📋 근거: (일반 2022-11) 수입수산물과 국산 간의 대체관계 분석 | 명태 수리미 → 대체 어종 전환점 분석
      </div>
