  ...
  it('publishes only aggregate values and derived quality counts', () => {
    expect(fleetDailyPublic).toEqual({
      _meta: {
        ...
        latestReportDate: '2026-09-09',
        latestAsOf: '2026-09-08',
      ...
      latest: {
        ...
        asOf: '2026-09-08',
        pacific: { asOf: '2026-09-08', dailyMt: 71, monthlyMt: 886, annualMt: 49_126.8 },
        atlantic: { asOf: '2026-09-08', dailyMt: 140, monthlyMt: 1_180, annualMt: 34_640 },
        carrier: { loadedTotalMt: 7_684.1, expectedRemainingMt: 3_556.7 },
      },
      deltas: { pacificDailyMt: 46, atlanticDailyMt: 90, totalDailyMt: 136 },
      reconciliation: {
        pacificDaily: { reportedMt: 71, rowsMt: 71, matches: true, missingCount: 0 },
        atlanticDaily: { reportedMt: 140, rowsMt: 140, matches: true, missingCount: 0 },
      ...
      quality: {
        counts: {
          reconciliationChecks: 608,
          reconciliationCompleteChecks: 608,
