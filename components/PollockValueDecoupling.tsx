  ...
  return (
    <div style={{
      ...
      <TakeawayBox
        ...
        actionPlan="이는 명태를 활용한 수리미(Surimi, 연육) 시장의 수요 증가와 조업 매입원가 상승이 결합된 강력한 원자재 인플레이션 시그널입니다. 최종재(어묵, 식자재 등)의 소비자가판가 인상이 불가피하며, 원물을 대량 사입해 재고를 우선 확보하는 롱 포지션 전략이 재고 손실 가치를 방어할 유일한 수단입니다."
      />
    </div>
  );
}
