    ...
    const mockData = {
      ...
      widgets: [
        ...
        },
        {
          ...
          sit: <>베트남은 태국 대비 전력료와 인건비(지수 38 vs 100)가 으로 저렴하나 통관 및 전력망 불안정 리스크에 노출. 반면 태국은 운영비(OPEX)는 높지만 아세안 물류 허브로서의 통제력과 전문 인프라를 보유, 구조적 프리미엄을 향유 중임.</>,
        ...
        },
        {
          ...
          sit: '베트남 콜드체인 시장은 글로벌 최고 수준인 CAGR 12.4% 성장 중(2024년 1.3M → 2028년 1.7M 팔레트 전망)이나, 인프라 미충족률이 80%에 육박함. 향후 3~5년이 초과 수익을 창출할 수 있는 진입의 절대적 골든 윈도우임.',
        ...
        },
        {
          ...
          sit: '태국(RDC 허브)과 베트남(가공·수출 기지)을 연계한 Bi-Node 이원화 전략은 단일 거점 대비 5년 NPV 추정치가 75% 이상 높게 도출됨. 태국의 전력망 안정성 및 BOI 인센티브, 베트남의 원가 경쟁력이 강한 상호 보완재(Complementary Goods)로 작용함.',
        ...
        },
        {
          ...
          sit: '동결건조(HMR) 수산 블록은 -20°C에서 36개월, 25°C 상온에서도 무려 14개월의 장기 유통이 가능(KFAS 실증). 고온 노출 시 TBA(지방산화) 급증 리스크만 통제하면 콜드체인 운영비(OPEX)를 80% 이상 혁신적으로 절감할 수 있는 게임 체인저()임.',
