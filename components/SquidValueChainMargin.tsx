...
export default function SquidValueChainMargin() {
  ...
  return (
    <div className={styles.glassCard} ref={containerRef}>
      ...
      <TakeawayBox
        situation="한국산 오징어 고갈로 대왕오징어가 대체재로 떠올랐지만, 중국 내 가공 공장의 인건비 상승(파란 영역)이 원물가(노란 영역) 이상으로 급증하며 최종 수입 단가를 밀어올리고 있습니다. 최근에는 소비자가(붉은 선) 상승이 매입원가 인상을 따라가지 못해 국내 상사들의 채산성이 악화되었습니다."
