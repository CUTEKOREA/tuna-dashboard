  ...
  return (
    <div className={s.wrapper}>
      ...
      <div style={{ background: 'var(--panel-bg)', border: '1px solid var(--panel-border)', borderRadius: 'var(--card-radius)', padding: 24 }}>
        <TakeawayBox
          situation={<>6/18 기준 SEIN PHOENIX BKK 하역 완료, BAO LUCKY BKK 하역 중, SHIN FUJI BKK 하역 대기 중, SHIN IZU 통영 하역 중. SEIN TOPAZ TARAWA 대기 중, SEIN GALAXY·LAKE WIN FUNAFUTI 대기 중. S/HAR 부산 오리엔트 조선 상가수리 진행. S/JUP 6/18 출항 완료, SEIN KASAMA 편 M/E 수리 예정. P/DIS 파망 사고 수리 중, P/GRACE 하역 후 6/18 출항 예정.</>}
