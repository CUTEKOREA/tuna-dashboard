...
/* ── EU 원양 선망 선단의 인도양 황다랑어 자원 리스크 (IOTC 1차) ──
   검증(solid, 2024 IOTC SC27 / 데이터 최종연도 2023): 2023 어획 400,950t, 최근20년 MSY 421,000t(416-430),
   2019-23 평균어획 423,142t. F2023/FMSY=0.2·SB2023/SBMSY=1.32 → 과잉어획 아님·과잉어획 진행 아님(green).
   EU 보유 선망·보급선 50척+(7개 EU기업 ~90% 지배). Pew·Blue Marine은 평가 방법론 신중론.
...
const STOCK = [
  ...
  { label: 'MSY 상한', t: 421, color: '#f59e0b' },
...
export default function SasEuDistantFleet() {
  return (
    <WidgetCard
      ...
      takeaway={{
        situation: "EU 사시미/스테이크 원료(신선·냉동 황다랑어)의 상류 공급원은 스페인·프랑스가 운영하는 인도양 원양 선망선단으로, EU 보유 선망·보급선 50척+(7개 EU 기업이 약 90% 지배)이 인도양 열대다랑어 어획의 약 1/3을 책임집니다. 최신 평가 기준으로 — 2024년 IOTC 과학위(SC27, 데이터 최종연도 2023)는 인도양 황다랑어 MSY를 약 421,000톤(416-430)으로 상향하고 2023년 어획(약 400,950톤)·5년 평균어획(423,142톤)을 반영해 'green'(과잉어획 아님·과잉어획 진행 아님, F2023/FMSY=0.2)으로 판정했습니다. 이는 직전(2021) 평가의 'MSY 약 349,000톤 초과·30% 감축 권고' 서사를 뒤집은 것으로, 자원 서사가 분기점에 섰습니다(Pew·Blue Marine은 평가 방법론에 신중론).",
        ...
        source: "IOTC SC27 2024(MSY 421,000t·2023 어획 400,950t·5년평균 423,142t·green 판정, 데이터 최종연도 2023) / 직전 IOTC 2021 평가(구 MSY ~349,000t·30% 감축 권고, 갱신됨) / SeafoodSource·AP(EU 선단 50척+·약 1/3 점유)",
      }}
      customBody={
          ...
          <div style={{ height: '180px', width: '100%' }}>
            <SafeResponsiveContainer width="100%" height="100%">
              <BarChart data={STOCK} margin={{ top: 18, right: 16, left: 0, bottom: 0 }}>
                ...
                <ReferenceLine y={421} stroke="#f59e0b" strokeDasharray="4 4" />
