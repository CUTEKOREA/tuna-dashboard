  ...
  it('publishes only aggregate values and derived quality counts', () => {
    expect(fleetDailyPublic).toEqual({
      _meta: {
        ...
        latestAsOf: '2026-08-25',
        detailSha256: expect.stringMatching(/^[a-f0-9]{64}$/),
      },
      latest: {
        reportDate: '2026-08-26',
        asOf: '2026-08-25',
        pacific: { asOf: '2026-08-25', dailyMt: 25, monthlyMt: 2_813, annualMt: 47_645.8 },
        atlantic: { asOf: '2026-08-25', dailyMt: 190, monthlyMt: 5_130, annualMt: 31_855 },
        carrier: { loadedTotalMt: 8_763.3, expectedRemainingMt: 5_771.7 },
      },
      deltas: { pacificDailyMt: -95, atlanticDailyMt: -245, totalDailyMt: -340 },
      reconciliation: {
        pacificDaily: { reportedMt: 25, rowsMt: 25, matches: true, missingCount: 0 },
        atlanticDaily: { reportedMt: 190, rowsMt: 190, matches: true, missingCount: 0 },
      ...
      quality: {
        counts: {
          reconciliationChecks: 568,
          reconciliationCompleteChecks: 568,
