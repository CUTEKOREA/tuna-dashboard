...
export type HsEntry = {
  ...
  hsk10?: string[];   // HSK 10자리 전체 스코프 (L-04: KCS 호출은 10자리 의무)
...
export const HS_CODES = {
  ...
  shrimp_frozen: {
    label: '냉동 새우',
    hsSgn: '0306171090',
    // 관세청 스냅샷(2026-07-06, 2026.01~05 실측)에서 확인한 HSK 10자리.
    // 6자리 030617만 쓰면 조제(1605)가 빠져 베트남 수입액이 45% 사라진다.
    hsk10: [
      '0306161090', '0306169090',                               // 030616 냉동 보리새우류
      '0306171090', '0306179010', '0306179091', '0306179099',   // 030617 냉동 기타 새우
      '1605211000', '1605219000', '1605290000',                 // 1605 조제·저장 새우
    ],
    note: 'L-04(HSK 10자리 의무) 준수로 2026-08-13 6자리 030617에서 전환. 냉동 0306 16/17 + 조제 1605 21/29.',
  },
  ...
  // ⚠ 2026-08-17 정정: 기존 두 코드는 골뱅이가 아니었다.
  //   0307600000 은 달팽이(에스카르고, 2025년 상반기 수입 $0.06M), 1605550000 은
  //   문어 조제(중국산 $40.5M)다. 골뱅이 수입의 실체는 **자숙 냉동육**이라 조제(1605.59)로
  //   들어온다 — 2024년 $58.5M 중 영국 $30.5M(52.1%), 파이 위젯 주장과 일치 확인.
  //   캔 수입(1605591010 밀폐용기)은 사실상 0 — 캔은 국내 생산, 수입은 원료육.
  whelk_prepared: {
    label: '자숙·조제 골뱅이류 (기타 연체류 조제)',
    hsSgn: '160559',
    note: '6자리 상위 코드. 하위 1605591090(기타)이 수입의 대부분. 관세청 API 실측으로 검증 (2026-08-17).',
  },
  flatfish_fresh: {
    label: '가자미 신선',
    hsSgn: '0302230000',
