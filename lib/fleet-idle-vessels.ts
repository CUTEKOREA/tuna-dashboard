...
export const FLEET_IDLE_NOTES: Record<string, FleetIdleNote> = {
  MOAMARI: {
    asOf: '2026-09-04',
    headline: '프로펠러 볼트 3개 파손(선장 보고서 8/18 확정) 수리차 젠산 예인 중 · 계약 항해 24~26일 · 9/3·9/4 보고 연속 도착 9/28 · 항해 29일 예상 · 예인료 계약 일 $41,000, 29일 가정 시 약 119만불(16.5억원)으로 계약 대비 3~5일·$12.3~20.5만 초과 예상 · 복귀 10월 중순~11월 초 예상 · 조업손실 약 810~1,170 MT 예상',
    lines: [
      ...
      { label: '예인 진행 (예상)', text: '8/31 출발은 확정. 도착 예정은 9/2 보고의 9/29에서 9/3 보고에 9/28로 하루 당겨진 뒤, 9/4 보고에서도 9/28을 유지했다 — 이틀 연속 같은 값이라 추정이 일단 멎었다. 항해 29일, 평균 6.7노트 환산이다. 여전히 예상치이며 계약 상한(26일)보다 3일·하한(24일)보다 5일 늦다.' },
      ...
      { label: '조업손실', text: '마지막 어획 8/13부터 어장 복귀까지 56~81일이다. 보고 주기(149보고일 / 232달력일)로 환산하면 36~52보고일이고, 일평균 22.58 MT를 곱해 약 810~1,170 MT다. 8/14 이후 이미 발생한 분을 포함한 값이며 MOAMARI 연간 실적 3,365 MT의 24~35%에 해당한다.' },
      { label: '확정 / 예상 구분', text: '확정은 사고 경위(8/17 접안 중 로프 감김)·프로펠러 볼트 3개 파손·출발지·도착지·일 $41,000·계약 항해 24~26일·8/31 출발이다. 프로펠러 추가 손상 여부, 도착 9/28, 항해 29일, 총 예인료 약 119만불, 수리 3~28일, 복귀 10/8~11/2, 조업손실 810~1,170 MT은 전부 예상치 또는 미확인이다. 도착 예정일은 일일보고에서 바뀐다 — 9/2 보고 9/29 → 9/3 보고 9/28 → 9/4 보고 9/28(유지). 잠수부 점검 결과·젠산 조선소 견적·실제 도착일이 나오면 갱신한다.' },
    ],
  },
};
