  ...
  it('publishes only aggregate values and derived quality counts', () => {
    expect(fleetDailyPublic).toEqual({
      ...
      latest: {
        ...
        asOf: '2026-08-20',
        pacific: { asOf: '2026-08-20', dailyMt: 33, monthlyMt: 2_417, annualMt: 47_249.8 },
        atlantic: { asOf: '2026-08-20', dailyMt: 320, monthlyMt: 3_745, annualMt: 30_470 },
        carrier: { loadedTotalMt: 11_492.3, expectedRemainingMt: 6_317.7 },
      },
      deltas: { pacificDailyMt: 20, atlanticDailyMt: 150, totalDailyMt: 170 },
      reconciliation: {
        pacificDaily: { reportedMt: 33, rowsMt: 33, matches: true, missingCount: 0 },
      ...
      quality: {
        counts: {
          reconciliationChecks: 552,
          reconciliationCompleteChecks: 552,
