        ...
        <div className={styles.card}>
          ...
          <div className={styles.cardBody}>
            ...
            <TakeawayBox 
              ...
              actionPlan="통조림 공장의 폐수 처리 비용을 '매출 원천'으로 전환하는 극단적 ESG 순환 경제 모델을 전면에 내세워야 합니다." 
        ...
        <div className={styles.card}>
          ...
          <div className={styles.cardBody}>
            ...
            <TakeawayBox 
              ...
              actionPlan="주요 원물인 소형 다랑어의 어획 쿼터 축소로 인한 단가 급등이 예상되므로, 즉각적인 안전 재고 6개월분 선제 확보가 필수적입니다." 
      ...
      <div className={styles.card} style={{ marginBottom: '1.5rem' }}>
        ...
        <div className={styles.cardBody}>
          ...
          <TakeawayBox 
            ...
            actionPlan="원물 가격 상승 리스크가 낮은 참치액의 압도적 마진 디커플링을 무기로 삼아, 고환율 시기에 공격적 마케팅 비용을 투입해 경쟁사를 도태시켜야 합니다." 
            ...
            <div style={{ minHeight: '350px', background: 'rgba(0,0,0,0.2)', padding: '1.5rem', borderRadius: '8px' }}>
              {activeResearchTab === 'K01' && (
                <>
                  ...
                  <TakeawayBox situation="자숙 부산물은 히스타민 45mg/kg(기준 200 이하)으로 극도로 안전하며, 조단백 24.8%로 영양성도 뛰어남." actionPlan="수출 시 '자숙 공정 인증 원료' 라벨을 도입하여 타 발효수산물 대비 압도적 안전성을 무기로 삼으십시오." source="KFAS 한국수산과학회지" />
                </>
              )}
              ...
              {activeResearchTab === 'K07' && (
                <>
                  ...
                  <TakeawayBox situation="쌀코지 첨가 저염(10%) 발효 시 유리아미노산 급증 및 관능 최고점 달성." actionPlan="5060 건강 타겟 '저염 참치액젓(나트륨 50%↓)'을 출시하여 30%의 가격 프리미엄을 확보하십시오." source="KFAS 한국수산과학회지" />
                </>
              )}
              {activeResearchTab === 'K08' && (
                <>
                  ...
                  <TakeawayBox situation="Aminopeptidase 효소 처리 시 쓴맛이 75% 감소하고 감칠맛이 폭발적으로 상승." actionPlan="'제로 비린내, 순수 감칠맛' 라인을 신설하여 기존 멸치/까나리의 한계를 극복하는 핵심 기술로 편입하십시오." source="KFAS 한국수산과학회지" />
                </>
              )}
        ...
        <div className={styles.card}>
          ...
          <div className={styles.cardBody}>
            ...
            <TakeawayBox 
              ...
              actionPlan="현재 SCFI 하락 국면을 활용하여, 3개월 후 예상되는 저운임 시기에 원료 수입 물량을 집중하는 '물류 스케줄 헷징' 전략을 실행하십시오." 
        ...
        <div className={styles.card}>
          ...
          <div className={styles.cardBody}>
            ...
            <TakeawayBox 
              ...
              actionPlan="기존 태국 단일 소싱에서 탈피하여 베트남 OEM 물량을 45%까지 즉각 확보하는 '차이나 플러스 원(China+1)' 방식의 다변화가 필요합니다." 
        ...
        <div className={styles.card}>
          ...
          <div className={styles.cardBody}>
            ...
            <TakeawayBox 
              ...
              actionPlan="소비자 인식에서 멸치/까나리를 압도했으므로, 이제는 전통 간장 수요층을 완전히 흡수하는 '만능 조미료' 브랜딩에 마케팅 예산을 집중하십시오." 
        ...
        <div className={styles.card}>
          ...
          <div className={styles.cardBody}>
            ...
            <TakeawayBox 
              ...
              actionPlan="전통 액젓 가격 급등으로 원가 압박을 받는 HMR/외식 프랜차이즈 B2B 시장을 집중 공략하여 '안정적 공급가 보장'을 무기로 B2B 계약을 싹쓸이해야 합니다." 
        ...
        <div className={styles.card}>
          ...
          <div className={styles.cardBody}>
            ...
            <TakeawayBox 
              ...
              actionPlan="가장 엄격한 FDA 기준(50ppm)을 통과하는 수출 전용 '저히스타민 라인' 인증을 선점하여 북미 한인마트 및 아시안 소스 시장을 독점하십시오." 
