    ...
    <>
      <div className={styles.insightCard}>
        ...
        <div style={{ padding: '0 20px 20px 20px' }}>
          <TakeawayBox
            situation="태국 등 1차 원물 허브 매입가와 EU/미주향 2차 가공 수출가 간의 구조적 괴리를 정량 추적 중입니다. 2021년 물류 대란 이후 운임 상승폭을 흡수하고도 톤당 스프레드가 $3,450을 돌파하는 등 초과수익 구간이 형성되었습니다."
            actionPlan="단순 원물 트레이딩 볼륨을 축소하고, 가공 차익(Processing Margin)을 극대화하는 \'Value-Add\' 라인으로 자본을 전면 재배치해야 합니다. 특히 EU향 무관세 혜택이 있는 에콰도르 내 톨링 파트너십을 즉시 체결하여 규제 차익까지 동시에 확보하여 잉여현금흐름을 극대화하십시오."
          />
        </div>
      </div>
      ...
      <div className={styles.insightCard}>
        ...
        <div style={{ padding: '0 20px 20px 20px' }}>
          <TakeawayBox
            situation="과거 미국·일본이 주도하던 가공 패권이 지정학적 임금 인플레이션 및 관세 장벽으로 인해 해체되며, 에콰도르(글로벌 가공 hub M/S 26%, 2023) 및 베트남 중심의 신흥 오프쇼어링 허브로 시장 재편이 완료되는 국면입니다. *EU pre-cooked loin 좁은 segment 기준으로는 에콰도르 M/S 32~42%(TunaNewInsightsA 참조).*"
            actionPlan="미국 및 일본 내 On-shore 가공 설비를 보유한 경쟁사들의 한계 비용이 한계선에 도달했습니다. 우리는 중남미(에콰도르)의 기구축된 밸류체인을 활용해, 북미 리테일러향 \'관세 회피 프라이빗 라벨\' 장기 공급 계약을 선점하는 우회 진입 전략을 즉각 승인해야 합니다."
          />
        </div>
      </div>
      ...
      <div className={styles.insightCard}>
        ...
        <div style={{ padding: '0 20px 20px 20px' }}>
          <TakeawayBox
            situation="1인당 GDP 상승 곡선과 맞물려 상온 보관 단백질 수요가 폭발하는 \'소비 블랙홀\' 국가들의 데이터입니다. 특히 나이지리아 등 아프리카/중동 권역에서 연평균 성장률 20% 이상의 비선형적 폭발이 관측됩니다."
            actionPlan="선진국의 저성장 굴레에서 벗어나, 아프리카 및 중동 내 1차 벤더 지분을 전략적으로 인수하거나 조인트벤처를 설립하십시오. 초기 진입 시 저가 블렌딩 스킵잭 라인업으로 시장 점유율을 장악한 뒤, 프리미엄 라인으로 마진을 확대하는 2-Step 침투 전략을 집행해야 합니다."
          />
        </div>
      </div>
    </>
  ...
  const renderCaptureTrack = () => (
    <>
      <div className={styles.insightCard}>
        ...
        <div style={{ padding: '0 20px 20px 20px' }}>
          <TakeawayBox
            situation="엘니뇨/라니냐 사이클에 따른 중서부태평양 어획량의 변동성이 대서양 조업량과 강한 음의 상관관계를 보이고 있습니다. 2015년, 2023년 기후 충격 당시 대서양이 +42%의 손실 보전 역할을 수행했습니다."
            actionPlan="기상 이변은 리스크가 아니라 기회입니다. 글로벌 ENSO(엘니뇨 남방진동) 지수가 1.5 임계치를 돌파하는 즉시, 태평양 선단의 30%를 대서양 공해상으로 전진 배치하는 \'동적 헷징 매뉴얼\'을 전격 가동하십시오. 기상 리스크를 선제적 조업권 확보의 무기로 전환해야 합니다."
          />
        </div>
      </div>
      ...
      <div className={styles.insightCard}>
        ...
        <div style={{ padding: '0 20px 20px 20px' }}>
          <TakeawayBox
            situation="참치 어획량 급감에 따른 단가 폭등 시, 대체 단백질인 펠라직(고등어 등 표층수 어종) 수요가 수직 상승하는 강력한 역상관관계(-0.78, Negative Correlation) 지표입니다. 대체재 간의 강한 헷지 효과입니다."
            actionPlan="참치 단일 어종에 의존하는 \'One-trick Pony\' 비즈니스 모델을 즉시 폐기하십시오. 참치 흉어 리스크를 재무적으로 완전 상쇄할 수 있도록, 스칸디나비아산 고등어 쿼터 확보 및 트레이딩 부서를 통합 신설하여 \'펠라직 인덱스 펀드\' 관점의 다각화된 상품 포트폴리오를 구축해야 합니다."
          />
        </div>
      </div>
      ...
      <div className={styles.insightCard}>
        ...
        <div style={{ padding: '0 20px 20px 20px' }}>
          <TakeawayBox
            situation="태평양 도서 국가 라인에서 발원하는 수출 통관량과 실제 수입 반영량 간의 거대한 이격은 해상 전재 기반의 불법·비보고·비규제 블랙마켓 볼륨입니다. ESG 규제 당국의 다음 타겟이 될 시한폭탄입니다."
            actionPlan="무역 불일치 물량이 당사의 소싱 파이프라인에 1%라도 섞여 들어올 경우, 서구권 메이저 리테일러의 상장 폐지급 벤더 퇴출 리스크가 존재합니다. 즉시 제3자 블록체인 이력 추적 시스템을 도입하여 밸류체인의 무결성을 투명하게 증명하고, 이를 마케팅 무기로 역활용하여 잉여현금흐름을 극대화하십시오."
          />
        </div>
      </div>
    </>
  ...
  const renderPremiumTrack = () => (
    <>
      <div className={styles.insightCard}>
        ...
        <div style={{ padding: '0 20px 20px 20px' }}>
          <TakeawayBox
            situation="2015년 임계점을 기점으로, 품질 균일성과 지방률 정밀 통제가 가능한 양식 참치의 톤당 단가가 자연산 야생 어획 단가를 추월(+31.9% 프리미엄)하는 패러다임 역전이 고착화되었습니다."
            actionPlan="불확실성이 극심한 원양 어선 건조에 대한 CAPEX 승인을 전면 보류하십시오. 조업 의존형 구조에서 탈피하여, 지중해 및 호주 등지의 최상위 지분 구조를 가진 양식 인프라 또는 배양 기술 스타트업으로 전사적 투자가용자본을 전면 이동시켜야 해야 합니다."
          />
        </div>
      </div>
      ...
      <div className={styles.insightCard}>
        ...
        <div style={{ padding: '0 20px 20px 20px' }}>
          <TakeawayBox
            situation="kg당 $30 이상의 막대한 지불 용의(Willingness to Pay)를 지닌 초프리미엄 미식(Gastronomy) 시장 지형입니다. 전통적 코어 마켓인 일본($28/kg)의 소비력이 정체된 반면, UAE(두바이) 및 홍콩 등 신진 부유층 마켓이 최고가 수요 블랙홀로 부상 중입니다."
            actionPlan="도쿄 츠키지/토요스 시장을 거치는 기존의 다단계 중간 유통 구조를 즉각 해체하십시오. 최상급 O-Toro(대뱃살) 등 하이엔드 컷은 항공 냉장 콜드체인을 통해 두바이, 리야드 등 중동 VVIP 럭셔리 호스피탈리티 채널로 직결하는 고마진 파이프라인을 구축해야 합니다."
          />
        </div>
      </div>
    </>
  ...
  const renderMacroTrack = () => (
    <>
      <div className={styles.insightCard}>
        ...
        <div style={{ padding: '0 20px 20px 20px' }}>
          <TakeawayBox
            situation="글로벌 수출국 상위 3개국의 어획 할당 통제력이 심화되며, 시장 집중도(HHI)가 리스크 수위인 2,950(Danger Zone)을 돌파했습니다. 이는 글로벌 바이어(캔 제조사)들의 네고 권력이 붕괴되고 원자재 공급사들의 마진 스퀴즈(Margin Squeeze) 횡포가 본격화되었음을 시사합니다."
            actionPlan="조달 원가 폭등 리스크가 임박했습니다. 현물 시장에서의 단기 매입 비중을 최소화하고, 핵심 선단과의 3~5년 단위 장기 선도계약 혹은 상호 지분 스왑을 체결하여 원가 변동성을 락인하는 강력한 헤지 포지션을 구축해야 합니다."
          />
        </div>
      </div>
      ...
      <div className={styles.insightCard}>
        ...
        <div style={{ padding: '0 20px 20px 20px' }}>
          <TakeawayBox
            situation="지난 30년간 글로벌 해수온 펀더멘털 변화로 인해 한대성 어종(Bluefin)의 생물량은 침식당하고 열대성 어종(Skipjack)이 88% 시장을 지배(Dominance)하는 영구적 생태계 역전(Ecosystem Inversion) 궤적입니다."
            actionPlan="당사의 장기 설비투자 타당성 검토 로직을 전면 수정하십시오. 10년 내용연수를 지닌 신규 참치선망어선 설계 시, 더 이상 축소되는 고위도 어장에 베팅하지 말고, 적도 부근 표층수 열대 어종 대량 포획 및 가공 효율에 최적화된 하드웨어 스펙으로 과감한 피벗을 승인해야 합니다."
          />
        </div>
      </div>
    </>
  ...
  const renderInnovationTrack = () => (
    <>
      <div className={styles.insightCard}>
        ...
        <div style={{ padding: '0 20px 20px 20px' }}>
          <TakeawayBox
            situation="맹목적 탐색 조업(Blind Searching)의 시대가 종료되었습니다. 3D 소나 및 위성 통신 기반 AI 집어장치(FADs)의 결합으로 조업 성공률(CPUE)은 비약적으로 상승(+15%)하는 동시에 핵심 매입원가인 선박 연료비(MGO Cost)는 급감(-28%)하는 전형적인 기술-매입원가 구조 혁신(J-Curve)이 발생 중입니다."
            actionPlan="구형 아날로그 선단의 퇴출이 임박했습니다. 즉각 전 선단에 대한 디지털 레트로핏 CAPEX 예산을 승인하십시오. 정밀 조업 시스템 장착은 단순 매입원가 절감을 넘어, 다가오는 해운업계 스코프 3 탄소 배출 규제 페널티를 회피하는 가장 확실한 ESG 재무 헷징 수단입니다."
          />
        </div>
      </div>
      ...
      <div className={styles.insightCard}>
        ...
        <div style={{ padding: '0 20px 20px 20px' }}>
          <TakeawayBox
            situation="월마트, ALDI 등 글로벌 유통 채널 캡틴들이 MSC(해양관리협의회) 미인증 제품을 소싱 리스트에서 영구 퇴출(De-listing)시키고 있습니다. MSC 및 돌고래 안전(Dolphin-Safe) 듀얼 인증 확보 여부가 판가에 최대 +81%의 독점적 프리미엄(Monopoly Rent)을 부여하는 핵심 라이선스로 격상되었습니다."
            actionPlan="인증 확보는 더 이상 CSR 부서의 마케팅 비용이 아니라, 생존과 초과수익을 가르는 핵심 무형자산입니다. 전 선단 및 가공 라인의 MSC-COC 인증 획득 및 갱신을 전사 최우선 CEO KPI로 락인하고, 인증 획득에 소요되는 컨설팅 비용을 무제한 승인하여 잉여현금흐름을 극대화하십시오."
          />
        </div>
      </div>
      ...
      <div className={styles.insightCard}>
        ...
        <div style={{ padding: '0 20px 20px 20px' }}>
          <TakeawayBox
            situation="양식 참치의 생물학적 한계(극악의 사료전환효율 FIFO)와 글로벌 어분(Fishmeal) 매입원가 폭등이 결합되어, 푸드테크 기반의 식물성(Vegan) 및 세포 배양(Cultivated) 대체 참치 시장이 연 7.8% CAGR의 구조적 메가 트렌드($1.59B)로 폭발하고 있습니다."
            actionPlan="레거시 어획 산업의 단백질 생산 한계치에 도달했습니다. 벤처캐피털 조직을 즉각 가동하여 글로벌 세포 배양 수산물 스타트업에 대한 시리즈 A/B 지분 투자를 단행하십시오. 단일 생물 단백질 회사를 넘어 글로벌 \'Alt-Protein\' 포트폴리오를 거느린 푸드테크 지주사로 기업가치를 재평가 받아야 해야 합니다."
          />
        </div>
      </div>
      ...
      <div className={styles.insightCard}>
        ...
        <div style={{ padding: '0 20px 20px 20px' }}>
          <TakeawayBox
            situation="가공 공정에서 폐기되거나 사료용으로 헐값에 넘겨지던 52%의 참치 부산물(머리, 뼈, 내장)이 고양이용 프리미엄 펫푸드 및 바이오/해양 콜라겐 시장으로 전용(Upcycling)되면서, 본업(Canned Tuna 8.5%)을 압도하는 28.5%의 비정상적 초과 영업Bottom-line(순이익)률(Operating Margin)을 창출하고 있습니다."
            actionPlan="부산물은 폐기물이 아니라 가장 수익성 높은 숨겨진 캐시카우입니다. 어분 라인 매각을 즉시 중단하고, 부산물 원료를 활용한 자체 \'하이엔드 펫 밀 팩토리\' 및 바이오-오메가3 추출 설비 구축에 즉각적인 조인트 벤처 자본을 투입하여 밸류체인 완전 수직 계열화를 달성하여 잉여현금흐름을 극대화하십시오."
          />
        </div>
      </div>
    </>
