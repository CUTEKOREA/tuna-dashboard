...
return (
    <div className={styles.insightCard}>
      ...
      <TakeawayBox
        situation="[복합 정책 리스크 고조] 미국 상호관세(92점)와 강제노동법(88점)이 참치 산업의 최대 정책 리스크로 식별되었습니다. 6대 정책 리스크 종합 점수는 74점(B+)으로, 미국 관세 인상 시 한국 참치 가공품 수출 규모(KCS HSK 1604.14)에 미국 MFN 12.5~35% 차익을 적용한 시나리오 추정치는 연간 약 $280M 규모입니다."
...
export function FtaTariffOptimizer() {
  ...
  return (
    <div className={styles.insightCard}>
      ...
      <TakeawayBox
        situation="[관세 차익 기회] Korea→EU/US 루트에서 KORUS·한-EU FTA 적용 시 참치 가공품 관세가 0%. 한국 대미 수출액 × (미 MFN 12.5%/35% in oil) 차익 산정 시 연간 $12M+ 절감 효과가 추정됩니다(보고서 산식 기반)."
