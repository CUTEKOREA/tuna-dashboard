  ...
  return (
    <div className={styles.container}>
      ...
      <div style={{ fontSize: '14px', fontWeight: 'bold', color: 'var(--text-main)', marginBottom: '16px', display: 'flex', alignItems: 'center', gap: '8px' }}>
        ...
        <TermTooltip term="REEFER MOVEMENT SCHEDULE" description="[표 설명] 방콕 항구로 입항 예정인 운반선(Reefer)들의 세부 일정과 각 공장(Cannery)별 분배 예정 물량을 보여줍니다. 이를 통해 특정 캔 공장의 원재료 수급 현황을 파악할 수 있습니다." /> (01/05/26 - 07/05/26) : WEEK 18
