...
export const FLEET_IDLE_NOTES: Record<string, FleetIdleNote> = {
  MOAMARI: {
    ...
    lines: [
      ...
      { label: '손상 (확정 / 미확인)', text: '8/18 본선 갑판장이 잠수 장비로 감긴 로프를 제거하는 과정에서 **프로펠러 볼트 3개 파손**을 확인했다 — 여기까지가 확정이다. 프로펠러·관련 장비의 추가 손상 여부는 잠수부 점검이 필요하다고 보고돼 아직 미확인이다.' },
      ...
      { label: '예인 진행 (예상)', text: '8/31 출발은 확정. 도착 9/29·항해 30일은 **현재 속도 기준 예상치**로 확정된 값이 아니다 — 평균 6.4노트 환산이며, 계약 상한(26일)보다 4일·하한(24일)보다 6일 늦다. 속도가 회복되면 좁혀진다.' },
      ...
      { label: '확정 / 예상 구분', text: '확정은 사고 경위(8/17 접안 중 로프 감김)·프로펠러 볼트 3개 파손·출발지·도착지·일 $41,000·계약 항해 24~26일·8/31 출발이다. 프로펠러 추가 손상 여부, 도착 9/29, 항해 30일, 총 예인료 123만불, 수리 3~28일, 복귀 10/9~11/3, 조업손실 840~1,210 MT은 **전부 예상치 또는 미확인**이다. 잠수부 점검 결과·젠산 조선소 견적·실제 도착일이 나오면 갱신한다.' },
    ],
  },
};
