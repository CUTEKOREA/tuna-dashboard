...
import { AreaChart, Area, BarChart, Bar, LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip, Legend, Cell, PieChart, Pie } from 'recharts';
import WidgetCard from './WidgetCard';
import { Globe, TrendingUp, AlertTriangle, Crosshair } from 'lucide-react';
...
<PieChart>
            ...
            <Tooltip contentStyle={{ background: '#0a0f1f', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px' }} />
          </PieChart>
      }
      takeaway={{
