...
export const FLEET_IDLE_NOTES: Record<string, FleetIdleNote> = {
  MOAMARI: {
    asOf: '2026-09-01',
    headline: '프로펠러 로프가드 수리차 젠산 예인 중 · 복귀 10월 말~11월 중순, 총 이탈 61~93일',
    lines: [
      { label: '경위', text: '8/17 크리스마스섬 입항, SEIN KASAMA편으로 약 760톤 전재. 8/31 SEIN SAPPHIRE 예인으로 젠산 출발.' },
      { label: '예인', text: '크리스마스섬~젠산 4,644해리. 원양 예인 5~6노트 기준 32~39일 걸려 10월 초·중순 도착 예상.' },
      { label: '수리 (짧은 쪽)', text: '로프가드만 손상이면 3~7일. 크리스마스섬은 항만 없는 개방 정박지라 너울에 노출돼 현장 잠수 작업이 어렵고, 입항 후 14일을 머문 것도 기상에 막힌 정황으로 읽힌다.' },
