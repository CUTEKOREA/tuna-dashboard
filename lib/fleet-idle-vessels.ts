...
export const FLEET_IDLE_NOTES: Record<string, FleetIdleNote> = {
  MOAMARI: {
    asOf: '2026-09-02',
    headline: '프로펠러 로프가드 수리차 젠산 예인 중 · 계약 항해 24~26일 · 현재 속도면 30일(9/29 도착) 예상 · 예인료 계약 일 $41,000, 30일 가정 시 약 123만불(17억원)으로 계약 대비 4~6일·$16.4~24.6만 초과 예상 · 복귀 10월 중순~11월 초 예상 · 조업손실 약 840~1,210 MT 예상',
    lines: [
      ...
      { label: '확정 / 예상 구분', text: '확정은 출발지·도착지·일 $41,000·계약 항해 24~26일·8/31 출발뿐이다. 도착 9/29, 항해 30일, 총 예인료 123만불, 수리 3~28일, 복귀 10/9~11/3, 조업손실 840~1,210 MT은 **전부 예상치**다. 젠산 조선소 견적과 실제 도착일이 나오면 갱신한다.' },
    ],
  },
};
