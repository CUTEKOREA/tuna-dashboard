...
return (
    <div className={styles.insightCard}>
      ...
      <div style={{ padding: '0 20px 20px 20px' }}>
        <TakeawayBox
          situation="나우루의 대만→중국 외교 전환(2024.01)으로 대만 선단의 PNA 입어권이 급격히 축소되고 있습니다. 중국은 이 영향력을 현지 가공 투자가 아닌 본토 선전/광동 메가 캐너리에 집중 투입하며, ATQ 무관세를 무기화하여 EU 프리쿡트 로인 시장에서 에콰도르(EUMOFA 2024 기준 EU 참치 수입의 29% volume / 48% value 차지)를 빠르게 대체 중입니다."
          actionPlan="에콰도르 가공 자산의 밸류에이션을 즉시 재산정하십시오. 중국 메가 캐너리 본격 가동(2027~) 시 에콰도르향 투자 IRR이 3~5%p 하락할 수 있습니다. 대안으로 PNG/솔로몬 제도의 EU-RoO 특혜 가공 거점을 선제 확보하여 잉여현금흐름을 극대화하십시오."
...
export function InsightIOCollapse() {
  return (
    <div className={styles.insightCard}>
      ...
      <div style={{ padding: '0 20px 20px 20px' }}>
        <TakeawayBox
          situation="WCPO 공급 부족분의 최후 보루인 인도양(IO) 선단이 MGO $2,100/t 폭등과 어획 급감으로 자체 붕괴 직전입니다. 프랑스 Sapmer는 €18.3M 순손실, 복수 선단이 조업 중단을 검토 중이며 태국의 IO 긴급 수입은 Q1 2026 +106% YoY 급증했습니다."
          actionPlan="**[Actionable Insight]** 인도양 공급 붕괴는 '블랙스완'이 아닌 '그레이 코뿔소'입니다. 6개월 선물 계약을 즉시 체결하여 매입원가를 $1,800/t 이하로 락인하십시오. 동시에 서아프리카(가나 Tema 허브) 대체 소싱 파이프라인을 즉각 가동하여 IO 의존도(Exposure)를 30% 이하로 분산해야 합니다."
...
export function InsightEU18C() {
  return (
    <div className={styles.insightCard}>
      ...
      <div style={{ padding: '0 20px 20px 20px' }}>
        <TakeawayBox
          situation="EU의 -18℃ 냉동 규제는 실제 식중독 사례가 미미함에도 시행된 경제적 무기입니다. €200M 규모의 시장 사기를 차단하는 동시에, -18℃ 설비 미보유 제3국 선단(글로벌 40%)의 EU 시장 접근을 원천 차단합니다. 스페인/프랑스 선단은 이미 완비."
