...
const TRADERS = [
  { key: 'FCF', name: 'FCF', gid: 'tFcf', color: '#38bdf8', total: 99043 },
  { key: 'ITOCHU', name: 'ITOCHU', gid: 'tIto', color: '#8b5cf6', total: 25156 },
  { key: 'TRI MARINE', name: 'TRI MARINE', gid: 'tTri', color: '#ec4899', total: 38715 },
  { key: 'Direct deal', name: '직거래', gid: 'tDir', color: '#10b981', total: 76360 },
  { key: 'Maldives', name: '몰디브', gid: 'tMal', color: '#f59e0b', total: 0 },
];

export default function TraderStatus() {
  const [hover, setHover] = React.useState<number | null>(null);
  const cards = [...TRADERS.filter((t) => t.total > 0), { key: 'TOTAL', name: '합계', gid: '', color: 'var(--text-main)', total: 239274 }];
