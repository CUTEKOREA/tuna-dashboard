...
STAGES: list[dict] = [
    ...
    {"key": "s09", "title": "산지 — 위판 원장 5개년", "pillar": "S2",
     "widgets": ["F_auction_annual", "F_vessel_gear_2025", "F_vessel_top20_2025", "F_vessel_top50_3yr"]},
...
SIT_TAK.update({
    ...
    "F_traceability_coverage": (
        "고시 별표가 지정한 냉동·냉장오징어 품목번호에 해당하는 2025년 수입은 금액 437,944,857달러, 중량 127,342,711kg이다. 같은 해 오징어 수입 총액 672,612,910달러와 총중량 164,675,983kg에 견주면 금액 커버가 65.1%, 중량 커버가 77.3%다. 금액 커버가 중량 커버보다 낮다는 것은 대상 밖 물량의 킬로그램당 금액이 대상 물량보다 높다는 뜻이다. 지정기한은 2029-04-30이고 제조공장은 신고의무자가 아니라 이력은 공장 문 앞에서 끝난다.",
