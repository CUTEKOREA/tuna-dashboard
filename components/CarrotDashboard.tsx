...
{/* Section 1: Raw Material */}
      ...
      <div className="ds-grid-2" style={{ marginBottom:'2.5rem' }}>
        ...
        <div style={{ gridColumn: '1 / -1', margin: '2.5rem 0 1rem', borderTop:'1px solid rgba(140,170,255,0.12)', paddingTop:'1.5rem' }}>
          ...
          takeaway={{
            situation: (
              <div>
                ...
                <p>실측: <strong>한국 당근 수입액 $3.1M(2000) → $51M(2024) (16배). 미국 $21M → $212M (10배), 독일 $400M(2024, 글로벌 1위 수입국·EU 재수출 hub). 일본 $19~38M 정체 (인구 감소). 한국 자급률 47%는 OECD 평균 78% 대비 -31%p, 일본 80%·중국 95% 대비도 뚜렷한 부족 → 글로벌 hub 진입 동력</strong>.</p>
              </div>
            ),
            actionPlan: (
              <div>
