  ...
  return (
    <div style={{
      ...
      <TakeawayBox 
        ...
        actionPlan="BAADER 581 Pro와 같은 모듈형 자동화 시스템(필렛팅 및 트림 통합)을 전면 도입해야 함. 이는 수율을 3~4% 향상시키고 수작업 의존도를 40% 감소시켜 즉각적인 재무적 이익을 창출하며, IoT 기반 예지보전으로 다운타임을 원천 차단함."
