  ...
  const Body = (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
      <div style={PanelStyle}>
        ...
        <div style={PanelDesc}>2025년 사상 최고치 — 60.9천 톤 / $199.0M (전년 대비 +35.6%/+61.8%, 對FTA표 기준). 노르웨이 대량 매집 사이클.</div>
        {YearlyChart}
      </div>

      <div style={PanelStyle}>
        <div style={PanelTitle}>🌊 분기별 흐름과 2026 Q1 절벽</div>
        <div style={PanelDesc}>2025년 매 분기 증가세 → 2026 Q1 10.1천 톤(전년 동기 대비 −52.7%, 對세계 통관 기준)으로 급락. 노르웨이 어획 쿼터 삭감이 직접 원인.</div>
        {QuarterChart}
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '14px' }}>
        <div style={PanelStyle}>
          ...
          <div style={PanelDesc}>노르웨이 −62.9% / 중국 −42.7% / 영국 +216.1%. 수입액 비중 노르웨이 73.9%·영국 12.1%·중국 8.0%.</div>
          {OriginChart}
        </div>
        <div style={PanelStyle}>
          <div style={PanelTitle}>💵 노르웨이 냉동 고등어 단가</div>
          <div style={PanelDesc}>2025 Q1 $2.7/kg → 2026 Q1 $4.9/kg, +78.3%(KMI 명문). 어획 쿼터 삭감 → cost-push 충격.</div>
          {NorwayPriceChart}
        </div>
      </div>
      ...
      >
        {[
          { label: '2025년 수입 (사상 최고)', value: '60.9천 톤', sub: '$199.0M, +35.6% (對FTA표)', color: '#38bdf8' },
          { label: '2026 Q1 수입 (절벽)', value: '10.1천 톤', sub: '$45.6M, −52.7% (對세계)', color: '#ef4444' },
          { label: '노르웨이 단가 충격', value: '+78.3%', sub: '$2.7→$4.9/kg', color: '#fb923c' },
          { label: '국내 1~2월 생산 회복', value: '+49.9%', sub: '31.8→47.6천 톤', color: '#10b981' },
        ].map((k, i) => (
...
<p>실측: <strong>2025년 對FTA표 기준 고등어 수입 60.9천 톤·$199.0M으로 사상 최고치 달성 후, 2026 Q1 對세계 수입 −52.7% 절벽. 노르웨이 냉동 단가 $2.7→$4.9/kg(+78.3%)·노르웨이 수입액 비중 73.9%·냉동 비중 97.7%</strong>로 한 국가·한 형태에 집중된 구조가 그대로 충격으로 노출.</p>
<p>구조 변화 시그널: <strong>영국산 +216.1%</strong> 급증이 노르웨이 대체 통로로 부상. 국내 1~2월 생산도 +49.9% 회복 — 수입 의존 완화 동시 진행.</p>
</div>`,
        actionPlan: `<div>
<p><strong>재정의</strong>: 쿼터 절벽은 외부 충격이 아니라 <strong>"수입액 비중 73.9% 단일국 의존을 정상 운영했던 조달 정책의 후행 청구서"</strong>. 다변화는 옵션이 아니라 마진 방어 의무.</p>
<p><strong>3단계</strong>: ① 노르웨이 비중 75% 이하 가드레일 설정 — 영국·아일랜드(북동대서양 다른 쿼터국) 직거래 라인 즉시 개설. ② 2026 Q1 단가 $4.9/kg 락인된 노르웨이 장기계약 재협상 + 국내산 1~2월 회복분(+49.9%)을 활용한 도매가 협상력 회수. ③ 분기별 KMI FTA 동향 데이터를 사내 S&OP 사이클에 정식 입력 — 분기 발표일 +5영업일 내 조달 위원회 의사결정 트리거화.</p>
</div>`,
