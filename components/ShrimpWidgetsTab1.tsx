...
export const W01_Megatrend = () => (
  <WidgetCard title="수생태계 메가트렌드 (1970-2022)" icon={Globe} term="Production Megatrend" desc="글로벌 전체 생산량" source="FAO FishStatJ - Global Production Timeline" situation="2000년대 이후 인공 양식(Aquaculture) 인프라의 폭발적 증가로 새우 생산량 곡선이 구조적 수직 팽창(Vertical Expansion) 단계에 진입하며, 글로벌 식량 밸류체인의 판도가 영구적으로 재편되었습니다." actionPlan="[Value-Chain Migration] 자연산 어획에 의존하는 낡은 비즈니스 모델(Legacy Model)에서 즉각 탈피하십시오. 전사 CAPEX를 글로벌 양식 밸류체인 편입 및 스마트 아쿠아팜 지분 확보에 집중하여 매입원가 주도권(Cost Leadership)을 탈환해야 합니다." telemetry={{ status: 'STATIC', syncDate: '2026-05-29' }}>
...
export const W05_Top10Prod = () => (
  <WidgetCard title="글로벌 생산 Top 10 국가" icon={Globe} term="Top Production" desc="최근 국가별 총생산량" source="FAO FishStatJ - Recent Production by Country" situation="중국, 인도, 에콰도르 3개국이 글로벌 양식 생산 물량의 절대다수를 통제하며, 사실상의 시장 독과점(Oligopoly/Triopoly) 헤게모니를 완벽하게 구축했습니다." actionPlan="[Macro Risk Monitoring] 이 3대 메이저 국가의 기후변화(El Nino) 및 생물학적 리스크가 당사 영업이익(OPM)의 치명적 변수로 작용합니다. C/I/E(China/India/Ecuador) 벨트에 대한 퀀트 기반 실시간 리스크 모니터링 데스크를 즉각 신설." telemetry={{ status: 'STATIC', syncDate: '2026-05-29' }}>
    <SafeResponsiveContainer width="100%" height="100%">
...
export const W08_Top10AquaVal = () => (
  <WidgetCard title="양식업 부가가치 창출 Top 10" icon={DollarSign} term="Aqua Value Gen" desc="양식업으로 달러를 쓸어담는 국가" source="FAO FishStatJ - Aquaculture Value" situation="글로벌 물량 생산량(Volume) Top 3 국가가 창출하는 부가가치(Value-Add) Top 3 순위와 완벽히 동기화(Synchronization)되며 극단적인 Bottom-line(순이익) 과점 체제(Oligopoly)를 완성했습니다." actionPlan="[Pricing Power Hedging] 메이저 3국은 물량 공세(Dumping)를 넘어 글로벌 마켓 프라이싱 권한(Pricing Power)마저 독점하고 있습니다. 특정 국가에 대한 소싱 의존도(Exposure)를 30% 이하로 통제(Diversification)하여 공급망 병목 리스크(Bottleneck)를 완벽히 헤징(Hedging)해야 합니다." telemetry={{ status: 'STATIC', syncDate: '2026-05-29' }}>
    <SafeResponsiveContainer width="100%" height="100%">
