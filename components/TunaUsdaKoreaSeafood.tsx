...
const ICONS: Record<string, any> = {
  w_kr_seafood_total_import: ShoppingBag,
  w_kr_us_seafood_share: Globe,
  w_kr_us_seafood_items: FileText,
  w_idn_halal_seafood: Shield,
  w_es_seafood_top_importers: MapPin,
};

/**
 * USDA FAS GAIN 기반 한국 수산물 시장 인텔리전스 위젯.
 *
 * - filterPillar='S3': 인도네시아 할랄 (정책·물류·통관)
 * - filterPillar='S4': 한국 수입·미국산 점유·Top 품목·스페인 비교 (판매·수요)
 */
export default function TunaUsdaKoreaSeafood({ filterPillar }: { filterPillar?: 'S3' | 'S4' } = {}) {
