        ...
        {stocks.map((stock, i) => {
          ...
          return (
            <div key={i} style={{
              flex: '0 0 auto',
              minWidth: '150px',
              background: 'var(--dsc-surface, #0a0f1f)',
              borderRadius: '12px',
              border: `1px solid ${isUp ? 'rgba(var(--w-red-500-rgb), 0.2)' : isDown ? 'rgba(var(--w-blue-500-rgb), 0.2)' : 'var(--dsc-surface-border, rgba(140,170,255,0.10))'}`,
              padding: '12px 16px',
