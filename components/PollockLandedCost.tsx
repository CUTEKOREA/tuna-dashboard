 ...
 * 근거: (일반 2024-06) 신통상규범 + (기본 2025-10) 물가 안정화
 */

// ═══ Widget LC1: 착지원가 워터폴 분석 ═══
  ...
  return (
    <div className={styles.card}>
      <div className={styles.cardHeader}>
        ...
        <h3 className={styles.cardTitle}>W-LC1 · 명태 착지원가 워터폴 분석</h3>
      </div>
      <div style={{ background: 'rgba(34,197,94,0.08)', border: '1px solid rgba(34,197,94,0.2)', padding: '8px 12px', borderRadius: '8px', marginBottom: '12px', fontSize: '0.75rem', color: '#86efac' }}>
        📋 근거: (일반 2024-06) 신통상규범 + (기본 2025-10) 물가 안정화 | Tariffs/WITS/FRED API
      </div>
      {/* Route Tabs */}
  ...
  return (
    <div className={styles.card}>
      <div className={styles.cardHeader}>
        ...
        <h3 className={styles.cardTitle}>W-LC2 · 조달 경로 비교 + 환율 민감도</h3>
      </div>
