  ...
  it('publishes only aggregate values and derived quality counts', () => {
    expect(fleetDailyPublic).toEqual({
      _meta: {
        ...
        latestReportDate: '2026-09-04',
        latestAsOf: '2026-09-03',
      ...
      latest: {
        ...
        asOf: '2026-09-03',
        pacific: { asOf: '2026-09-03', dailyMt: 155, monthlyMt: 505, annualMt: 48_745.8 },
        atlantic: { asOf: '2026-09-03', dailyMt: 115, monthlyMt: 430, annualMt: 33_890 },
        carrier: { loadedTotalMt: 5_834.1, expectedRemainingMt: 5_771.7 },
      },
      deltas: { pacificDailyMt: -20, atlanticDailyMt: -80, totalDailyMt: -100 },
      reconciliation: {
        pacificDaily: { reportedMt: 155, rowsMt: 155, matches: true, missingCount: 0 },
        atlanticDaily: { reportedMt: 115, rowsMt: 115, matches: true, missingCount: 0 },
      ...
      quality: {
        counts: {
          reconciliationChecks: 596,
          reconciliationCompleteChecks: 596,
          reconciliationUnavailableChecks: 0,
          reconciliationUnavailableDocuments: 0,
          reconciliationIssues: 19,
          reconciliationDocuments: 17,
          reconciliationPartialDifferences: 19,
          reconciliationPartialDifferenceDocuments: 17,
