...
export default function SasUsTariffLadder() {
  return (
    <WidgetCard
      ...
      cardDesc="2025 미국 상호관세(IEEPA) 공급국별 적용률 — Federal Register·USTR·CBP 검증"
      takeaway={{
        situation: "2025년 미국 상호관세로 비통조림 참치 공급국 간 관세 격차가 새로 생겼습니다(한국 적용분 2025-11-14 발효). 관세 사다리: 멕시코(USMCA 원산지) 0% 면제 < 한국·EU 15% < 인니·태국 19% < 베트남 20%. 한국은 KORUS FTA 무관세 우위가 15%로 침식됐으나, 핵심 경쟁국 인니·태국·베트남 대비 4~5%p 낮은 위치를 확보했습니다. 비통조림 참치 MFN 기저율은 대체로 무관세에 가까워, 상호관세가 사실상 신규 장벽으로 작동합니다.",
        actionPlan: "① 한국 가공·수출은 인니·태국·베트남 대비 4~5%p 관세우위 — 베트남(20%)·인니(19%) 비중이 큰 미국 바이어의 소싱 다변화 수요를 흡수할 사쿠/사시미 OEM·PB 전환 윈도우입니다. ② 멕시코 USMCA 면제(0%)는 구조적 최강 우위로, 멕시코 가공 거점 자산은 관세 회피 프리미엄을 보유 — 한국 사쿠 라인과 묶는 관세차익(tariff-arbitrage) 듀얼소싱에 우선 배분하십시오. ③ 한국 15%는 협정 재협상에 민감하므로 시나리오 헤지 필요.",
        source: "Federal Register 2025-21940(한국 15%) / White House EO 2025-15010(인니·태국 19%·베트남 20%) / US-EU Framework(EU 15% inclusive) / CBP IEEPA FAQ(멕시코 USMCA 면제)",
      }}
      customBody={
