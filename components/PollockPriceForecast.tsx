...
// ═══ Widget PF1: VAR 가격 예측 (통명태 + 수리미 + 명란) ═══
  ...
  return (
    <div className={styles.card}>
      <div className={styles.cardHeader}>
        ...
        <h3 className={styles.cardTitle}>W-PF1 · 명태 AI 가격 예측 엔진 (VAR 모형)</h3>
      </div>
      <div style={{ background: 'rgba(59,130,246,0.08)', border: '1px solid rgba(59,130,246,0.2)', padding: '8px 12px', borderRadius: '8px', marginBottom: '12px', fontSize: '0.75rem', color: '#93c5fd' }}>
        📋 근거: (기본 2024-08) 수산물 무역 단기 전망모형 | 5변수 VAR: 러시아FOB, MGO, SST, KRW/USD, 중국가동률 | FRED Live
      </div>
      {/* Product Tabs */}
  ...
  return (
    <div className={styles.card}>
      <div className={styles.cardHeader}>
        ...
        <h3 className={styles.cardTitle}>W-PF2 · What-If 시나리오 시뮬레이터</h3>
      </div>
      <div style={{ background: 'rgba(245,158,11,0.08)', border: '1px solid rgba(245,158,11,0.2)', padding: '8px 12px', borderRadius: '8px', marginBottom: '12px', fontSize: '0.75rem', color: '#fcd34d' }}>
        📋 5대 시나리오별 명태 가격/수리미/명란 궤적 + 마진 영향 시뮬레이션
      </div>
      ...
      <TakeawayBox
        situation="기준 시나리오(45% 확률) 마진 12.5%. 쿼터 감축 시 마진 8.2%로 급락. 러시아 제재 강화 시 5.8%까지 하락 위험."
