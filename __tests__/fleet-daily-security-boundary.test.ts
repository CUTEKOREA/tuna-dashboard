  ...
  it('publishes only aggregate values and derived quality counts', () => {
    expect(fleetDailyPublic).toEqual({
      ...
      latest: {
        ...
        asOf: '2026-08-23',
        pacific: { asOf: '2026-08-23', dailyMt: 36, monthlyMt: 2_668, annualMt: 47_500.8 },
        atlantic: { asOf: '2026-08-23', dailyMt: 280, monthlyMt: 4_505, annualMt: 31_230 },
        carrier: { loadedTotalMt: 8_763.3, expectedRemainingMt: 5_771.7 },
      },
      deltas: { pacificDailyMt: 3, atlanticDailyMt: -40, totalDailyMt: -37 },
      reconciliation: {
        pacificDaily: { reportedMt: 36, rowsMt: 36, matches: true, missingCount: 0 },
        atlanticDaily: { reportedMt: 280, rowsMt: 280, matches: true, missingCount: 0 },
