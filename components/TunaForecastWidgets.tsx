  ...
  return (
    <div className={styles.insightCard}>
      ...
      <TakeawayBox
        ...
        actionPlan="**[Actionable Insight]** [기후 헷지 포트폴리오] ① WCPO 의존도(Exposure)를 낮추기 위해 대서양(ICCAT) 쿼터 추가 확보, ② 가격 상승기 대비 Q2 선제 재고 확보(3개월분), ③ 중장기적으로 지중해 참다랑어 축양 투자를 통한 기후 독립적 공급원 구축을 병행 추진해야 합니다."
  ...
  return (
    <div className={styles.insightCard}>
      ...
      <TakeawayBox
        ...
        actionPlan="**[Actionable Insight]** [3중 방어 전략] ① 환율 헷지: 3개월 선물환 계약으로 ₩1,400 이하 환율 락인, ② FTA 우회: 한-ASEAN FTA 활용 태국 경유 관세 최적화(0% 적용), ③ ECOS/KCS API 실시간 모니터링 체계 구축으로 환율·관세 변동 즉시 대응 프로토콜을 가동해야 합니다."
