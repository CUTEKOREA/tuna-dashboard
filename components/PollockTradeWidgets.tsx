  ...
  return (
    <div style={glassContainerStyle}>
      ...
      <div style={{ marginTop: '20px' }}>
        <TakeawayBox
          situation="명태 전 세계 수입국의 랭킹을 도식화했습니다. 중국이 압도적인 1위로 나타나지만, 이는 중국인의 내수 소비가 목적이 아니라 노동집약적인 수작업 공정(뼈 발라내기 등)을 거쳐 전 세계로 비싸게 우회 수출하기 위한 거대 베이스캠프 역할 때문입니다."
          actionPlan="**[Actionable Insight]** 가공의 권력을 쥔 중국 벤더에 대한 협상력 상실은 자사 제품의 매입원가(COGS) 통제력 붕괴로 직결됩니다. 중국 다롄이나 칭다오 항구 소재의 가공 팩토리(Factory) 일부에 합작 지분을 꽂아 넣어 투명한 임가공비 내역을 상시 보고받을 수 있는 지위에 편입해야 합니다. (Conviction Buy)"
    ...
    <div style={glassContainerStyle}>
      ...
      <div style={{ marginTop: '20px' }}>
        <TakeawayBox
          ...
          actionPlan="**[Actionable Insight]** 원물 수입에 머무는 단순 트레이딩(매구입) 기능을 점진적으로 축소하거나 철회하십시오. 마진 공간이 허락되는 유일한 구명조끼는 직접 B2C (이커머스/온라인 리테일) 브랜드를 만들어 최종 소비자 가격 재량권을 갖는 방안뿐입니다."
    ...
    <div style={glassContainerStyle}>
      ...
      <div style={{ marginTop: '20px' }}>
        <TakeawayBox
          ...
          actionPlan="**[Actionable Insight]** 언제 터질지 모르는 서방(미/EU) 관세국의 중국산 전수 조사 및 블라인드 수입 규제 리스크가 병목 지점의 암관입니다. 당장 공급망의 30%를 중국이 아닌 베트남, 인도네시아 등 제3 미규제 동남아 가공 벨트로 할당해 우회 플랜B를 즉시 성립시켜야 합니다. (Conviction Buy)"
    ...
    <div style={glassContainerStyle}>
      ...
      <div style={{ marginTop: '20px' }}>
        <TakeawayBox
          ...
          actionPlan="**[Actionable Insight]** 단순 내수용 황태나 동태탕 베이스의 가공을 전부 파기하십시오. 현금 캐시플로우를 방어하기 위해 K-푸드 붐에 승차할 수 있는 튀김 밀키트, 프리미엄 K-명란 스낵 등 '글로벌 지향형 아이템'에 R&D 예산을 즉각 재편성하여 역수출 볼륨을 올려야 합니다. (Conviction Buy)"
