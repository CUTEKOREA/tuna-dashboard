...
> - 조정값은 당일 `+22.250`, 누적 `+21.520`, 조정 잔량 `970.850`으로 닫힌다. 사진에 적힌 온도는 문맥 보정 없이 N/STAR `-21~23℃`, S/SPR·N/SUN `-22~23℃` 그대로 보존했다.
> - 8/18 예정량은 세 원본에 없고 XLSX의 `300.000`은 8/17 당일 계획이므로 명일 문구는 `###톤`으로 생성한다. 8/15의 8/16 공휴일·8/17 계획 300톤 기록은 과거 계획으로 보존했다.
