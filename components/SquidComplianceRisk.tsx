...
export default function SquidComplianceRisk() {
  ...
  return (
    <div className={styles.glassCard} ref={containerRef}>
      ...
      <TakeawayBox source="국제해사기구(IMO) & 포클랜드 ITQ-B 제도 보고서" situation="중국 원양 선단이 장악한 공해상은 막대한 어획량을 보장하지만, 불법 환적 리스크가 95에 달해 향후 구미(US/EU) 대형 유통망 수출 시 전면 차단될 '시한폭탄'입니다. 반면 포클랜드 해역은 25년 장기 어업권(ITQ-B) 접근이 가능하고 리스크가 현저히 낮습니다."
