...
export const WidgetPlantBasedImpact = () => (
  <WidgetCard
    ...
    takeaway={{
      ...
      actionPlan: "방어 기제로 '자연산(Wild-Caught) 100%' 프리미엄 헤리티지 마케팅을 강화하거나, 블렌딩용 식물성 단백질 소싱 라인을 선제 구축.",
    }}
  />
);
...
export const WidgetCellCultureVC = () => (
  <WidgetCard
    ...
    takeaway={{
      ...
      actionPlan: '향후 5년 내 배양육 매입원가가 상업 궤도에 돌입합니다. 당사 어획 할당량 자산을 매각하기 전 피보팅(Pivoting) 파트너를 모색.',
    }}
  />
);
...
export const WidgetPetFoodUpcycling = () => (
  <WidgetCard
    ...
    takeaway={{
      ...
      actionPlan: "선상 폐기물을 '마리아나 트렌치(Mariana Trench)'와 같은 펫 영양식 브랜드 라인업으로 업사이클링(Up-cycling)하여 영업외수익을 극대화하십시오.",
    }}
  />
);
...
export const WidgetStarlinkMaritime = () => (
  <WidgetCard
    ...
    takeaway={{
      ...
      actionPlan: '단순 선원 복지를 넘어, 본사 서버와 선단의 실시간 고대역폭 연결을 통해 태풍 우회 연비를 월간 $22,000 절감하는 작전사령부를 구축.',
    }}
  />
);
...
export const WidgetMnATargets = () => (
  <WidgetCard
    ...
    takeaway={{
      ...
      actionPlan: '어선 선단을 추가 매입하는 낡은 관행을 당장 멈추고 현금을 전부 비축하여, 폭락장에 나온 물류AI 기업을 저점 인수(Bolt-on).',
    }}
  />
);
