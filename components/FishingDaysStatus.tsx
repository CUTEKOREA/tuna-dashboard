...
const fishingDaysData: Record<string, FishingData[]> = {
  "PNG": [
    ...
    { company: "신라교역", total: 351.00, consumed: 15.02, remaining: 335.98, rate: 4 },
  ],
  "Solomon": [
    ...
    { company: "신라교역", total: 44.00, consumed: 23.65, remaining: 20.35, rate: 54 },
  ],
  "Kiribati": [
    ...
    { company: "신라교역", total: 234.00, consumed: 213.61, remaining: 20.39, rate: 91 },
  ],
  "Tuvalu": [
    ...
    { company: "신라교역", total: 80.00, consumed: 70.57, remaining: 9.43, rate: 88 },
  ],
  "Nauru": [
    ...
    { company: "신라교역", total: 122.00, consumed: 115.20, remaining: 6.80, rate: 94 },
  ],
  "FSM": [
    ...
    { company: "신라교역", total: 49.00, consumed: 14.85, remaining: 34.15, rate: 30 },
  ],
};
