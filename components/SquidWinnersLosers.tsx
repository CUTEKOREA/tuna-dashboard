    ...
    <div className={styles.glassCard} style={{ padding: '1.5rem', borderColor: 'rgba(16,185,129,0.3)', marginTop: '2rem' }}>
      ...
      <div style={{ marginTop: '20px' }}>
        <TakeawayBox
          ...
          actionPlan="자체 선단의 어획량 증가에 베팅하는 전통적 조업 모델은 붕괴했습니다. 즉시 국내 연근해 및 남대서양/포클랜드 조업 의존도를 대폭 축소하고, 오프테이크(Off-take) 선도 거래를 통해 수입 물량을 안정 확보해야 합니다. 장기적으로는 양식 기술 투자 또는 오징어를 대체할 수 있는 타 펠라직 어종으로의 선단 포트폴리오 다변화가 필수 생존 전략입니다."
        />
      </div>
    </div>
  );
