    ...
    <div className={styles.insightCard} ref={containerRef}>
      ...
      <div style={{ marginTop: '20px' }}>
        <TakeawayBox
          ...
          actionPlan="지중해 남부(호주/일본 자본 유입)와 일부 선진국이 고부가가치 양식 생태계를 독점하고 있습니다. 우리 기업이 이 카르텔을 단독으로 깨는 것은 불가능합니다. 차라리 자본력이 부족한 튀르키예나 크로아티아 등 후발 양식 국가에 ODA(공적개발원조) 또는 민간 합작 채널을 통해 설비(냉동/사료)를 선지원하고 반대급부로 양식 물량의 장기 매입권(Off-take)을 독점하는 투트랙 우회 전략을 구사하십시오."
        />
      </div>
    </div>
  );
