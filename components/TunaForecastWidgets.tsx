...
return (
    <div className={styles.insightCard}>
      ...
      <TakeawayBox
        situation="[퍼펙트 스톰 진행 중] Atuna 방콕 가다랑어 산지가격 실측은 2025-10 $1,700 → 2025-12 $1,500 저점 → 2026-04 $2,100 위기 정점 → 2026-05 $1,975로 진정 국면입니다. 동시 충격 요인 두 가지: (1) 2026-02말 호르무즈 해협 봉쇄 위기로 MGO(해상 경유)가 톤당 $2,000을 돌파, 어획 비용의 약 68%를 잠식. (2) 슈퍼 엘니뇨로 1Q26 WCPO 어획량이 전년 동기 대비 -22%(-39,000톤) 급감. 태국 가공업체들이 $2,000 저항선에서 관망세로 돌아서며 가격 추가 상승을 차단 중입니다."
        actionPlan="[양면 헷지 전략] (a) 인도양(IOTC) 대체 공급선(몰디브·세이셸·인도·필리핀) 비중을 확대해 WCPO 단일 의존도를 낮추고, (b) 호르무즈 리스크가 해소되지 않는 동안 단기 매입은 2~4주 단위로 분할해 $2,000+ 호가 노출을 회피합니다. 가공업체 관망세가 유지되는 한 1,950~2,050 박스권이 6~8주 지속될 가능성이 높으며, 박스 하단에서 분할 매입이 안전합니다."
  ...
  return (
    <div className={styles.insightCard}>
      ...
      <TakeawayBox
        ...
        actionPlan="**[Actionable Insight]** [기후 헷지 포트폴리오] ① WCPO 의존도(Exposure)를 낮추기 위해 대서양(ICCAT) 쿼터 추가 확보, ② 가격 상승기 대비 Q2 선제 재고 확보(3개월분), ③ 중장기적으로 지중해 참다랑어 축양(Ranching) 투자를 통한 기후 독립적 공급원 구축을 병행 추진해야 해야 합니다. (Conviction Buy)"
...
export function LandingCostSensitivity() {
  ...
  return (
    <div className={styles.insightCard}>
      ...
      <TakeawayBox
        situation="[복합 매입원가(COGS) 압박] 미국 301 관세 시나리오 적용 시 착지매입원가(COGS)가 +20% 급등(Spike)하며, 원화 약세(₩1,450/USD) 시나리오에서는 추가로 마진 5.1%p 압축이 발생합니다. 현재 기준환율(₩1,385) 대비 ₩65 추가 절하 시 kg당 약 ₩420의 매입원가(COGS) 상승이 불가피합니다."
        actionPlan="**[Actionable Insight]** [3중 방어 전략] ① 환율 헷지: 3개월 선물환 계약으로 ₩1,400 이하 환율 락인, ② FTA 우회: 한-ASEAN FTA 활용 태국 경유 관세 최적화(0% 적용), ③ ECOS/KCS API 실시간 모니터링 체계 구축으로 환율·관세 변동 즉시 대응 프로토콜을 가동해야 해야 합니다. (Conviction Buy)"
