    ...
    <div className={styles.insightCard} ref={containerRef}>
      ...
      <div style={{ width: '100%', height: '300px' }}>
        <SafeResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <XAxis dataKey="Year" stroke="#94a3b8" tick={{ fill: '#94a3b8' }} axisLine={false} tickLine={false}  angle={0} textAnchor="middle" height={60} tickFormatter={truncateXAxis}/>
      ...
      <div style={{ marginTop: '20px' }}>
        <TakeawayBox
          ...
          actionPlan="**[Actionable Insight]** 대한민국 최고급 하이엔드 Omakase 시장을 타겟팅하려면 품질과 수율이 불확실한 자연산 조업보다 지중해권(튀르키예, 스페인 등) 축양 물량의 락인이 필수적입니다. 단순히 일본 상사를 거쳐 수입하는 패시브(Passive)한 소싱에서 벗어나 유럽 현지의 탑티어 팜(Farm)들과의 독점적인 장기 구매 계약채널을 열고, 국내 미식 소비자들이 열광하는 지방 함량(Otoro)의 균일성 등 '프리미엄 지표'를 마케팅 전면에 내세워야 초과 수익을 누릴 수 있습니다."
        />
      </div>
    </div>
  );
