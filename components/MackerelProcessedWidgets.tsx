...
export const WidgetFishmealHegemony = () => (
  <div style={widgetStyle}>
    ...
    <TakeawayBox 
      ...
      actionPlan="고등어류 단가는 이제 '서민 식탁'이 아닌, 10배 이상 거대한 '연어 양식장 원가' 및 '초고가 펫케어 시장'에 연동되어 최저 가격 바닥(Floor)이 붕괴되지 않는 구조입니다."
    />
  </div>
);
...
export const WidgetChinaStealthMackerel = () => (
  <div style={widgetStyle}>
    ...
    <TakeawayBox 
      ...
      actionPlan="수리미에 이어 고등어마저 훠궈/어묵 등 중국 내수 시장으로 쏠리며 한국의 수입 단가를 위협합니다. 글로벌 바잉 파워(Buying Power) 붕괴 전 대응이 시급합니다."
    />
  </div>
);
