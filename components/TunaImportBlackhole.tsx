    ...
    <div className={styles.glassCard} ref={containerRef}>
      ...
      <div style={{ marginTop: '20px' }}>
        <TakeawayBox
          ...
          actionPlan="전 세계 수입 참다랑어의 과반 이상이 도쿄로 향하는 '기형적 블랙홀 파레토 원칙'이 작동 중입니다. 일본 바이어들이 물류와 경매 단가를 독식하는 구조를 깨야 합니다. 츠키지/도요스 시장 등 일본 경매를 경유하지 말고, 최대 산지인 호주·지중해(몰타) 양식장과 무조건 '산지 직거래(Direct Sourcing)' 채널을 개통하십시오. 중간 유통마진을 회수하여 한국발 미국/유럽행 직수출 프리미엄 브랜드의 가격 경쟁력을 단번에 확보해야 합니다."
        />
      </div>
    </div>
  );
