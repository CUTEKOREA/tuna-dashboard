  ...
  return (
    <div className={styles.insightCard}>
      ...
      <div style={{ padding: '0 20px 20px 20px' }}>
        <TakeawayBox
          situation="[Market Telemetry] 브라질 HPAI 수입금지(5~7월)로 국내 도매가가 KAMIS 기준 1,950→2,650원/kg으로 +36% 폭등합니다. 태국산 CIF 2,750원은 얼핏 비싸 보이나, 순살 수율(잔뼈 제로)과 주방 인건비 절감을 감안한 TCU는 사실상 동등합니다. CBOT 옥수수 $4.15 저점은 태국 생산원가 역대 최저를 의미합니다."
...
export function InsightChannelMatrix() {
  return (
    <div className={styles.insightCard}>
      ...
      <div style={{ padding: '0 20px 20px 20px' }}>
        <TakeawayBox
          situation="[Channel Intelligence] ①프랜차이즈 B2B(맘스터치·BHC·교촌): 순살 다리살 수요 폭발, 브라질 의존도 전환 임계점 진입. ②편의점 HMR: 샐러드치킨·꼬치 최고 마진(35%), 태국 수작업발골+자동화가 핵심 무기. ③대형마트: 생닭은 국내산 독점, 냉동가공 코너만 가능. ④식자재마트: 중국산 13~14% 저가 덤핑 경쟁으로 마진 박."
