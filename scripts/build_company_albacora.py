...
⚠ 선단은 EINF 2025 가 23척(그중 4척 용선)이라 적고, 회사 웹사이트는 18척, 공적 등록부로 확인되는 것은 12척이다.
...
# RFMO 4개 기구(WCPFC·IOTC·ICCAT·IATTC) 등록부 확인분. EINF 23척 중 12척.
FLEET = [
    ...
    {"선명": "ROSITA C", "gt": 2502, "선적": "스페인", "기구": "WCPFC·IATTC", "소유사": "Atunera Dularra SL → Grupo Conservas Garavilla (Bolton 계열)"},
    {"선명": "AURORA B", "gt": 2479, "선적": "스페인", "기구": "WCPFC·IATTC", "소유사": "Atunera Dularra SL → Grupo Conservas Garavilla (Bolton 계열)"},
...
FINANCIALS = [
    ...
    {"항목": "가공 3사 합계", "값": "약 €315M", "기준": "2025 · EINF (65.8+15.7+233.3)", "등급": "공시"},
    {"항목": "2024 그룹 방향", "값": "스페인 감소 · 에콰도르 급성장으로 팬데믹 이전 회복", "기준": "언론", "등급": "매체"},
    {"항목": "2025 개별 실적", "값": "매출 129.95 M€ (+4.7%) · 순이익 21.46 M€ (−7.4%)", "기준": "벤더 DB 기업카드 — 개별법인 기준", "등급": "벤더DB"},
...
RISKS = [
    ...
    {"시점": "2022-06-15", "건": "ALBACORA CUATRO 암모니아 누출", "내용": "세이셸 빅토리아 정박 중. 사망 2명. CIAIM 공식 조사는 폭발이 아니라 암모니아 흡입으로 결론"},
...
TRADE_THREAT = [
    {"회사": "Thai Union 🇹🇭", "위협": "미국 관세 — 2025-08 수침 캔참치 31.5% → 2026-07-24 Section 301 12.5%",
     "대응": "대미 물량을 태국 → 가나·세이셸로 전환 + 미국 국적선 조달 확대"},
    {"회사": "Albacora 🇪🇸", "위협": "EU-아세안 FTA — 인도네시아 2025-09 타결(2026-08 현재 미발효)·태국 협상 중",
...
LIMITS = [
    ...
    {"항목": "EINF 23척 중 등록부 미포착 11척", "상태": "4개 기구 등록부에 없다. 용선 4척 포함 · 세이셸·에콰도르 기국 가능성"},
...
META = {
    ...
    "출처한계": "비상장 가족기업이라 그룹 연결 매출 절대액이 공개되지 않는다. 개별법인 실적은 벤더 DB 기업카드로 열려 있다(2025년 매출 129.95 M€ · 순이익 21.46 M€). 선단은 EINF 2025 가 23척(용선 4 포함)이라 적고 그중 12척만 공적 등록부로 확인된다 — 나머지 11척은 추정하지 않았다.",
