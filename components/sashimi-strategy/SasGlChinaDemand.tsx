...
/* ── 중국 참치 수요 부상 (IndexBox·SeafoodSource) ──
   ...
   몰타 양식 BFT 2023 18,624t·€1.67억(일본 95%→중국 다변화 MOU 2023.11), 중국 일식당 약 63,500개(2025, 日 농림수산성 — 2023 피크 ~78,000개에서 -19.4% 급감).
...
const STAT = [
  ...
  { label: '중국 일식당 수(2025)', value: '약 6.4만개', sub: '2023 피크 ~7.8만 → -19.4% 급감(日 농림수산성)', color: '#10b981' },
...
export default function SasGlChinaDemand() {
  return (
    <WidgetCard
      ...
      description="가다랑어 수입 +522% — 단 폭증은 저가 냉동 주도, 일식당은 2025년 급감"
      pillar="S4"
      telemetry={{ status: 'STATIC', syncDate: '2025-11-28' }}
      cardDesc="중국 참치 수입·소비 급증 — 가다랑어 IndexBox·몰타 BFT SeafoodSource·일식당 日 농림수산성(2025)"
      takeaway={{
        situation: "중국이 글로벌 참치 수요의 신흥 축으로 부상했습니다. 냉동/신선 가다랑어 수입이 +522%(13만 톤·$185M, 한국이 3.5만 톤 공급), 소비가 +298%(15.1만 톤) 급증했고, 일식당이 2023년 약 7.8만 개로 정점을 찍은 뒤 2025년 약 6.35만 개로 -19.4% 급감했습니다(중일 수산물 수입중단·내수 둔화; 日 농림수산성 2025 조사). 다만 폭증분의 대부분은 저가 냉동 가다랑어(가공·통조림급)로 수량 증가율(+300~520%)이 금액 증가율을 크게 상회 — 프리미엄 사시미는 아직 일부입니다. 동시에 중국은 지중해 블루핀(몰타 양식 2023년 18,624톤·€1.67억)이 일본 의존(95%)을 탈피하려는 다변화 대상(2023.11 MOU)으로 부상했습니다.",
        actionPlan: "중국을 '단일 시장'이 아니라 '두 시장'으로 보십시오. ① 대량 저가 냉동 가다랑어는 한국 원양이 이미 공급 중인 레드오션이므로 단가가 아닌 추적성·안정공급으로 방어하고, ② 급감 후에도 6만 개 이상으로 세계 최대인 중국 일식당 채널의 프리미엄 사시미(블루핀·고급 황다랑어) 수요는 일본·지중해가 선점하기 전 한국이 진입할 고마진 창구입니다. 중국의 일본 탈피 다변화 흐름(몰타 MOU)에 한국산 사시미급을 끼워넣는 B2B 외식 직공급을 우선 검토하십시오.",
        source: "IndexBox(중국 가다랑어 수입 +522%·13만t·$185M·한국 3.5만t) / SeafoodSource·MaltaToday(몰타 BFT 2023 18,624t·€1.67억·중국 MOU) / 일본 농림수산성 해외 일식당 조사 2025(중국 약 63,500개·2023 피크 78,000개 대비 -19.4%)",
      }}
      customBody={
