    ...
    <div className={styles.glassCard} style={{ borderColor: 'rgba(139, 92, 246, 0.3)' }}>
      ...
      <div style={{ marginTop: '20px' }}>
        <TakeawayBox
          ...
          situation="호주가 톤당 $11,508의 압도적인 최고 마진 달성률을 보이고 선별적인 프리미엄 시장 수요를 파고들었으며, 폴란드($3,178/t), 체코($2,558/t) 등 주요 유럽 인접국들이 동유럽 중심의 견고한 가공 스프레드를 기록하고 있어 서유럽 향 '밸류업 팩토리' 역할을 지속 중입니다. 반면 한국은 단순 벌크 원물 수입 후 유사한 가격대에 재수출되는 비효율(Inefficiency)적 중계 물동량이 많아 부가가치 창출 구조 개선이 절실합니다."
          actionPlan="**[Actionable Insight]** 동유럽/폴란드식 고수익 가공 모델을 참고하여 수입산 펠라직 어종을 HMR(간편식)·구이용 필레·양념 및 특수 포장 제품 등 2차 가공품으로 전환할 자체 인프라를 구축해야 합니다. 또한 호주 사례와 같이 철저히 시장을 분리하여 저가 대량 유통과 고가 소량 프리미엄 시장(수출 및 내수)을 동시에 타겟팅하는 '프라이싱 이원화' 전략을 수립하여 잉여현금흐름(FCF)을 극대화하십시오. (Strong Buy)"
        />
      </div>
    </div>
  );
