...
gtc_file = "/Users/idong-geon/연구자동화애이전트들/tuna-dashboard/data/gtc_insights_part2.js"
...
print(f"Found {len(gtc_insights)} GTC part 2 insights.")

jsx_output = ""
# We start at 42 because previously we added up to 41 (21 original + 14 + 6 = 41).
for i, ins in enumerate(gtc_insights, start=42):
...
{jsx_output}
    ...
    with open(target_file, 'w') as f:
        f.write(new_content)
    print("Successfully injected GTC insights part 2.")
else:
