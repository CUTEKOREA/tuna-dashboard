...
export const tooltipStyle: React.CSSProperties = { backgroundColor: '#1a2442', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px', color: '#f8fafc' };
...
export const WidgetCard = ({ title, icon: Icon, term, desc, source, situation, actionPlan, telemetry, children }: any) => (
  <div className="ds-card-insight" style={{ display: 'flex', flexDirection: 'column', height: '100%', flexShrink: 0 }}>
    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px', flexShrink: 0, overflow: 'hidden' }}>
      ...
      {telemetry?.status && (
        <span style={{ flexShrink: 0, marginLeft: 'auto', display: 'inline-flex', alignItems: 'center', gap: '4px', fontSize: '0.65rem', fontWeight: 700, letterSpacing: '0.04em', color: '#94a3b8', background: 'rgba(140,170,255,0.12)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '6px', padding: '2px 6px' }} title={telemetry.syncDate ? `동기화: ${telemetry.syncDate}` : undefined}>
