  ...
  return (
    <div style={{
      ...
      <TakeawayBox
        ...
        actionPlan="서방의 Boycott이 무의미할 정도로 러시아 공장 선단(Factory trawlers)이 밸류체인 최상단을 지배하고 있습니다. 무리한 탈(脫)러시아화는 매입 매입원가 상승 폭탄으로 돌아오므로, 우회로(중국 필레 가공)를 통한 전략적 락인이 여전히 불가피합니다."
      />
    </div>
  );
}
