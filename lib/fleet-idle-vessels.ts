...
export const FLEET_IDLE_NOTES: Record<string, FleetIdleNote> = {
  MOAMARI: {
    asOf: '2026-09-22',
    headline: '프로펠러 볼트 3개 파손(선장 보고서 8/18 확정) 수리차 젠산 예인 중 · 계약 항해 24~26일 · 도착 예정이 사흘 앞당겨졌다가 두 번 연속 되밀렸다(9/15 10/4 → 9/16 10/1 → 9/17 9/30 → 9/18 10/1 → 9/21 10/2, 9/22 유지) · 10/2 도착 기준 항해 32일 예상 · 예인료 계약 일 $41,000, 32일 가정 시 약 131만불(1,390원/$ 환산 18.2억원)으로 계약 대비 6~8일·$24.6만~32.8만 초과 예상 · 복귀 10/12~11/6 예상 · 조업손실 약 810~1,140 MT 예상',
    lines: [
      ...
      { label: '예인 진행 (예상)', text: '8/31 출발은 확정. 도착 예정이 9/11 10/20 까지 밀렸다가 9/14 10/11 → 9/15 10/4 → 9/16 10/1 → 9/17 9/30 으로 당겨졌고, 9/18 보고 10/1 · 9/21 보고 10/2 로 두 번 연속 되밀렸고 9/22 보고는 10/2 를 유지했다. 속도는 8노트대에서 내려와 있다 — 보고 위치로 재면 9/21~9/22 하루 6.7노트, 9/18~9/22 나흘 평균 6.5노트다(9/17~9/18 하루는 8.2). 9/22 위치까지 약 2,806해리를 왔고 약 1,835해리가 남았다. 최근 나흘 속도면 약 12일 뒤 10/3 으로 보고 예정일보다 하루 늦고, 출발 이후 누적 평균 5.3노트면 10/6 전후다. 보고대로 10/2 에 닿으려면 남은 10일 동안 평균 7.6노트가 필요하다. 최신 10/2 기준이면 항해 32일, 평균 6.0노트로 계약 상한(26일)보다 6일·하한(24일)보다 8일 늦다.' },
      { label: '예인료 (계약 확정 / 총액 예상)', text: '일 $41,000은 계약 확정. 총액은 항해일수에 달려 있어 예상치다 — 계약 24~26일이면 $98.4만~106.6만, 10/2 도착 기준 32일이면 약 $131만(1,390원/$ 환산 18.2억원)이다. 9/14 보고의 10/11(41일·약 $168만)에서 $37만이 줄었고, 자금팀 추산 「약 123만불(일 5,700만원·30일 약 17억원)」보다 이틀치 $8.2만 많다. 최근 나흘 속도대로 10/3 에 닿으면 33일·약 $135만이 된다. 계약 초과 6~8일분 $24.6만~32.8만(약 3.4~4.6억원)의 부담 주체가 용선 계약서상 누구인지 확인이 먼저다.' },
      ...
      { label: '확정 / 예상 구분', text: '확정은 사고 경위(8/17 접안 중 로프 감김)·프로펠러 볼트 3개 파손·출발지·도착지·일 $41,000·계약 항해 24~26일·8/31 출발이다. 프로펠러 추가 손상 여부, 도착 10/2, 항해 32일, 총 예인료 약 131만불, 수리 3~28일, 복귀 10/12~11/6, 조업손실 810~1,140 MT은 전부 예상치 또는 미확인이다. 도착 예정일은 일일보고마다 바뀐다 — 9/7 이후 10/4·10/15·10/16·10/11·10/20·10/11·10/4·10/1·9/30·10/1·10/2·10/2 이다. 잠수부 점검 결과·젠산 조선소 견적·실제 도착일이 나오면 갱신한다.' },
    ],
  },
};
