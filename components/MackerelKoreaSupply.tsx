    ...
    <div className={styles.glassCard} style={{ borderColor: 'rgba(239, 68, 68, 0.3)' }}>
      ...
      <div style={{ marginTop: '20px' }}>
        <TakeawayBox
          ...
          actionPlan="**[Actionable Insight]** 헐값에 거래되는 200~300g 중소형 고등어 원물을 1인 가구 타겟 프리미엄 HMR(전자레인지용 순살구이) 상품으로 적극 전환하여 부가가치를 극대화해야 합니다. 수요가 정체된 대형어(300g 이상) 물량을 안정적으로 확보하기 위해 선별 상장(경매) 입찰 단가를 세밀하게 조정하고 산지 직계약 물량을 선점하는 투트랙 전략이 요구됩니다. 고수온 현상 장기화로 어획량 자체가 크게 감소할 수 있는 리스크가 불가피하므로, 원물의 안정적 수급을 위한 구체적인 수입 다변화 비상계획을 선제적으로 수립해야 합니다. (Conviction Buy)"
        />
      </div>
    </div>
  );
