...
export const FLEET_IDLE_NOTES: Record<string, FleetIdleNote> = {
  MOAMARI: {
    asOf: '2026-09-14',
    headline: '프로펠러 볼트 3개 파손(선장 보고서 8/18 확정) 수리차 젠산 예인 중 · 계약 항해 24~26일 · 도착 예정이 보고마다 흔들린다(9/7 10/4 → 9/11 10/20 → 9/14 10/11) · 10/11 도착 기준 항해 41일 예상 · 예인료 계약 일 $41,000, 41일 가정 시 약 168만불(23.4억원)으로 계약 대비 15~17일·$61.5만~69.7만 초과 예상 · 복귀 10/21~11/15 예상 · 조업손실 약 950~1,300 MT 예상',
    lines: [
      ...
      { label: '예인 진행 (예상)', text: '8/31 출발은 확정. 일일보고의 도착 예정이 9/2 9/29 → 9/3·9/4 9/28 → 9/7 10/4 → 9/8 10/15 → 9/9 10/16 → 9/10 10/11 → 9/11 10/20 → 9/14 10/11 로, 9/7 이후 여섯 번의 보고에서 10/4~10/20 사이를 오갔다. 최신 10/11 기준이면 항해 41일, 평균 4.7노트다. 계약 상한(26일)보다 15일·하한(24일)보다 17일 늦다. 보고 위치로 따로 재면 9/13까지 약 1,530해리를 와서 약 3,110해리가 남았고, 지금까지 평균(약 4.9노트)이면 10/10 전후라 보고 예정일과 대체로 맞는다. 다만 9/10→9/13 사흘은 약 210해리(2.9노트)에 그쳐, 이 속도가 이어지면 10/27 전후까지 밀린다.' },
      { label: '예인료 (계약 확정 / 총액 예상)', text: '일 $41,000은 계약 확정. 총액은 항해일수에 달려 있어 예상치다 — 계약 24~26일이면 $98.4만~106.6만, 10/11 도착 기준 41일이면 약 $168만(1,390원/$ 환산 23.4억원)이다. 9/7 기준(10/4, 34일)이던 $139만에서 7일치 $28.7만이 늘었고, 9/11 보고의 10/20 이었다면 50일·$205만이다. 자금팀 추산 「약 123만불(일 5,700만원·30일 약 17억원)」은 9/29 도착 기준이라 이제 $45만가량 낮게 잡혀 있다. 계약 초과 15~17일분 $61.5만~69.7만(약 8.5~9.7억원)의 부담 주체가 용선 계약서상 누구인지 확인이 먼저다.' },
      ...
      { label: '복귀', text: '어장까지 1,945해리, 11노트 기준 7일. 10/11 도착 + 수리 3~28일 + 복귀 7일이면 어장 복귀는 10/21~11/15이다.' },
      { label: '조업손실', text: '마지막 어획 8/13부터 어장 복귀까지 69~94일이다. 보고 주기(155보고일 / 242달력일)로 환산하면 44~60보고일이고, 일평균 21.71 MT를 곱해 약 950~1,300 MT다. 8/14 이후 이미 발생한 분을 포함한 값이며 MOAMARI 연간 실적 3,365 MT의 28~39%에 해당한다.' },
      { label: '확정 / 예상 구분', text: '확정은 사고 경위(8/17 접안 중 로프 감김)·프로펠러 볼트 3개 파손·출발지·도착지·일 $41,000·계약 항해 24~26일·8/31 출발이다. 프로펠러 추가 손상 여부, 도착 10/11, 항해 41일, 총 예인료 약 168만불, 수리 3~28일, 복귀 10/21~11/15, 조업손실 950~1,300 MT은 전부 예상치 또는 미확인이다. 도착 예정일은 일일보고마다 바뀐다 — 9/7 이후 10/4·10/15·10/16·10/11·10/20·10/11 로 한 방향으로 밀리지도 않는다. 잠수부 점검 결과·젠산 조선소 견적·실제 도착일이 나오면 갱신한다.' },
    ],
  },
};
