  ...
  return (
    <div className={s.wrapper}>
      ...
      <div style={{ background: 'var(--panel-bg)', border: '1px solid var(--panel-border)', borderRadius: 'var(--card-radius)', padding: 24 }}>
        <TakeawayBox
          situation={<>6/17 기준 SEIN PHOENIX·BAO LUCKY BKK 하역 중, SHIN FUJI BKK 하역 대기 중, SHIN IZU 통영 하역 중. SEIN TOPAZ TARAWA 대기 중, SEIN GALAXY·LAKE WIN FUNAFUTI 대기 중. S/HAR 부산 오리엔트 조선 상가수리 진행. S/JUP 6/18 출항 완료, SEIN KASAMA 편 M/E 수리 예정. P/DIS 파망 사고 수리 중, P/GRACE 하역 후 6/18 출항 예정.</>}
          actionPlan={<>① 하역선 관리: SEIN PHOENIX(잔량 343t)·BAO LUCKY(잔량 1,739t) BKK 하역, SHIN FUJI 하역 대기 모니터링. ② 전재 대기선 관리: SEIN TOPAZ TARAWA 대기, SEIN GALAXY(예상잔량 1,654t)·LAKE WIN FUNAFUTI 대기 모니터링. ③ S/JUP SEIN KASAMA 도착(6/20) 일정에 맞춰 M/E 부속 인수 후 6/22 MAJURO 입항 수리 일정 관리. ④ 대서양 선망: P/PATH, P/QUEEN, P/COM 등 출항 및 조업 현황 점검. P/GRACE 6/18 TEMA 출항 예정 점검.</>}
