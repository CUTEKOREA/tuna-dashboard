...
export default function PollockChinaDetour() {
  ...
  return (
    <WidgetCard
      ...
      takeaway={{
        situation: '미국/유럽의 러시아산 수산물 직수입 제재(Tariff/Ban) 이후 러시아 명태 원물(H&G)이 중국으로 집중 유입. 중국은 자체 상업 어획량이 거의 없음에도 2023년 약 13만 7천 톤의 명태(대부분 냉동 필레)를 서방으로 가공 수출하며 우회 가공 허브 역할 수행.',
        ...
        source: 'OEC HS 0303 무역 흐름 · UN Comtrade (2019-2023)',
      }}
    />
  );
}
