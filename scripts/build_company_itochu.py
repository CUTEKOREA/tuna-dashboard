...
⚠ **한국 관점이 이 회사의 반전이다.** MSC 인증 선단 25척 중 11척이 사조그룹이다.
...
COMPARE = [
    ...
    {"항목": "자사 어선", "frinsa": "0척", "albacora": "선망 18척", "fcf": "0척", "itochu": "0척 · 인증 선단 25척"},
...
META = {
    ...
    "측정경계": "MSC 인증 선단 25척은 2022~2023년 인증 문서 기준. ESG레포트의 26척 체제와 정합한다.",
