  ...
  return (
    <div className={styles.glassCard} style={{ marginTop: '2rem' }}>
      ...
      <TakeawayBox
        ...
        actionPlan="원양 선단 투자 방향을 단일 어종에 집중하지 마십시오. 참치(안정적 현금흐름)와 오징어(높은 시세차익 기회)를 6:4 비율로 포트폴리오를 구성하면, 참치의 안정성이 오징어 시세 급락기의 손실을 헤지하고, 오징어의 고수익이 참치 마진 정체기를 보완합니다. 분기별 리밸런싱 시 ENSO 전망과 RFMO 쿼터 발표를 기준으로 비중을 조정하십시오."
      />
    </div>
  );
}
