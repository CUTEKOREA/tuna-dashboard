      ...
      case "Bar":
        return (
          <BarChart data={d}>
            ...
            {hasForecast && <ReferenceArea x1={forecastStartKey} x2={forecastEndKey} fill="rgba(var(--w-amber-500-rgb), 0.05)" stroke="rgba(var(--w-amber-500-rgb), 0.2)" strokeDasharray="3 3" />}
