...
export function EmergingMarketsHeatmap() {
  ...
  return (
    <div className={styles.insightCard}>
      ...
      <TakeawayBox
        situation="글로벌 사우스 참치 시장 총 기회규모는 $1.9B입니다. 나이지리아($597M, 5년 성장률 +23%)와 인도네시아($352M, +18%)가 최대 성장 시장이며, UAE 할랄 프리미엄 시장($180M)은 kg당 단가가 일반 시장 대비 30~40% 높아 마진 극대화에 유리합니다."
        actionPlan="**[Actionable Insight]** [3단계 진입 전략] ① 나이지리아: 현지 캔 브랜드 라이센싱으로 마켓 선점(3년 내 점유율 5% 목표), ② UAE: 할랄 인증 + 프리미엄 라인 전개로 kg당 $2 추가 마진 확보, ③ 베트남: OEM 가공 허브로 활용하여 현지 인건비 사익을 극대화해야 합니다."
