    ...
    <div style={glassContainerStyle}>
      ...
      <div style={{ marginTop: '20px' }}>
        <TakeawayBox
          ...
          actionPlan="가공의 권력을 쥔 중국 벤더에 대한 협상력 상실은 자사 제품의 원가 통제력 붕괴로 직결됩니다. 중국 다롄이나 칭다오 항구 소재의 가공 팩토리(Factory) 일부에 합작 지분을 꽂아 넣어 투명한 임가공비 내역을 상시 보고받을 수 있는 지위에 편입해야 합니다."
