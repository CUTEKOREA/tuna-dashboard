...
PROMOTED: dict[str, str] = {
    # ── F 섹션(최종 보고서) 2026-08-22 ──
    "F_processing_financials": "가공 상위 100개사 가운데 90곳의 재무가 확인된다. 전자공시에 실린 곳은 15곳뿐이고 나머지 75곳은 신용조사기관 자료로 열렸다. 이 90곳이 상위 100 생산량의 88.3%를 만든다.",
    "F_deepsea_financials": "「전자공시 미등재」는 「재무 없음」이 아니다. 등재 밖 원양 법인 11곳 전부의 재무가 확인되고 해창수산 377억, 씨맥스피셔리 154억으로 감사보고서 8사 사이에 들어간다.",
    "F_deepsea_catch": "원양 오징어류 어획은 2023년 31,511톤이 바닥이었고 2024년 63,156톤으로 두 배가 됐다가 2025년 52,122톤으로 다시 17.5% 줄었다. 같은 기간 단가는 6,232원에서 6,212원으로 거의 움직이지 않았다.",
    "F_kamis_region_2025": "전국 평균 하나가 지역을 접는다. 2025년 마른오징어 소매는 수원 86,770원과 강릉 63,953원이 35.7% 벌어지고, 산지인 포항은 84,977원으로 위에서 셋째다.",
    "F_kamis_daily_monthly": "월별 계열은 연근해냉동이 2025년 9월, 생선이 2026년 3월에 멈추지만 경락 일별은 2026년 8월 21일까지 이어진다. 최저 대비 최고 스프레드 중앙값은 2023년 23%에서 2025년 60%로 벌어졌다.",
    "F_kamis_origin_premium": "2025년 8월부터 경락표가 원산지를 나눈다. 서울에서 둘 다 관측된 253일 평균은 연근해 냉동 13,591원, 원양 냉동 10,130원으로 연근해가 34% 비싸다.",
    "F_coop_sales_annual": "수협 계통판매로 본 오징어류 위판은 1999년 240,853톤이 최대였고 2024년 13,199톤은 그 5.5%다. 해양수산부 위판 원장은 이 계열의 66.6~81.6%만 담는다.",
    "F_coop_sales_region": "결손은 고르지 않다. 2025년 부산은 계통 7,705톤인데 원장에는 1,211톤(15.7%)만 남고, 다른 지역은 86~95%다. 1999년 부산은 109,014톤으로 전국 최대 위판지였다.",
    "F_auction_annual": "위판 물량은 2021년 37,850t에서 2024년 10,768t으로 떨어지는 동안 단가는 8,089원에서 14,857원/kg으로 올랐고 2025년은 20,911t에 11,435원/kg이다.",
    "F_vessel_gear_2025": "2025년 쌍끌이대형기선저인망은 27척으로 4,006t을 팔아 근해채낚기 213척의 3,654t을 넘었고 단가는 채낚기 15,135원/kg이 저인망 10,077원/kg보다 높다.",
    "F_vessel_top20_2025": "2025년 위판 금액 상위 20척은 전부 쌍끌이 저인망이며 1위 제11동일호가 304.0t에 28.65억, 2위 제7동일호가 283.6t에 28.02억이다.",
    "F_vessel_top50_3yr": "상위 50척은 저인망 25척과 채낚기 22척으로 갈리고 이들이 전체 위판금액의 2023년 24.7%, 2024년 20.9%, 2025년 27.3%를 가져갔다.",
    "F_import_unit_annual": "한국 오징어 수입단가는 2021년 2.611달러/kg 바닥에서 2025년 4.085달러/kg까지 올랐다가 2026년 1~5월 3.067달러/kg로 내려왔다.",
    "F_processing_scale": "업소는 825곳에서 1,253곳, 품목은 2,413에서 4,538로 6년 내내 늘었는데 생산량은 2024년 53,538톤을 정점으로 꺾였고 가동률은 10.4%로 최저다 (2020→2025).",
    "F_processing_region": "업소 수는 경기 366곳이 가장 많지만 물량은 부산 133곳이 29.8%로 1위이고 업소당 물량은 부산 93.1톤 대 경기 12.1톤으로 7.7배 차이다 (2025년).",
    "F_processing_top100": "상위 100개사가 전국의 80.1%를 덮지만 1위 주식회사인성의 점유는 4.65%이고 가동률은 1위 13.4%에서 10위 부경수산 97.3%까지 벌어진다 (2025년).",
    "F_processing_sales": "오징어가 주로 들어가는 다섯 품목유형의 2025년 국내판매액은 기타 수산물가공품 3조 4,827억원부터 건어포 1,020억원까지인데, 품목유형 단위라 오징어만의 값은 어디에도 없다.",
    "F_overlap_by_type": "수입 명의 603곳 가운데 가공업을 함께 가진 곳은 117곳(19.4%)뿐이고 원물 전업은 23.4%인 반면 조제품 전업은 13.7%다.",
    "F_direct_importers": "생산 상위 100 가공사 가운데 33곳이 직접 수입하며 신고는 합계 509건, 그중 14곳이 강원이고 주제조국은 33곳 합산으로 페루 83%라 원장 전체의 35%와 대비된다.",
    "F_kamis_wholesale": "도매 물오징어 생선 중품 연평균은 2023년 13,315원에서 2024년 16,611원으로 뛴 뒤 2025년 13,687원으로 내려왔고 2026년 부분연도는 15,559원이다.",
    "F_kamis_retail": "소매 물오징어는 세 계열이 모두 해마다 올랐다. 연근해 신선냉장 대 6,258원→7,745원, 연근해 냉동 4,977원→5,962원, 원양 냉동 4,035원→5,108원 (2023→2026, 원/마리).",
    ...
    "A_sourcing_signal_board": "2026년 5~9월 기준일의 다섯 산지 신호가 갈린다. 페루는 8월 30일 상업 조업 재개(8월 30일~12월 31일 기간 한도 82,321톤), 칠레는 잔여 쿼터 60,727톤으로 조업 중, 아르헨티나는 어기 종료, 포클랜드는 9월 빌드에 적용할 공지가 없고, 한국 살오징어는 조업 상태를 확인할 데이터 자체가 없다.",
    "A_peru_pota_timeline": "페루 대왕오징어는 7월 9일 소진율 89.8%(529,391톤/589,230톤) 공지 뒤 열흘 안팎에 선창 규모별로 조업이 닫혔고, 8월 29일 RM 00304-2026이 연간 한도를 709,659톤으로 재설정해 8월 30일부터 12월 31일까지 82,321톤 한도로 상업 조업을 다시 열었다. 잔여 한도 10% 진입이 곧 발주 마감 신호이고, 재개 한도 82,321톤은 조달가능량이 아니다.",
    "A_chile_jibia_quota": "칠레 대왕오징어는 9월 1일 기준 법정 쿼터 200,000톤 중 139,273.3293톤을 포획해 69.6367%를 소진했고 잔량은 60,726.6707톤이다. 8월 18일 65.011%에서 2주 새 4.6%p 올랐다.",
    ...
    "B_kmi_consumer_price": "한국해양수산개발원 화면의 최신 날짜 확정 소비자가는 9월 8일 5,077원/마리로 8월 28일 확정가 5,321원보다 내렸다. 화면 비교 기준값 4,777원(9월 9일)은 별도 값이므로 당일 확정가로 쓰지 않는다.",
    "D_sprfmo_compliance": "2024/25 남태평양 공해 준수보고의 잠재적 비준수 41건에는 한국 기국 어선의 오징어 전재자료 기한 초과 제출 1건이 포함됐다. 서류 지연 한 건이 기국 준수기록에 남는 구조다.",
    "E_monitoring_calendar": "이번 주 5개 감시축은 가격 두 계열 갱신, 페루 8월 30일 상업 재개 뒤 신규 공문(441-2026, 개별 선사 선단 증설 인가), 칠레 쿼터 69.6367% 소진, 중국 해관 수입 달러값 미확정으로 갈린다.",
}
...
STAGES: list[dict] = [
    ...
    # 08 선박별은 사내 자료 차트만 붙는다(큐레이션 위젯 없음). 사슬 순서 검사를 위해 자리만 둔다.
    {"key": "s08", "title": "선박별", "pillar": "S2", "widgets": []},
    # ── 2026-08-22 최종 보고서(8_한국_오징어_산업_해부) 15절 이식 — 국내 산업 단계 09~15 ──
    {"key": "s09", "title": "산지 — 위판 원장 5개년", "pillar": "S2",
     "widgets": ["F_coop_sales_annual", "F_coop_sales_region", "F_auction_annual",
                 "F_vessel_gear_2025", "F_vessel_top20_2025", "F_vessel_top50_3yr"]},
    {"key": "s10", "title": "조달선과 수입 주체", "pillar": "S3", "widgets": ["F_import_unit_annual"]},
    {"key": "s11", "title": "원양 — 스무 개 법인", "pillar": "S2", "widgets": ["F_deepsea_catch", "F_deepsea_financials"]},
    {"key": "s12", "title": "가공 — 규모·지역·업체", "pillar": "S2",
...
TITLE_OVERRIDES = {
    "F_auction_annual": "산지 위판 연간 중량·금액·단가",
    "F_vessel_gear_2025": "2025년 어업별 오징어 위판",
    "F_vessel_top20_2025": "2025년 위판 금액 상위 20척",
    "F_vessel_top50_3yr": "위판 상위 50척 3개년 실적",
    "F_import_unit_annual": "연간 수입단가 (오징어만, 2020년~2026년 5월)",
    "F_processing_scale": "오징어 주원료 가공 업소·품목·생산량·가동률 추이",
    "F_processing_region": "2025년 시도별 가공 생산량과 업소당 물량",
    "F_processing_top100": "2025년 오징어 가공 생산량 상위 100개사",
    "F_processing_sales": "가공식품 품목유형별 생산액·국내판매액 추이",
    "F_overlap_by_type": "수입 유형별 가공업 보유 비율",
    "F_direct_importers": "직접 수입하는 상위 100 가공사 33곳",
    "F_kamis_wholesale": "도매 물오징어 연평균 단가 (원/kg)",
    "F_kamis_retail": "소매 물오징어 연평균 단가 (원/마리)",
    "F_tariff_rates": "냉동오징어 관세율표 (기본·조정·협정, 2025~2026)",
    "F_traceability_coverage": "유통이력 고시가 덮는 오징어 수입 비중",
...
SIT_TAK: dict[str, tuple[str, str]] = {
    ...
    "A_sourcing_signal_board": (
        "다섯 산지의 상태가 같은 시점에 갈린다. 페루 대왕오징어는 2026년 7월 24일 중단 공지 뒤 8월 29일 RM 00304-2026으로 8월 30일부터 상업 조업이 다시 열렸고 칠레는 조업 중이며 잔여 쿼터가 남아 있다. 산지마다 신호가 다르다는 것 자체가 이 시장의 구조다.",
        "한 산지가 멈춰도 다른 산지가 도는 것이 오징어 조달의 기본 전제다. **단일 산지 의존을 계약 단계에서 금지**하고 산지별 중단 공지를 주간 단위로 확인하라.",
    ),
    "A_chile_jibia_quota": (
        "칠레 수산청의 2026년 9월 3일 워크북은 내부 기준일 9월 1일 현재 총쿼터 200,000톤 중 139,273.3293톤을 포획했다고 기록한다. 소진율은 69.6367%, 잔량은 60,726.6707톤이며 소형어업 배분 175,500톤은 79.1140%가 소진됐다.",
        "잔량은 재고나 확보 가능 물량이 아니다. **워크북의 포획 누계와 법정 쿼터를 주간 대조**해 소진 속도가 빨라질 때 칠레산 신규 계약의 선적기한을 앞당겨라.",
    ),
    "B_kmi_consumer_price": (
        "원양 냉동 오징어 중품 1마리의 최신 날짜 확정값은 2026년 9월 8일 5,077원이다. 같은 화면의 비교율(전주비 -9.9%, 전월비 -8.8%)은 별도 기준값 4,777원에 붙으므로 두 값을 한 시세로 합치면 안 된다.",
        "소비자가는 매입원가가 아니다. **확정 관측 5,077원과 화면 비교기준 4,777원을 분리 표기**하고, KAMIS 도매 원/kg 또는 수입단가와 평균하지 마라.",
    ),
    "E_monitoring_calendar": (
        "9월 10일 점검에서 KMI와 KAMIS는 가격이 갱신됐고 칠레 쿼터는 69.6367% 소진됐다. 페루는 8월 29일 RM 00304-2026으로 상업 조업이 재개됐고 9월 1일 공문 441-2026은 개별 선사의 선단 증설 인가라 재개·중단 판단과 무관하며, 중국 해관 030743 수입 달러값은 보안문자 차단으로 미확정이다.",
    ...
    "B_stage_separated_prices": (
        "같은 오징어라도 어느 단계의 가격인지에 따라 값이 다르다. 9월 8일 확정 소비자가는 마리당 5,077원이고, "
        "9월 9일 화면 비교값 4,777원과도 구분해야 한다. 수입단가는 톤당 3,288.74달러라 단위와 기준중량도 다르다.",
...
COLUMN_KO: dict[str, str] = {
    ...
    '1999_t': '1999(t)',
    '2010_t': '2010(t)',
    'ledger_coverage_pct': '원장 몫(%)',
    'ledger_t': '원장 위판량(t)',
    'months': '관측월',
    '지역': '지역',
    'price_krw_per_kg': '단가(원/kg)',
    'note_rcep': '역내협정 비고',
    '건수': '건수',
    '단가': '단가(원/kg)',
    '수입겸업': '수입 겸업',
    ...
    'year': '연도',
    'series': '계열',
    'hold_capacity_m3_max': '선창 용적 상한(㎥)',
    'windows': '조업 창',
    # F 섹션(최종 보고서) 열 — 2026-08-22
    'lots': '건수',
    'weight_t': '위판중량(t)',
    'amount_krw': '위판금액(원)',
    'unit_krw_per_kg': '단가(원/kg)',
    'import_kg': '수입량(kg)',
    'import_usd': '수입액(달러)',
    'unit_price_usd_kg': '단가(달러/kg)',
    'sites': '업소',
    'items': '품목',
    'production_t': '생산량(t)',
    'capacity_t': '생산능력(t)',
    'utilization_pct': '가동률(%)',
    'zero_output_pct': '무생산 비율(%)',
    'sido': '시도',
    'per_site_t': '업소당(t)',
    'import_type': '수입 유형',
    ...
    'importers': '수입 명의',
    'food_type': '품목유형',
    'production_krw_thousand': '생산액(천원)',
    'domestic_sales_krw_thousand': '국내판매액(천원)',
    'table': '원문 표',
    'hsk': '품목번호',
    'item': '품목',
    'basic_pct': '기본세율(%)',
    'adjustment_pct': '조정관세(%)',
    'fta_peru_pct': '페루 협정세율(%)',
    'fta_chile_pct': '칠레 협정세율(%)',
    'fta_china_pct': '중국 협정세율(%)',
    'fta_vietnam_pct': '베트남 협정세율(%)',
    'fta_asean_pct': '아세안 협정세율(%)',
    'rcep_pct': '역내포괄적경제동반자협정(%)',
    'covered_usd': '대상 금액(달러)',
    'total_usd': '총 금액(달러)',
    'coverage_usd_pct': '금액 커버(%)',
    'covered_kg': '대상 중량(kg)',
    'total_kg': '총 중량(kg)',
    'coverage_kg_pct': '중량 커버(%)',
    'krw': '원',
    'HACCP품목수': '식품안전관리인증 품목수',
    'DART확인': '전자공시 확인',
    '수출등록_국가수': '수출등록 국가수',
    '주제조국_비중_%': '주제조국 비중(%)',
    '점유율_%': '점유율(%)',
...
SIT_TAK.update({
    # ── F 섹션(최종 보고서) 2026-08-22 ──
    "F_processing_financials": (
        "상위 100개사 중 90곳의 재무가 확인된다. 전자공시 15곳, 신용조사기관 75곳이고 합쳐서 생산량의 88.3%를 덮는다. 매출은 동원홈푸드 2조 6,433억부터 수억원대까지 흩어져 있고 중앙값은 86억이다. 결산 연도는 2025년이 대부분이지만 2006년과 2012년이 각각 하나씩 섞여 있다. 영업적자 9곳, 자본잠식 2곳이다.",
        "매출 규모와 오징어 생산량이 따로 놀므로, **거래처 심사에서 매출 대신 오징어 생산량 대비 매출 비율을 보고** 결산 연도가 오래된 곳은 최신 자료를 따로 요구해야 한다.",
    ),
    "F_deepsea_financials": (
        "외부감사 대상이 아닌 원양 법인 11곳의 재무가 신용조사기관 자료로 확인된다. 해창수산 377억, 피에이아이 183억, 씨맥스피셔리 154억 순이고 이 규모는 감사보고서가 있는 여덟 곳 사이에 들어간다. 결산 연도는 2014년부터 2025년까지 흩어져 있고 창진교역은 2014년이 마지막이다. 자본잠식이 창진교역 −429억, 동신어업 −334억, 삼영수산 −174억으로 셋이다.",
        "등재 여부가 회사 규모를 말해 주지 않으므로, **원양 조달처 심사에서 전자공시 유무로 거르지 말고** 신용조사기관 자료의 결산 연도를 함께 확인해야 한다.",
    ),
    "F_deepsea_catch": (
        "원양어업통계는 어획통계보다 한 해 빠르다. 오징어류 원양 어획은 2021년 73,867톤에서 2023년 31,511톤까지 내려갔다가 2024년 63,156톤으로 반등했고 2025년 52,122톤이다. 금액은 2025년 3,238억원이고 단가는 6,212원으로 5년 내내 6,200~6,450원 사이에 머문다.",
        "물량이 두 배로 뛰어도 단가가 내려오지 않으므로, **원양 자체 물량 확대를 단가 인하 근거로 쓰지 말고** 확보 물량 자체를 공급 안정 수단으로 다뤄야 한다.",
    ),
    "F_kamis_region_2025": (
        "2025년 도매 물오징어 생선은 전국 13,687원, 서울 14,973원, 대구 13,074원으로 열 달 관측 기준 14.5% 벌어진다. 소매 마른오징어는 열다섯 지역 모두 열두 달이 채워져 있고 수원 86,770원이 가장 높고 강릉 63,953원이 가장 낮다. 소매 물오징어는 지역마다 조사된 달수가 달라서 강릉은 한 달, 울산은 다섯 달만 공표됐다.",
        "지역 편차가 두 자릿수이므로, **소비지별 판매 단가를 전국 평균이 아니라 해당 지역 공표값으로 잡고** 관측 월수가 열둘이 아닌 계열은 연평균 비교에서 빼야 한다.",
    ),
    "F_kamis_daily_monthly": (
        "경락가격은 2022년 12월 30일부터 2026년 8월 21일까지 거래일 888일이 열린다. 일별 평균의 연평균은 2023년 11,193원, 2024년 14,447원, 2025년 12,670원, 2026년 8월까지 11,686원이다. 같은 날 최고값과 최저값의 격차는 중앙값 기준 2023년 23%, 2024년 40%, 2025년 60%, 2026년 40%다. 월별 계열이 멈춘 뒤에도 이 계열은 이어진다.",
        "물량이 바닥이던 해에 시장 사이가 가장 멀어졌으므로, **현물 매입 시점에는 전국 평균이 아니라 그날의 최저값과 최고값을 함께 보고** 월별 계열이 끊긴 구간은 일별 집계로 대체해야 한다.",
    ),
    "F_kamis_origin_premium": (
        "원산지 구분은 2025년 8월부터만 있다. 그전에는 지역 행이 「냉동」 한 칸이었다. 서울은 연근해와 원양이 각각 253일 관측돼 13,591원과 10,130원으로 34.2% 차이가 난다. 부산은 28.7%, 광주는 8.2%이고 대구와 대전은 연근해 관측일이 31일과 53일뿐이라 폭이 크게 나온다.",
        "같은 냉동이라도 원산지에 따라 도매가가 3할 갈리므로, **견적서에 연근해와 원양을 분리 표기하고** 관측일이 적은 지역의 프리미엄을 전국값으로 확대하지 말아야 한다.",
    ),
    "F_coop_sales_annual": (
        "수협계통판매통계정보는 1998년부터 2026년 6월까지 오징어류 판매고를 월별로 공표한다. 1999년 240,853톤·3,423억원에서 2024년 13,199톤·1,907억원으로 내려왔고 2025년은 30,176톤·3,360억원으로 되돌아왔다. 같은 기간 단가는 1,421원에서 14,452원을 거쳐 11,134원이 됐다. 2026년 상반기는 2,734톤으로 전년 같은 기간 5,215톤의 절반이고 단가는 16,894원이다.",
        "위판 물량은 반등해도 단가가 내려오지 않으므로, **국내 산지 매입 예산은 톤이 아니라 금액 기준으로 잡고** 2026년 상반기의 물량 반토막을 하반기 수입 대체 계획에 미리 넣어야 한다.",
    ),
    "F_coop_sales_region": (
        "2025년 지역별로는 부산 7,705톤, 경남 4,902톤, 전남 3,926톤, 충청 3,813톤, 경북 3,032톤 순이다. 1999년에는 부산이 109,014톤으로 전국 최대였고 경북 77,162톤, 강원 27,830톤이 뒤따랐다. 26년 사이 부산은 93% 줄었다. 원장과 대조하면 부산만 15.7%가 남고 경남 87.2%, 경북 86.5%, 강원 90.5%, 전남 94.3%로 다른 지역은 대부분 90% 안팎이다.",
        "같은 해 같은 어종인데 자료마다 물량이 다르므로, **산지 물량을 인용할 때 계통판매인지 위판 원장인지 출처를 함께 적고** 부산 물량은 원장만으로 판단하지 말아야 한다.",
    ),
    "F_auction_annual": (
        "위판 건수는 2021년 173,565건에서 2023년 113,444건까지 줄었다가 2024년 126,413건, 2025년 129,075건으로 다시 늘었다. 중량은 37,850t, 23,485t, 16,612t, 10,768t, 20,911t으로 이어지고 금액은 3,062억에서 1,600억까지 내려간 뒤 2,391억이 됐다. 단가는 8,089원, 9,019원, 10,339원, 14,857원, 11,435원/kg으로 물량이 가장 적은 2024년에 가장 높다. 2025년 상태별로는 활어 16,439원, 선어 10,956원, 냉동 9,761원이다.",
        "물량이 가장 적었던 2024년에 단가가 14,857원/kg으로 가장 높았으므로 **국내 산지 매입 예산은 톤 기준이 아니라 위판단가 상승분을 넣은 금액 기준으로 잡고** 활어 비중이 오르는 해의 평균 단가 상승을 자원값 상승으로 읽지 말아야 한다.",
    ),
    "F_vessel_gear_2025": (
        "금액으로는 근해자망 258척 6,104t 745억이 가장 크고 근해채낚기 213척 3,654t 553억, 쌍끌이대형기선저인망 27척 4,006t 403.6억, 정치망 157척 1,864t 194.5억, 연안자망 591척 1,226t 128.8억이 뒤를 잇는다. 단가는 근해채낚기 15,135원/kg이 이 다섯 어업 가운데 가장 높고 근해자망 12,205원, 연안자망 10,502원, 정치망 10,437원, 쌍끌이대형기선저인망 10,077원 순이다. 쌍끌이서남해구기선저인망은 9척이 975t을 82.6억에 팔아 단가 8,470원/kg이다. 위판 어선 1,935척 가운데 금액 상위 10척이 10.2%, 100척이 42.6%, 500척이 89.9%를 차지한다.",
        "척수가 많은 어업이 물량을 쥔 것이 아니므로, **대량 물량은 저인망이 파는 여수·마산·삼천포 위판장을, 단가 높은 물량은 채낚기 위판장을 따로 겨냥해** 매입선을 나눠야 한다.",
    ),
    "F_vessel_top20_2025": (
        "상위 20척은 모두 쌍끌이 저인망(대형·서남해구)이고 주위판장은 여수·마산·삼천포 수산업협동조합 세 곳이다. 1위 제11동일호는 43건에 304.0t으로 28.65억, 2위 제7동일호는 62건에 283.6t으로 28.02억, 3위 5동일호는 262.5t으로 25.45억이다. 단가는 마산의 제315동창호 11,202원/kg이 가장 높고 삼천포의 제1광성호 8,051원/kg이 가장 낮아 같은 저인망 안에서도 폭이 있다.",
        "상위 어선이 세 수협에 몰려 있으므로 **여수·마산·삼천포 위판장을 거치는 매입선을 확보**하되 어선명은 공개 열이라도 선주·선사 귀속을 추정해 쓰지 말아야 한다.",
    ),
    "F_vessel_top50_3yr": (
        "1위 제11동일호는 3개년 597.7t에 55.5억인데 2023년 244.8t, 2024년 48.9t, 2025년 304.0t으로 2024년에 크게 꺼졌다. 제302삼양호는 213.2t에서 16.6t으로, 제6유진호는 221.4t에서 12.9t으로 줄어 2024년 바닥이 저인망에서 났음을 보인다. 채낚기는 20위 안에 한 척도 없고 21위 제5연수호가 47.4t, 60.6t, 93.2t으로 해마다 늘어 3개년 26.0억, 25위 제3경신호는 18.4t에서 53.0t으로 늘었다. 저인망은 여수·마산·삼천포, 채낚기는 죽변·울산·후포·서산·구룡포가 주위판장이다.",
        "저인망 상위선은 2024년처럼 한 해에 물량이 크게 꺼지고 채낚기 상위선은 해마다 30~50t 안에서 고르므로, **연간 고정 물량 계약은 채낚기 위판장에, 대량 현물 매입은 저인망 어기의 위판 실적을 보며** 나눠 잡아야 한다.",
    ),
    "F_import_unit_annual": (
        "관세청 10자리 오징어만 합산한 연간 수입단가는 2020년 2.975달러/kg, 2021년 2.611달러/kg, 2022년 2.857달러/kg, 2023년 3.051달러/kg, 2024년 3.445달러/kg, 2025년 4.085달러/kg다. 2021년이 바닥이고 2025년이 여섯 해 중 최고다. 수입량은 2025년이 2020년을 조금 웃도는 정도인데 수입액은 크게 늘어, 오른 것은 물량이 아니라 단가다. 2026년 1~5월은 3.067달러/kg이며 다섯 달 관측분이라 연간 완결치가 아니다.",
        "2025년 단가 4.085달러/kg은 여섯 해 중 최고이고 2026년 1~5월 3.067달러/kg은 연간 완결치가 아니므로 **연간 원가 기준선은 2025년 단가로 잡고 2026년 1~5월 단가는 잠정치로 따로 표기**해 두 해를 같은 줄에 놓고 하락 추세로 단정하지 말아야 한다.",
    ),
    "F_processing_scale": (
        "업소와 품목은 2020년부터 2025년까지 한 해도 빠짐없이 늘었다. 생산능력은 2023년 한 번 줄었을 뿐 2020년 284,524톤에서 2025년 399,123톤이 됐다. 가동률은 13.8%에서 2023년 17.1%까지 올랐다가 2025년 10.4%로 떨어졌고 허가받아 두고 그해에 안 만든 품목 비율은 37.0%에서 50.3%로 올랐다.",
        "생산량은 완제품 무게이고 생산능력은 품목별 신고의 합이므로 **가공업체와 거래할 때는 생산능력 신고치가 아니라 그해 실제 생산량과 무생산 품목 비율을 놓고 공급 여력을 따져야** 한다.",
    ),
    "F_processing_region": (
        "생산량 비중은 부산 29.8%, 경상 20.6%, 강원 18.0%, 경기 10.7% 순이다. 업소당 물량은 부산 93.1톤, 강원 67.4톤, 경상 49.4톤인 반면 경기 12.1톤, 인천 26.0톤, 충청 14.1톤이라 수도권과 충청은 소규모 다수 층이다. 경기 366곳이 10.7%를 나눠 갖고 부산 133곳이 29.8%를 만든다.",
        "같은 업종이라도 지역마다 업소당 규모가 다른 층이므로, **대량 물량은 업소당 물량이 큰 부산·강원·경상 업체군에서 찾고 경기·인천의 소규모 다수 업체는 소량 납품선으로 따로 두는** 식으로 조달선을 지역별로 갈라야 한다.",
    ),
    "F_processing_top100": (
        "1위 주식회사인성 1,934톤(4.65%, 강원), 2위 (주)위스 1,400톤(3.37%, 부산), 3위 수협중앙회 급식사업부 1,248톤(3.00%, 인천) 순이다. 가동률은 2위 위스 87.5%, 5위 아이엠피쉬 96.5%, 9위 국제물산 94.9%, 10위 부경수산 97.3%처럼 부산·경남 업체가 높고 1위 인성 13.4%, 13위 참조은식품 4.7%처럼 낮은 곳이 강원에 몰린다. 4위 그린민푸드 제2공장은 생산능력이 0으로 보고돼 가동률이 나오지 않고 35위 명진식품은 144%로 신고 능력을 넘긴다. 상위 100 중 수입 겸업은 33곳, 식품안전관리인증 보유는 34곳이다.",
        "상위 100 중 11곳이 능력과 생산량을 같은 값으로 신고했고 여섯 곳은 능력을 0으로 적었으므로 **후보 업체의 가동률은 신고치로 믿지 말고 생산량 절대값과 전년 보고 유무를 함께 보고** 여유 능력은 직접 물어야 한다.",
    ),
    "F_processing_sales": (
        "2025년 국내판매액은 기타 수산물가공품 3조 4,827억원, 조미건어포 4,761억원, 조림류 3,952억원, 양념젓갈 2,520억원, 건어포 1,020억원이다. 기타 수산물가공품 국내판매액은 2022년 3,235,786,003천원에서 2025년 3,482,733,724천원으로 늘었고 조미건어포는 2024년 502,712,503천원에서 2025년 476,077,718천원으로 줄었다. 기타 수산물가공품에는 어류·연체류·조미가공품이 함께 들어 있고 조미건어포에는 쥐치포·황태채가 섞이며 생산액은 제조원가, 국내판매액은 제조원가에 이윤을 더한 값이다.",
        "이 금액은 오징어 가공품 시장 규모가 아니므로, **시장 크기 추정이나 업체별 매출 분해에 쓰지 말고** 품목유형 사이의 상대 비중과 연도별 방향만 참고해야 한다.",
    ),
    "F_overlap_by_type": (
        "수입 명의 603곳을 수입 유형으로 나누면 원물 전업이 312곳으로 가장 많고 그중 73곳이 품목제조보고를 갖는다. 조제품 전업은 204곳 중 28곳(13.7%), 혼합은 32곳 중 6곳(18.8%), 조제품 중심은 30곳 중 6곳(20.0%), 원물 중심은 25곳 중 4곳(16.0%)이다. 다섯 유형을 합치면 117곳이고 나머지는 가공업 없이 수입만 한다.",
        "가공업 없이 수입만 하는 명의가 다수이므로, **견적을 낸 수입 명의가 품목제조보고를 가진 가공사인지 상호 정규화 기준으로 먼저 확인**하고 가공업 없는 명의의 물량이 어디로 가는지를 상사 경유로 단정하지 말아야 한다.",
    ),
    "F_direct_importers": (
        "33곳 가운데 조제품 전업은 아라움 한 곳이고 더원씨푸드·동해로씨푸드·금한산업은 원물 중심, 나머지는 원물 전업이다. 신고건은 더원씨푸드 48건, 현대푸드·금한산업 각 42건, 정화식품 41건이 앞서고 생산 순위가 가장 높은 한성기업은 11건으로 전건 아르헨티나다. 주제조국이 페루 비중 100%인 곳이 14곳이며 중국이 주제조국인 곳은 진우푸드·대풍수산식품·해오름식품·비에스씨푸드·동원해사랑이다. 식품안전관리인증 품목은 금한산업 146, 현복식품 135, 신한성식품 93이 많고 수출등록 국가 수는 아라움 7개국이 최다다.",
        "직수입 가공사의 원료가 페루 한 곳에 쏠려 있으므로, **강원권 가공사와 계약할 때는 주제조국 비중이 페루 100%인지와 대체 제조국이 있는지를 명단으로 확인**하고 신고건수를 수입 물량으로 읽지 말아야 한다.",
    ),
    "F_kamis_wholesale": (
        "농수산물유통정보 월간 조회표의 연평균 행이며 단위는 원/kg이다. 생선 중품은 13,315원(2023), 16,611원(2024), 13,687원(2025), 15,559원(2026 부분연도)으로 오르내렸다. 연근해 냉동 계열은 11,192원, 14,455원, 13,778원으로 2024년 고점은 생선보다 낮았지만 2025년에는 13,778원으로 생선 13,687원을 근소하게 넘어섰다. 연근해 냉동은 2025년 9월이 마지막 관측이라 2026년 값이 없다.",
        "도매는 원/kg 고시가이고 소매는 원/마리라 둘을 나눠 마진을 내면 안 되므로 **국산 생물 매입 예산은 도매 원/kg 계열 하나로만 전년 대비를 잡고** 2026년 부분연도 값은 연말 확정 전까지 잠정치로 다뤄야 한다.",
    ),
    "F_kamis_retail": (
        "농수산물유통정보 소매 월간 조회표의 연평균 행이며 단위는 원/마리다. 연근해 신선냉장 대는 6,258원(2023), 6,928원(2024), 7,104원(2025), 7,745원(2026 부분연도)이고 연근해 냉동은 4,977원, 5,667원, 5,951원, 5,962원으로 2025년 이후 거의 멈췄다. 원양 냉동은 4,035원, 4,337원, 4,706원, 5,108원으로 매해 올랐다. 연근해 신선냉장 대가 원양 냉동보다 네 해 모두 높다.",
        "소매가는 원/마리라 마리당 무게가 없으면 원/kg 원가와 이을 수 없으므로, **소매 판매가를 원가 역산의 근거로 쓰지 말고 매장 판매가격 방향 점검에만** 써야 한다.",
    ),
    "F_tariff_rates": (
        "관세청 세율표 조회값이다. 주력 세번 0307.43-2090의 기본세율은 20%이고 조정관세 22%가 얹히며 협정세율은 페루 0%, 칠레 0%, 베트남 0%, 아세안 5%, 중국 9%(2025)→8%(2026), 역내포괄적경제동반자협정 20%다. 0307.43-2010은 기본세율 10%이지만 조정관세는 같은 22%이고 중국 22%, 베트남·아세안 21.6%로 페루·칠레 0%를 빼면 협정세율이 거의 내려가지 않는다. 유통비용표의 22%는 이 조정관세이며 기본세율도 평균 실행세율도 아니다.",
        "협정세율은 원산지요건을 충족해 신청할 때만 적용되므로 **견적 단계에서 HSK 10자리 세번과 원산지증명 확보 여부를 함께 확정**하고 페루·칠레산 0%와 비협정 22%를 같은 원가표에 섞지 말아야 한다.",
    ),
    "F_traceability_coverage": (
        "고시 별표가 지정한 냉동·냉장오징어 품목번호에 해당하는 2025년 수입은 금액 437,944,857달러, 중량 127,342,711kg이다. 같은 해 오징어 수입 총액 672,612,910달러와 총중량 164,675,983kg에 견주면 금액 커버가 65.1%, 중량 커버가 77.3%다. 금액 커버가 중량 커버보다 낮으니 대상 밖 물량의 킬로그램당 금액이 대상 물량보다 높다. 지정기한은 2029-04-30이고 제조공장은 신고의무자가 아니라 이력은 공장 문 앞에서 끝난다.",
        "조제품과 제조공장 투입분에는 이력이 닿지 않으므로 **원물 0307류 계약에는 유통이력 신고 이행 확인을, 조제품 1605.54 계약에는 별도의 원산지 증빙 제출을 요구**해 고시 하나로 원산지 리스크가 정리됐다고 보지 말아야 한다.",
    ),
    ...
    "B_price_freshness_board": (
        "가격 자료 세 종 가운데 기준일이 날짜까지 확정된 것은 한국해양수산개발원 소비자가격뿐으로, 2026년 9월 8일까지를 담아 경과 2일이다. 유엔식량농업기구 유럽 거래가격은 2026년 7월, 관세청 수입단가는 2026년 5월까지여서 월 단위 표기 탓에 경과일을 계산할 수 없는 「기준일정밀도부족」 상태다. 세 자료의 최신 시점은 최대 석 달가량 어긋난다.",
