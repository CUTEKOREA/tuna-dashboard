  ...
  return (
    <div className={styles.glassCard} ref={containerRef}>
      ...
      <TakeawayBox
        ...
        actionPlan="단순 거시 스프레드만 보는 것은 위험합니다. 정책 이벤트 캘린더를 시스템화하여, 조정관세 완화가 예상되는 시점 직전에 남반구 성수기 조업 물량을 '보세 창고 재고' 형태로 풀고, 방출 이벤트 직후에 시중에 본격 유통시키는 '정밀 창고 운용(Precision Warehousing)' 전략이 필수입니다."
      />
    </div>
  );
}
