    ...
    <div className={styles.glassCard} style={{ borderColor: 'rgba(20, 184, 166, 0.3)' }}>
      ...
      <div style={{ marginTop: '20px' }}>
        <TakeawayBox
          ...
          actionPlan="**[Actionable Insight]** 노르웨이 의존도(Exposure) 80%를 2027년까지 50% 이하로 낮추는 로드맵을 수립하십시오. 칠레산(잭마커렐)·아일랜드산(대서양고등어)을 보완 소싱 루트로 개척하되, 칠레산은 소형어 중심이므로 가공(필레/통조림)용으로 한정하고, 노르웨이산 대체재로는 아이슬란드·페로제도산 대형어를 우선 테스트하여 잉여현금흐름(FCF)을 극대화하십시오. (Strong Buy)"
        />
      </div>
    </div>
  );
