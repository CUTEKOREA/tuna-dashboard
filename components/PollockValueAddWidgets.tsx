    ...
    <div style={glassContainerStyle}>
      ...
      <div style={{ marginTop: '20px' }}>
        <TakeawayBox
          ...
          actionPlan="해동을 거치지 않은 최상위 신선도의 선상 가공품(FAS) 라인 파이프를 먼저 뚫어내는 기업이 글로벌 B2B 프리미엄 다이닝 납품 입찰전을 쓸어 담습니다. 구형 H&G 매입 비중을 줄이고 최첨단 FAS 선박들과의 전속 거래 예산을 최대로 배분하십시오."
...
export function Widget11_SurimiSpread() {
  ...
  return (
    <div style={glassContainerStyle}>
      ...
      <div style={{ marginTop: '20px' }}>
        <TakeawayBox
          situation="프리미엄 명태 연육과 동남아산 값싼 열대어(Tropical)의 가격 갭(Spread)을 관찰합니다. 이 가격 갭이 2배율(2.0x)을 초과 돌파하는 임계점에 진입하면 대량 B2B 어묵 제조사들은 원가 절감을 위해 맛이 조악해짐에도 싼 열대어 원료 레시피 교체를 단행합니다."
          actionPlan="핵심 클라이언트인 식품 공장들이 염가 제품 라인으로 이탈하는 엑소더스를 차단해야 합니다. 100% 명태만 고집하지 말고, 자사 차원에서 명태 70%와 가성비 열대어 30%를 황금 비율로 사전 혼합(Blending)한 중간 마진 가격대의 새로운 방어형 아이템을 출시하여야 합니다."
