    ...
    <div className={styles.insightCard}>
      <div className={styles.cardHeader}>
        <h3 className={styles.cardTitle}>
          <Globe size={20} color="#ef4444"/> Insight A. 나우루 스위치 — 중국 캐너리 온쇼어링
...
export function InsightIOCollapse() {
  return (
    <div className={styles.insightCard}>
      <div className={styles.cardHeader}>
        <h3 className={styles.cardTitle}>
          <Anchor size={20} color="#f97316"/> Insight B. 인도양 공급 붕괴 — 라스트 리조트의 임계점
...
export function InsightEU18C() {
  return (
    <div className={styles.insightCard}>
      <div className={styles.cardHeader}>
        <h3 className={styles.cardTitle}>
          <Shield size={20} color="#8b5cf6"/> Insight C. EU -18℃ 규제 무기화 — €200M 가격 갭
      ...
      <div className={styles.cardBody}>
        ...
        <div className={styles.kpiPanel}>
          <div className={styles.kpiBox} style={{ borderLeftColor: '#8b5cf6' }}>
            <div className={styles.kpiLabel}>Regulatory Price Gap</div>
