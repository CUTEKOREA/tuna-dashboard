...
const FIELD_KO: Record<string, string> = {
  ...
  '매출_백만': '매출(백만원)', '영업이익_백만': '영업이익(백만원)', '자산_백만': '자산(백만원)', '자본_백만': '자본(백만원)', '재무출처': '재무 출처', '결산일': '결산일', '회사': '회사', amount_krw_thousand: '금액(천원)',

  ym: '연월', avg: '평균(원/kg)', spread_pct: '최고·최저 격차(%)', days: '거래일', '2025_연평균': '2025 연평균', '2025_관측월': '관측월',
  '거래단계': '거래단계', '품목': '품목', '단위': '단위', '연근해_원_kg': '연근해(원/kg)', '연근해_관측일': '연근해 관측일',
  '원양_원_kg': '원양(원/kg)', '원양_관측일': '원양 관측일', '프리미엄_%': '연근해 프리미엄(%)',

  months: '관측월', ledger_t: '원장 위판량(t)', ledger_coverage_pct: '원장 몫(%)',
  price_krw_per_kg: '단가(원/kg)', '지역': '지역', '1999_t': '1999(t)', '2010_t': '2010(t)', '2023_t': '2023(t)', '2024_t': '2024(t)', '2025_t': '2025(t)',
  '2023_억': '2023 금액(억원)', '2024_억': '2024 금액(억원)', '2025_억': '2025 금액(억원)', '3개년_t': '3개년 중량(t)', '3개년_억': '3개년 금액(억원)',
  ...
  covered_usd: '대상 금액(USD)', total_usd: '총 금액(USD)', coverage_usd_pct: '금액 커버(%)', covered_kg: '대상 중량(kg)', total_kg: '총 중량(kg)', coverage_kg_pct: '중량 커버(%)',
  '주제조국_비중_%': '주제조국 비중(%)',
  importers: '수입 명의',
