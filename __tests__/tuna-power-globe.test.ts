...
const NUMERALS = [
  'Ⅰ', 'Ⅱ', 'Ⅲ', 'Ⅳ', 'Ⅴ', 'Ⅵ', 'Ⅶ', 'Ⅷ', 'Ⅸ', 'Ⅹ',
  'ⅩⅠ', 'ⅩⅡ', 'ⅩⅢ', 'ⅩⅣ', 'ⅩⅤ', 'ⅩⅥ', 'ⅩⅦ', 'ⅩⅧ', 'ⅩⅨ', 'ⅩⅩ', 'ⅩⅩⅠ', 'ⅩⅩⅡ', 'ⅩⅩⅢ', 'ⅩⅩⅣ', 'ⅩⅩⅤ', 'ⅩⅩⅥ', 'ⅩⅩⅦ', 'ⅩⅩⅧ', 'ⅩⅩⅨ', 'ⅩⅩⅩ', 'ⅩⅩⅪ', 'ⅩⅩⅫ', 'ⅩⅩⅩⅢ', 'ⅩⅩⅩⅣ', 'ⅩⅩⅩⅤ', 'ⅩⅩⅩⅥ', 'ⅩⅩⅩⅦ', 'ⅩⅩⅩⅧ', 'ⅩⅩⅩⅨ', 'ⅩⅬ', 'ⅩⅬⅠ', 'ⅩⅬⅡ', 'ⅩⅬⅢ', 'ⅩⅬⅣ', 'ⅩⅬⅤ', 'ⅩⅬⅥ', 'ⅩⅬⅦ', 'ⅩⅬⅧ',
];

describe('좌표 원장', () => {
  it('44편 전부가 본사 핀을 갖는다', () => {
    expect(HQ_POINTS).toHaveLength(48);
