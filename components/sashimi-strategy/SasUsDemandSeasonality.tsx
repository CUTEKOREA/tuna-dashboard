...
/* ── 미국 참치 수요 드라이버 + 계절성 ──
   검증: NFI 1인당 캔참치 2.0lb/년(2023, 상위 수산물 3위 — 2.2lb는 2019 구값),
...
const DRIVERS = [
  { label: '1인당 캔참치 소비', value: '2.0', unit: 'lb/년', sub: 'NFI 2023 · 상위 수산물 3위', color: '#38bdf8' },
...
export default function SasUsDemandSeasonality() {
  return (
    <WidgetCard
      ...
      cardDesc="수요 구조 — NFI 1인당 소비(2023)·IFIC 단백질 트렌드(2024) + 계절 수요 정성 인덱스(자체 추정, 무출처)"
      takeaway={{
        situation: "미국 참치 수요는 구조적 단백질 전환이 견인합니다. 단백질을 적극 추구하는 소비자가 2022년 59%→2024년 71%로 늘었고(IFIC Food & Health Survey), 1인당 캔참치 소비는 2.0lb/년(2023, NFI 상위 수산물 3위)입니다. 계절적으로는 여름 그릴링 시즌(6~8월)과 연말(12월) 스시·외식 수요가 피크를 이루는 패턴이며, 월별 수요 인덱스는 1차 출처가 없는 자체 정성 추정치(여름 고점·겨울 저점)로 정밀 수치가 아닌 방향성 참고용입니다.",
        ...
        source: "NFI Top 10 Seafood 2023(1인당 캔참치 2.0lb·3위) / IFIC Food & Health Survey(단백질 추구 67%→71%, 2024). 계절 인덱스는 그릴링·연말 수요 패턴 기반 자체 정성 추정(1차 출처 없음). FMI 54% 주장은 1차 미확인으로 제외",
      }}
      customBody={
