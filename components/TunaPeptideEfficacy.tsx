    ...
    <div className={styles.card}>
      ...
      <div className={styles.cardBody}>
        ...
        <TakeawayBox 
          ...
          actionPlan="1) 기존 자숙 공정에 프로테아제(Protease) 효소 분해 라인을 신설하는 것이 최우선 CapEx 투자 항목입니다 — 열수추출 대비 3~7배 높은 생리활성이 곧 B2B 납품 단가 프리미엄으로 직결됩니다. 2) HPMC 장용성 코팅을 적용한 캡슐형 건기식(EPP) 제품화를 통해, 기존 '조미료'($/kg 4.8) → '기능성 헬스케어 소재'($/kg 12.5+)로의 카테고리 업그레이드를 실현해야 합니다." 
