    ...
    <div className={styles.insightCard} ref={containerRef}>
      ...
      <div style={{ marginTop: '20px' }}>
        <TakeawayBox
          ...
          actionPlan="'모든 길은 도쿄로 통한다'는 극단적인 단일 시장 리스크를 안고 있습니다. 일본 내수 침체나 엔저 심화 시 수익성이 즉각 붕괴됩니다. 구매자는 미국과 UAE(두바이)의 최고급 하이엔드 레스토랑 타겟으로 데스티네이션(Destination)을 강제 다변화해야 합니다. 한국산 참다랑어를 일본 바이어의 화이트라벨(White-label) 납품에서 탈피하여 자체 프리미엄 'K-Bluefin' 브랜드로 독립시키는 마케팅 투자가 즉시 집행되어야 해야 합니다."
        />
      </div>
    </div>
  );
