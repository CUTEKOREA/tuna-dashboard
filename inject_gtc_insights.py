...
gtc_file = "/Users/idong-geon/연구자동화애이전트들/tuna-dashboard/components/Gtc2026Insights.tsx"
...
print(f"Found {len(gtc_insights)} GTC insights.")

jsx_output = ""
for i, ins in enumerate(gtc_insights, start=36):
...
{jsx_output}
    ...
    with open(target_file, 'w') as f:
        f.write(new_content)
    print("Successfully injected GTC insights.")
else:
