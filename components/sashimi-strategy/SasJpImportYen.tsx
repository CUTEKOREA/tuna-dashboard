...
/* ── 엔저가 가른 일본 참치 수입 — 買い負け (일본 수산청 수산백서·SeafoodSource) ──
   ...
   정정(Round2 2026-06-05, ICCAT SCRS 1차): 동대서양·지중해 BFT TAC(2024)=40,570t·실어획 39,426t.
   EU 蓄養(축양) 능력은 2024년 27,900t(양식장 20개소)→2025년 51,143t(25개소). 일본向 ~80~90%(2차 보강).
   → 기존 '총량 약 5만t 중 蓄養 약 4만t'은 1차 미뒷받침이라 ICCAT TAC/蓄養 능력값으로 교체.
   정정: 본마구로 국가별 구성비(대만 21.5% 등) 미검증으로 제외.
   주: 엔화 환산 도매 단가(¥1,500→¥1,900~1,950)는 SeafoodSource 2차 보도이며 ICCAT 1차 검증 범위 외(STATIC 유지). */
const YEN = [
