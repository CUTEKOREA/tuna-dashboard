    ...
    <div className={styles.card} style={{ display: 'flex', flexDirection: 'column', minHeight: '480px' }}>
      ...
      <div style={{ marginTop: 'auto' }}>
        <TakeawayBox
          ...
          actionPlan="**[Actionable Insight]** 1) 참치액젓 1톤 생산 시 부산물 자원화량을 SDG 12.3 기여도로 환산하여, ESG 보고서 및 바이어 대상 '순환경제 인증' 마케팅 소재로 활용해야 합니다. 2) FAO Blue Transformation 프레임워크와 연계하여, '추가 어획 없이 가치사슬을 업그레이드'하는 친환경 혁신 사례로 글로벌 바이어에게 포지셔닝하면 프리미엄 단가 확보가 가능합니다. 3) EU 하역 의무화 정책을 활용하여, 유럽 시장 진출 시 '규제 준수 + 순환경제' 이중 가치를 소구해야 해야 합니다. (Conviction Buy)"
