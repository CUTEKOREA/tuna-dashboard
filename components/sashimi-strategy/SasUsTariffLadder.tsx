...
export default function SasUsTariffLadder() {
  return (
    <WidgetCard
      ...
      cardDesc="2025 미국 상호관세(국제긴급경제권한법(IEEPA) 근거) 공급국별 적용률(국가별 일반율, 참치 품목 고유율 아님) — Federal Register·CBP 기준. 2025-11-25 농산물 예외(FR 2025-21203)의 수산물 적용 여부는 미반영."
      takeaway={{
        situation: "2025년 미국 상호관세로 비통조림 참치 공급국 간 관세 격차가 새로 생겼습니다(한국 적용분 2025-11-14 발효). 관세 사다리: 멕시코(미국·멕시코·캐나다 협정(USMCA) 원산지) 0% 면제 < 한국·EU 15% < 인니·태국 19% < 베트남 20%. 한국은 한·미 자유무역협정(KORUS FTA) 무관세 우위가 15%로 침식됐으나, 핵심 경쟁국 인니·태국·베트남 대비 4~5%p 낮은 위치를 확보했습니다. 여기 표시한 적용률은 각국 상호관세 일반율로, 비통조림 참치(HS 0302·0303·0304) 품목 고유율은 별도 확인이 필요합니다. 한국·경쟁국 모두 동일 일반율 체계 하에서 격차가 벌어졌다는 점이 핵심입니다.",
        ...
        source: "Federal Register 2025-21940(한국 15%) / White House 행정명령(EO) 14326, FR Doc. 2025-15010(인니·태국 19%·베트남 20%) / 미국-EU 프레임워크 합의(EU 15%, MFN 기저율 합산 기준) / CBP IEEPA FAQ(멕시코 USMCA 면제). 적용률은 국가별 상호관세 일반율이며 비통조림 참치 품목 고유율이 아님(EU는 MFN 기저율 합산 메커니즘 반영).",
      }}
      customBody={
