...
/* ── 국가별 참치 사시미 소비시장 비교 (6개국 × 어종/등급/소비처/규모) ──
   검증(FAO GLOBEFISH·IBISWorld·WWF Japan·CBI·BlueWeave·IndexBox): 일본 세계 참치 1/4~1/5 소비·참다랑어 약 72%(WWF 2012 추정),
   미국 스시외식 $327억(IBISWorld 2024)·미국 포케 샵 $20억(IBISWorld 2024), 한국 무한리필 731개, 중국 일식당 약 4만개(2017), EU 일식당 약 1.2만개(업계 추정).
   ※주의: '사시미 단독' 공식 시장규모 통계는 부재 → 외식채널·수입물량 근사. */
const ROWS = [
  { rc: '#ef4444', flag: '🇯🇵', name: '일본', size: '세계 최대(1/4~1/5 소비)', mass: '눈다랑어 30%·황다랑어', prem: '참다랑어(세계 약 72%·WWF 2012)', ch: '회전초밥·오마카세·도요스' },
  ...
  { rc: '#38bdf8', flag: '🇨🇳', name: '중국', size: '총참치 $1.76B(사시미 소수)', mass: '황다랑어 AAA 사쿠', prem: '블루핀(상하이 집중)', ch: '일식당 약 4만개(2017)·이커머스' },
  { rc: '#a78bfa', flag: '🇹🇼🇭🇰', name: '대만·홍콩', size: '소규모·프리미엄 편중', mass: '빅아이·황다랑어', prem: '블루핀(동강·홍콩 Toyosu)', ch: '동강축제·홍콩 오마카세' },
  { rc: '#22d3ee', flag: '🇪🇺', name: 'EU', size: '캔 위주, 사시미 소수', mass: '황다랑어(역외 신선 75%)', prem: '지중해 블루핀(대부분 일본行)', ch: '일식당 약 1.2만개(추정)·슈퍼스시' },
];
...
export default function SasGlConsumptionMatrix() {
  return (
    <WidgetCard
      ...
      cardDesc="국가별 사시미 소비 규모·어종·등급·채널 — FAO GLOBEFISH·IBISWorld(2024)·WWF Japan(2012)·CBI·IndexBox(외식·수입 근사, 기준연도 상이)"
      takeaway={{
        situation: "참치 사시미 소비는 국가마다 어종·등급·채널이 뚜렷이 갈립니다. 일본은 세계 참치의 1/4~1/5을 소비하는 압도적 1위로 눈다랑어(메바치) 30%가 대중 주력이고 참다랑어(세계 소비의 약 72%·WWF 2012 추정)가 프리미엄 정점입니다. 미국은 황다랑어(Ahi) 포케·사쿠 대중 시장(미국 포케 샵 $20억, IBISWorld 2024)과 블루핀 오마카세 프리미엄으로 이원화됐고, 한국은 눈다랑어 '가성비 횟감'과 무한리필 731개 채널이 특징입니다. 중국은 폭증 수입의 대부분이 가공용 저가 가다랑어이고 사시미는 황다랑어 AAA 사쿠 중심의 신흥 틈새시장(일식당 약 4만개, 2017 기준), EU는 캔 위주 시장에서 사시미가 소수입니다. ⚠ 모든 국가에서 '사시미 단독' 공식 시장규모 통계는 부재해 외식·수입 물량으로 근사한 수치입니다.",
        ...
        source: "FAO GLOBEFISH·IMARC(일본)·IBISWorld 2024(미국 스시 $327억·미국 포케 샵 $20억)·WWF Japan 2012(참다랑어 약 72%, 14년 경과 추정)·IMARC/MRFR(한국)·BlueWeave/IndexBox(중국, 일식당 4만개는 2017)·CBI(EU 일식당 약 1.2만개는 업계 추정·미확인). ※사시미 단독 통계 부재로 외식·수입 근사",
      }}
      customBody={
