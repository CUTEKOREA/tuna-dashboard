    ...
    <div style={{ padding: '0 1.5rem 3rem', color: 'var(--text-primary)', minHeight: '100vh', fontFamily: "'Inter',sans-serif", backgroundColor: 'var(--bg-color)' }}>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'repeat(2, 1fr)', gap:'1.5rem', marginBottom:'2.5rem' }}>
        ...
        <div className={styles.glassCard} style={{ display:'flex', flexDirection:'column', minHeight:'480px' }}>
          ...
          actionPlan="**[Actionable Insight]** 중국산 원물의 가격 경쟁력이 한층 강화될 전망입니다. 국내 생산 감소분을 상쇄하기 위해 중국산 벌크 수입 물량을 선제적으로 확보하고, 가격 하락 사이클을 활용해 마진율을 극대화해야 해야 합니다. (Conviction Buy)"
        ...
        <div className={styles.glassCard} style={{ display:'flex', flexDirection:'column', minHeight:'480px' }}>
          ...
          actionPlan="**[Actionable Insight]** 안정화된 도매가를 기반으로 국내 원물 소싱 비중을 전략(Strategy)적으로 재조정할 수 있는 적기입니다. 다만 평년 가격(1.4만원대)으로의 회귀 가능성을 대비해 스팟(Spot) 매수보다는 6개월 단위 선도 계약을 추진하여 잉여현금흐름(FCF)을 극대화하십시오. (Strong Buy)"
        ...
        <div className={styles.glassCard} style={{ display:'flex', flexDirection:'column', minHeight:'480px', gridColumn: '1 / -1' }}>
          ...
          actionPlan="**[Actionable Insight]** 수확량 타격 및 품질 저하를 사전 헷징하기 위해 기후 예측 AI 모델을 도입해야 합니다. 이상기후 징후 포착 시 대체 산지(중국, 이집트) 발주량을 즉각 상향하는 공급망 민첩성(Agility)을 확보하여 잉여현금흐름(FCF)을 극대화하십시오. (Strong Buy)"
      ...
      <div style={{ display:'grid', gridTemplateColumns:'repeat(2, 1fr)', gap:'1.5rem', marginBottom:'2.5rem' }}>
        ...
        <div className={styles.glassCard} style={{ display:'flex', flexDirection:'column', minHeight:'480px' }}>
          ...
          actionPlan="**[Actionable Insight]** 민간 저장고의 출하 지연은 단기적인 가격 하락 압력으로 작용합니다. 저가 매수 기회로 활용하되, 재고 품질 저하(수분 감모, 부패)를 고려해 실물 검수(QA) 기준을 최고 등급으로 상향해야 해야 합니다. (Conviction Buy)"
        ...
        <div className={styles.glassCard} style={{ display:'flex', flexDirection:'column', minHeight:'480px' }}>
          ...
          <div style={{ marginTop:'auto' }}>
            <TakeawayBox
          situation="[인사이트 7: 가공(Processing) 마늘 수입 비중 급증] OEC 및 관세청 통계 결과, 신선 마늘 대비 보관이 용이하고 관세가 저렴한 냉동 및 건조 가공(Processing) 마늘의 수입 비중이 91%를 돌파했습니다."
          actionPlan="**[Actionable Insight]** 외식업계(HORECA)의 인건비 부담으로 원물 직접 조리보다 가공(Processing) 형태의 B2B 수요가 절대적입니다. 해외 현지 가공(Processing) 벤더와 독점 계약을 체결하여 일관된 품질의 냉동 다진 마늘 밸류체인을 선점하여 잉여현금흐름(FCF)을 극대화하십시오. (Strong Buy)"
        ...
        <div className={styles.glassCard} style={{ display:'flex', flexDirection:'column', minHeight:'480px', gridColumn: '1 / -1' }}>
          ...
          <div style={{ marginTop:'auto' }}>
            <TakeawayBox
          situation="[인사이트 10: 채널 이원화 전략(Strategy)] B2B 시장은 철저한 저원가(수입산 가공(Processing)) 트랙을, B2C 시장은 무농약 소포장 프리미엄 트랙을 밟는 채널 이원화 현상이 심화되고 있습니다."
          actionPlan="**[Actionable Insight]** 중소형 패키징 리테일러를 인수하여 프리미엄 B2C 시장에 직진출하고, B2B는 대용량 벌크 위주의 규모의 경제를 실현하는 투-트랙 포트폴리오를 완비해야 가치평가 방어가 가능해야 합니다. (Conviction Buy)"
      ...
      <div style={{ display:'grid', gridTemplateColumns:'repeat(2, 1fr)', gap:'1.5rem', marginBottom:'2.5rem' }}>
        ...
        <div className={styles.glassCard} style={{ display:'flex', flexDirection:'column', minHeight:'480px' }}>
          ...
          actionPlan="**[Actionable Insight]** 필수 양념채소 간의 대체재 효과가 작동하지 않는 비탄력적 시장 구조입니다. 타 작물의 가격 등락에 의존하기보다, 마늘 자체의 고유 수요를 창출할 HMR 레시피 개발 및 소스화 R&D 투자가 요구됩니다. (Actionable Buy)"
        ...
        <div className={styles.glassCard} style={{ display:'flex', flexDirection:'column', minHeight:'480px' }}>
          ...
          actionPlan="**[Actionable Insight]** 정책 리포트 및 농식품부 보도자료를 실시간 크롤링하여 TRQ 방출 징후를 선제적으로 포착하는 조기 경보 시스템을 가동 중입니다. 물량 방출 직전 보유 재고를 선출하하는 디리스킹(De-risking) 프로토콜을 실행하여 잉여현금흐름(FCF)을 극대화하십시오. (Strong Buy)"
        ...
        <div className={styles.glassCard} style={{ display:'flex', flexDirection:'column', minHeight:'480px', gridColumn: '1 / -1' }}>
          ...
          actionPlan="**[Actionable Insight]** 외부 지정학적 충격에 무방비로 노출된 공급망은 실사 시 중대한 Risk 감점 요인입니다. 단순 선사 계약을 넘어 운임 변동에 따라 능동적으로 소싱처(동남아/남미)를 전환하거나 선도계약(Forward Rate Agreement)으로 물류비를 고정시키는 재무적 헷징 능력이 필수적입니다. (Execution Recommended)"
        ...
        <div className={styles.glassCard} style={{ display:'flex', flexDirection:'column', minHeight:'520px' }}>
          ...
          actionPlan="**[Actionable Insight]** 단순 매입원가(COGS) 계약을 지양하고 선물환 거래 및 환변동 보험을 통해 결제 통화 리스크를 능동적으로 헷징해야 합니다. 시뮬레이터를 통해 최적의 결제 시점을 매일 평가하여 잉여현금흐름(FCF)을 극대화하십시오. (Strong Buy)"
        source="📊 [데이터 출처: SCFI 지수 기반 시뮬레이션]"
        />
          </div>
        </div>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'repeat(2, 1fr)', gap:'1.5rem', marginBottom:'2.5rem' }}>
        ...
        <div className={styles.glassCard} style={{ display:'flex', flexDirection:'column', minHeight:'480px' }}>
          ...
          actionPlan="**[Actionable Insight]** 수량(Volume) 중심의 내수 성장은 한계에 직면했습니다. 타겟 시장을 글로벌 선진국으로 재편하고, 고마진 기능성/유기농 브랜드(Value Migration) 제품군을 론칭하는 것이 중장기 생존 및 멀티플(Multiple) 확장의 유일한 해답입니다. (Conviction Buy)"
        source="📊 [데이터 출처: FAOSTAT QCL Open API]"
        />
          </div>
        </div>
        ...
        <div className={styles.glassCard} style={{ display:'flex', flexDirection:'column', minHeight:'480px' }}>
          ...
          actionPlan="**[Actionable Insight]** 연간 수만 톤에 달하는 보관 부패/폐기 물량을 막지 못하면 무역 적자는 심화됩니다. 대규모 CA(Controlled Atmosphere) 저온 저장고 등 애그리테크(Agri-Tech) 인프라를 보유한 기업을 인수하여 수급 조절 및 시세 차익(Arbitrage) 역량을 내재화(Internalization)해야 해야 합니다. (Conviction Buy)"
        source="📊 [데이터 출처: 관세청(KCS) 관세율표]"
        />
          </div>
        </div>
        ...
        <div className={styles.glassCard} style={{ display:'flex', flexDirection:'column', minHeight:'480px', gridColumn: '1 / -1' }}>
          ...
          actionPlan="**[Actionable Insight]** B2C 소매 벤더 매각 시 ESG 컴플라이언스는 필수 듀딜리전스(DD) 항목입니다. 재생 플라스틱/종이 포장 자동화 설비를 선제 도입하여 대형 마트의 ESG 벤더 요건을 선점하는 것이 B2C 채널 방어 및 프리미엄 엑시트(Exit)의 전제 조건입니다. (Strong Buy)"
        ...
        <div className={styles.glassCard} style={{ display:'flex', flexDirection:'column', minHeight:'480px' }}>
          ...
          <div style={{ marginTop:'auto' }}>
            <TakeawayBox
          situation="J.P. Morgan 글로벌 사모펀드(PEF) 실사 API 기준, 동일한 매출이라도 단순 농산물 도매업은 4~5x 멀티플(Multiple)에 그치지만, 가공(Processing) 기술(Processing) 내재화(Internalization) 시 8x, 수확량 예측 AI(AgTech) 내재화(Internalization) 시 15x 이상의 엔터프라이즈 밸류(EV)를 인정받습니다."
          actionPlan="**[Actionable Insight]** 전통적인 유통 구조에 안주하면 자본 시장에서 가치(Valuation)를 인정받을 수 없습니다. 대시보드 내 GPR 단수 방어, 흑마늘 기능성 가공(Processing), 수입 Arbitrage 물류 시스템을 총결합하여 회사를 '글로벌 애그테크 플랫폼'으로 포지셔닝해야 궁극적인 EBITDA 15x 리레이팅(Re-rating) 엑시트(Exit)가 가능해야 합니다. (Conviction Buy)"
      ...
      <div style={{ display:'grid', gridTemplateColumns:'repeat(2, 1fr)', gap:'1.5rem', marginBottom:'2.5rem' }}>
        ...
        <div className={styles.glassCard} style={{ display:'flex', flexDirection:'column', minHeight:'480px' }}>
          ...
          actionPlan="**[Actionable Insight]** 국내 수급에 전적으로 의존하는 B2B 식자재/가공(Processing) 벤더는 중장기적으로 원물 확보 불능(Sourcing Failure) 상태에 빠집니다. 실사 시 자체 농장(Corporate Farming) 보유 여부보다는 인도, 동남아, 중국 등 복수 국가 소싱망을 보유한 업체를 선별해야 밸류에이션 리스크를 헤지할 수 있습니다."
        source="📊 [데이터 출처: KREI 농업관측센터]"
        />
          </div>
        </div>
        ...
        <div className={styles.glassCard} style={{ display:'flex', flexDirection:'column', minHeight:'480px' }}>
          ...
          actionPlan="**[Actionable Insight]** 고변동성은 매입원가(COGS) 예측을 불가능하게 만들어 제조 마진을 파괴합니다. 이를 제어하기 위해 선도계약(Forward Contract) 비율을 70% 이상으로 유지하고, 파생상품 및 데이터 기반 가격 예측 알고리즘 운용 능력을 갖춘 퀀트 농업(Quant Agri) 조직 구축이 시급해야 합니다. (Conviction Buy)"
        source="📊 [데이터 출처: UN Comtrade 선물거래소]"
        />
          </div>
        </div>
        ...
        <div className={styles.glassCard} style={{ display:'flex', flexDirection:'column', minHeight:'480px', gridColumn: '1 / -1' }}>
          ...
          actionPlan="**[Actionable Insight]** PEF 밸류업 관점에서 ESG는 단순 규제 준수를 넘어 새로운 'Cash Cow'입니다. 마늘 가공(Processing) 시설 인수 시, 잔여물을 사료/비료화 하는 폐루프(Closed-loop) 공정 도입 가능성을 철저히 실사하여, 탄소 배출권 및 부가 매출(Top-line) 동시 확장을 도모해야 해야 합니다. (Conviction Buy)"
