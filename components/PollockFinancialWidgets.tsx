...
<BarChart data={data}>
  <ChartPatternDefs />
            ...
            <YAxis stroke="rgba(255,255,255,0.5)" fontSize={11} tickFormatter={(v)=>`${v}%`} tickMargin={10} />
            <Tooltip contentStyle={{ background: '#0a0f1f', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px', color: 'var(--w-slate-50)' }} />
            <Bar dataKey="매출비중" fill="var(--w-slate-300)" name="그룹 전사 매출 점유(Volume)" radius={[4,4,0,0]} />
            <Bar dataKey="이익기여도" fill="var(--w-violet-500)" name="영업 순수익 현금 캐리 포션" radius={[4,4,0,0]} />
            <Legend iconType="circle" wrapperStyle={{ fontSize: '11px', color: 'rgba(255,255,255,0.7)', paddingTop: '10px' }} />
          </BarChart>
      }
      takeaway={{
...
<ScatterChart margin={{ top: 20, right: 20, bottom: 20, left: 10 }}>
            ...
            <Tooltip cursor={{ strokeDasharray: '3 3' }} contentStyle={{ background: '#0a0f1f', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px', color: 'var(--w-slate-50)' }} />
