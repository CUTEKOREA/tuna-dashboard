...
return (
  ...
  const situation = 'CJ 등 국내 대형 B2B 고객사의 참치캔 납품 단가 인하 압박 및 태국 가공업체들의 원가 상승 딜레마 발생. 태국 대비 베트남의 인건비는 38% 낮으며($280 vs $450/MT), EU-베트남 FTA로 관세율이 0%(태국 20.5%)로 원가 경쟁력이 압도적입니다. 다만 가공 수율(44% vs 46%)과 항만 효율(75 vs 85)은 태국이 우세하여 품질 관리 리스크가 존재합니다.';
