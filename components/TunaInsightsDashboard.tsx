      ...
      <div className={styles.insightCard}>
        ...
        <div style={{ padding: '0 20px 20px 20px' }}>
          <TakeawayBox
            ...
            actionPlan="**[Actionable Insight]** [Capital Allocation Strategy] 단순 원물 트레이딩 볼륨을 축소하고, 가공 차익(Processing Margin)을 극대화하는 \'Value-Add\' 라인으로 자본을 전면 재배치해야 합니다. 특히 EU향 무관세 혜택(Tariff Advantage)이 있는 에콰도르 내 톨링(Tolling) 파트너십을 즉시 체결하여 규제 차익(Regulatory Arbitrage)까지 동시에 확보하여 잉여현금흐름(FCF)을 극대화하십시오. (Strong Buy)"
          />
        </div>
      </div>
      ...
      <div className={styles.insightCard}>
        ...
        <div style={{ padding: '0 20px 20px 20px' }}>
          <TakeawayBox
            ...
            actionPlan="**[Actionable Insight]** [M&A / FDI Strategy] 미국 및 일본 내 On-shore 가공 설비를 보유한 경쟁사들의 한계 비용(Marginal Cost)이 한계선에 도달했습니다. 우리는 중남미(에콰도르)의 기구축된 밸류체인을 활용해, 북미 리테일러향 \'관세 회피(Tariff-free) 프라이빗 라벨(PB)\' 장기 공급 계약을 선점하는 우회 진입(Bypass) 전략을 즉각 승인해야 해야 합니다. (Conviction Buy)"
          />
        </div>
      </div>
      ...
      <div className={styles.insightCard}>
        ...
        <div style={{ padding: '0 20px 20px 20px' }}>
          <TakeawayBox
            ...
            actionPlan="**[Actionable Insight]** [Market Penetration Tactics] 선진국의 저성장(Stagnation) 굴레에서 벗어나, 아프리카 및 중동 내 1차 벤더(Tier 1 Distributor) 지분을 전략적으로 인수하거나 조인트벤처(JV)를 설립하십시오. 초기 진입 시 저가 블렌딩(Blending) 스킵잭 라인업으로 시장 점유율(Market Share)을 장악한 뒤, 프리미엄 라인으로 마진을 확대하는 2-Step 침투 전략을 집행해야 해야 합니다. (Conviction Buy)"
          />
        </div>
      </div>
    </>
      ...
      <div className={styles.insightCard}>
        ...
        <div style={{ padding: '0 20px 20px 20px' }}>
          <TakeawayBox
            ...
            actionPlan="**[Actionable Insight]** [Fleet Redeployment Protocol] 기상 이변은 리스크가 아니라 기회입니다. 글로벌 ENSO(엘니뇨 남방진동) 지수가 1.5 임계치를 돌파하는 즉시, 태평양 선단(Fleet)의 30%를 대서양 공해상으로 전진 배치하는 \'동적 헷징(Dynamic Hedging) 매뉴얼\'을 전격 가동하십시오. 기상 리스크를 선제적 조업권 확보(Arbitrage)의 무기로 전환해야 해야 합니다. (Conviction Buy)"
          />
        </div>
      </div>
      ...
      <div className={styles.insightCard}>
        ...
        <div style={{ padding: '0 20px 20px 20px' }}>
          <TakeawayBox
            ...
            actionPlan="**[Actionable Insight]** [Portfolio Diversification] 참치 단일 어종에 의존하는 \'One-trick Pony\' 비즈니스 모델을 즉시 폐기하십시오. 참치 흉어 리스크를 재무적으로 완전 상쇄(Offset)할 수 있도록, 스칸디나비아산 고등어 쿼터(Quota) 확보 및 트레이딩 부서를 통합 신설하여 \'펠라직 인덱스 펀드\' 관점의 다각화된 상품 포트폴리오를 구축해야 해야 합니다. (Conviction Buy)"
          />
        </div>
      </div>
      ...
      <div className={styles.insightCard}>
        ...
        <div style={{ padding: '0 20px 20px 20px' }}>
          <TakeawayBox
            ...
            actionPlan="**[Actionable Insight]** [ESG Compliance Audit] 무역 불일치 물량이 당사의 소싱 파이프라인(Supply Chain)에 1%라도 섞여 들어올 경우, 서구권 메이저 리테일러의 상장 폐지급 벤더 퇴출 리스크가 존재합니다. 즉시 제3자(Third-party) 블록체인 이력 추적 시스템을 도입하여 밸류체인의 무결성을 투명하게 증명(Auditability)하고, 이를 마케팅 무기로 역활용하여 잉여현금흐름(FCF)을 극대화하십시오. (Strong Buy)"
          />
        </div>
      </div>
    </>
      ...
      <div className={styles.insightCard}>
        ...
        <div style={{ padding: '0 20px 20px 20px' }}>
          <TakeawayBox
            ...
            actionPlan="**[Actionable Insight]** [Capex Reallocation] 불확실성이 극심한 원양 어선 건조(Hardware)에 대한 CAPEX 승인을 전면 보류하십시오. 조업 의존형 구조에서 탈피하여, 지중해 및 호주 등지의 최상위 지분 구조를 가진 양식(Ranching/Farming) 인프라 또는 배양 기술(Bio-tech) 스타트업으로 전사적 투자가용자본(Dry Powder)을 전면 이동시켜야 해야 합니다. (Conviction Buy)"
          />
        </div>
      </div>
      ...
      <div className={styles.insightCard}>
        ...
        <div style={{ padding: '0 20px 20px 20px' }}>
          <TakeawayBox
            ...
            actionPlan="**[Actionable Insight]** [Direct-to-Market Expansion] 도쿄 츠키지/토요스 시장을 거치는 기존의 다단계 중간 유통(Middle-man) 구조를 즉각 해체하십시오. 최상급 O-Toro(대뱃살) 등 하이엔드 컷은 항공 냉장(Air-freight) 콜드체인을 통해 두바이, 리야드 등 중동 VVIP 럭셔리 호스피탈리티(Hospitality) 채널로 직결(B2B Direct)하는 고마진 파이프라인을 구축해야 해야 합니다. (Conviction Buy)"
          />
        </div>
      </div>
    </>
      ...
      <div className={styles.insightCard}>
        ...
        <div style={{ padding: '0 20px 20px 20px' }}>
          <TakeawayBox
            ...
            actionPlan="**[Actionable Insight]** [Procurement Risk Mitigation] 조달 원가(COGS) 폭등 리스크가 임박했습니다. 현물(Spot) 시장에서의 단기 매입 비중을 최소화하고, 핵심 선단과의 3~5년 단위 장기 선도계약(Forward Contract) 혹은 상호 지분 스왑(Equity Swap)을 체결하여 원가 변동성을 락인(Lock-in)하는 강력한 헤지 포지션을 구축해야 해야 합니다. (Conviction Buy)"
          />
        </div>
      </div>
      ...
      <div className={styles.insightCard}>
        ...
        <div style={{ padding: '0 20px 20px 20px' }}>
          <TakeawayBox
            ...
            actionPlan="**[Actionable Insight]** [Future-Proof Asset Strategy] 당사의 장기 설비투자(Shipbuilding F/S) 타당성 검토 로직을 전면 수정하십시오. 10년 내용연수를 지닌 신규 참치선망어선(Purse Seiner) 설계 시, 더 이상 축소되는 고위도 어장에 베팅하지 말고, 적도 부근 표층수 열대 어종 대량 포획 및 가공 효율에 최적화된 하드웨어 스펙으로 과감한 피벗(Pivot)을 승인해야 해야 합니다. (Conviction Buy)"
          />
        </div>
      </div>
    </>
      ...
      <div className={styles.insightCard}>
        ...
        <div style={{ padding: '0 20px 20px 20px' }}>
          <TakeawayBox
            ...
            actionPlan="**[Actionable Insight]** [Operational Capex Deployment] 구형 아날로그 선단의 퇴출이 임박했습니다. 즉각 전 선단에 대한 디지털 레트로핏(Retrofit) CAPEX 예산을 승인하십시오. 정밀 조업 시스템 장착은 단순 매입원가(COGS) 절감을 넘어, 다가오는 해운업계 스코프 3(Scope 3) 탄소 배출 규제 페널티를 회피하는 가장 확실한 ESG 재무 헷징 수단입니다."
          />
        </div>
      </div>
      ...
      <div className={styles.insightCard}>
        ...
        <div style={{ padding: '0 20px 20px 20px' }}>
          <TakeawayBox
            ...
            actionPlan="**[Actionable Insight]** [Compliance & Pricing Strategy] 인증 확보는 더 이상 CSR 부서의 마케팅 비용이 아니라, 생존과 초과수익을 가르는 핵심 무형자산(Intangible Asset)입니다. 전 선단 및 가공 라인의 MSC-COC 인증 획득 및 갱신을 전사 최우선 CEO KPI로 락인(Lock-in)하고, 인증 획득에 소요되는 컨설팅 비용을 무제한 승인하여 잉여현금흐름(FCF)을 극대화하십시오. (Strong Buy)"
          />
        </div>
      </div>
      ...
      <div className={styles.insightCard}>
        ...
        <div style={{ padding: '0 20px 20px 20px' }}>
          <TakeawayBox
            ...
            actionPlan="**[Actionable Insight]** [Future Food-Tech M&A] 레거시(Legacy) 어획 산업의 단백질 생산 한계치(Cap)에 도달했습니다. 벤처캐피털(CVC) 조직을 즉각 가동하여 글로벌 세포 배양 수산물 스타트업에 대한 시리즈 A/B 지분 투자를 단행하십시오. 단일 생물 단백질 회사를 넘어 글로벌 \'Alt-Protein\' 포트폴리오를 거느린 푸드테크 지주사로 기업가치(Valuation)를 재평가(Re-rating) 받아야 해야 합니다. (Conviction Buy)"
          />
        </div>
      </div>
      ...
      <div className={styles.insightCard}>
        ...
        <div style={{ padding: '0 20px 20px 20px' }}>
          <TakeawayBox
            ...
            actionPlan="**[Actionable Insight]** [Vertical Integration Execution] 부산물은 폐기물이 아니라 가장 수익성(Profitability) 높은 숨겨진 캐시카우(Hidden Cash-cow)입니다. 어분 라인 매각을 즉시 중단하고, 부산물 원료를 활용한 자체 \'하이엔드 펫 밀(Pet Meal) 팩토리\' 및 바이오-오메가3 추출 설비 구축에 즉각적인 조인트 벤처(JV) 자본을 투입하여 밸류체인 완전 수직 계열화를 달성하여 잉여현금흐름(FCF)을 극대화하십시오. (Strong Buy)"
          />
        </div>
      </div>
    </>
