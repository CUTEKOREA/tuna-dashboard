...
def s1_self_sufficiency_species_gap():
    ...
    return {
        ...
        "sit": "2018년은 생산의 34.3%가 망치고등어였고 공표 자급률 151.1%가 망치고등어를 넣으면 "
               "128.5%로 내려간다. 2023년도 26.3%에 144.1%가 129.3%가 된다. 자급률이 가장 높았던 "
               "두 해가 망치고등어 비중이 가장 컸던 두 해다. 나머지 네 해는 격차가 5%p 안이다.",
        "strat": "종 경계가 분자와 분모에서 다르게 그어진다. 국내생산은 망치고등어를 빼지만 수출은 "
                 "HS 0303540000 한 칸에 세 종이 들어 있어 뺄 수 없다. 같은 조사가 2023년 아프리카 수출 "
                 "급증을 「망치고등어 및 소형어 어획 비중이 높아지면서」로 설명한다. "
                 "자급률 수치를 근거로 국내 수급을 판단하기 전에 어느 종이 세어졌는지 확인해야 한다.",
        "_kpi": {"title": "2018년 자급률 격차", "value": "22.6%p",
                 "trend": "공표 151.1% → 망치 포함 128.5%",
                 "desc": "그해 생산의 34.3%가 통계에서 빠진 망치고등어였다"},
        "_prov": dict(source_id="MOF_DISTRIBUTION_SURVEY", period="2018-2023",
                      inputs=[MOF_SURVEY_2024_PDF], grade="B",
...
def s4_value_chain_domestic_vs_import():
    ...
    return {
        ...
        "data": data, "unit": "%",
        "sit": "국산 어가수취가 소비자가의 40.9%인데 수입산 CFR은 35.2%다. 소매 단계는 국산 36.2, "
               "수입 35.0%로 거의 같다. 소비자가격은 국산 선어 11,830.3원/kg, 수입 냉동 8,290.5원/kg 로 "
               "수입이 국산의 70.1%인데, 이는 선어와 냉동의 차이가 크기 때문이며 같은 염장끼리 견주면 "
               "수입산이 더 비싸다.",
        "strat": "소매 몫은 두 사슬이 거의 같고 생산자 몫은 국산이 오히려 크다. 갈리는 곳은 "
                 "도매·중도매 층이다 — 수입 22.6%p 가 국산 13.3%p 의 1.7배이고, 그 안에서 "
                 "소비지중도매인 한 단계가 17.1%p 로 가장 크며 대부분이 간접비 1,091.9원이다. "
                 "원가를 줄일 여지는 원산지 교체가 아니라 이 층에 있다. 창고 보관료가 90일 기준으로 "
                 "잡혀 있어 회전을 줄이면 붙는 비용도 줄어든다.",
        "_kpi": {"title": "생산자 몫 (2023)", "value": "국산 40.9% vs 수입 35.2%",
                 "trend": "소매 단계는 36.2% vs 35.0% 로 거의 같다",
                 "desc": "소비자가 국산 선어 11,830원 · 수입 냉동 8,290원/kg"},
        "_prov": dict(source_id="MOF_DISTRIBUTION_SURVEY", period="2023",
                      ...
                      note="국산은 표 「고등어(선어)의 유통비용(부산 공동어시장 → 소비지 도매시장)」, "
                           ...
                           "국산 경로에는 소비지중도매 단계가 도매 칸에 합산돼 있어 0으로 뒀다. "
