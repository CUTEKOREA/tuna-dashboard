    ...
    <div className={s.heroStrip}>
      <div className={s.heroHeader}>
        <h2 className={s.heroTitle}>
          ...
          <span style={{ fontSize: '0.75rem', color: 'var(--text-muted)', fontWeight: 500 }}>26.05.31 (일) 기준</span>
        </h2>
      ...
      <div className={s.kpiRow}>
        <div className={`${s.kpiCard} ${s.kpiCardHighlight}`}>
          ...
          <div className={`${s.kpiValue} ${s.kpiValueAccent}`}><CountUp end={2146} duration={2} separator="," /><span className={s.kpiUnit}>톤</span></div>
          <div style={{ fontSize: '0.72rem', color: '#34d399', marginTop: 4 }}>국적선 1,367t + 합작선 779t</div>
        </div>
        <div className={s.kpiCard}>
          <div className={s.kpiLabel}>📅 월간 총 어획량</div>
          <div className={s.kpiValue}><CountUp end={7582} duration={2} separator="," /><span className={s.kpiUnit}>톤</span></div>
          <div style={{ fontSize: '0.72rem', color: 'var(--text-muted)', marginTop: 4 }}>국적선 4,983t + 합작선 2,599t</div>
        </div>
        <div className={s.kpiCard}>
          <div className={s.kpiLabel}>📊 연간 총 어획량</div>
          <div className={s.kpiValue}><CountUp end={33412} duration={2.5} separator="," /><span className={s.kpiUnit}>톤</span></div>
          <div style={{ fontSize: '0.72rem', color: 'var(--text-muted)', marginTop: 4 }}>국적선 21,510t + 합작선 11,902t</div>
        </div>
      </div>
