...
export default function SasKoreaMajorCompanies() {
  return (
    <WidgetCard
      ...
      takeaway={{
        situation: '한국 참치 산업은 동원그룹(동원산업 8.94조 + 동원F&B 4.48조)이 수출 점유율 49.2%로 뚜렷한 1위입니다. 순수 사시미 전문 기업은 사조씨푸드(수출 541억 > 내수 240억)와 동원수산(365억)으로, 두 기업 모두 수출 의존도가 높습니다. 사조산업은 영업적자(-94억)로 구조조정 압력을 받고 있습니다.',
