...
export default function SasUsImportBarriers() {
  return (
    <WidgetCard
      ...
      takeaway={{
        situation: "미국향 사시미·스테이크 참치는 단일 관세가 아니라 3중 규제 관문을 통과해야 진입합니다. ① 수산물수입모니터링제도(SIMP) — 사시미급 참치 5종(빅아이·황다랑어·날개·가다랑어·참다랑어, 가다랑어는 통조림·로인 중심)이 이력추적 의무 대상으로 어획~수입 이력을 24개월 보존해야 합니다. ② FDA 메틸수은 1.0ppm은 조치기준(action level)으로, 초과 시 부적합(어덜터레이티드) 간주 대상입니다(대형 빅아이 노출 위험). ③ 히스타민은 2024년 분해 조치기준이 50→35ppm으로 강화돼 콜드체인이 깨지면 거부 위험이 큽니다. 수산물은 FDA 수입거부 상위 식품군으로, 미국 농무부 경제연구소(USDA ERS) 2005~2013년 분석 기준 전체 거부의 약 20%로 1위였습니다(최신 연도 갱신 미확인).",
        ...
        source: "FDA Action Levels(메틸수은 1.0ppm 조치기준) / FDA CPG Sec 540.525 Final(히스타민 분해 35ppm·위해 200ppm 조치기준, 2024-11-04 Federal Register 2024-25315) / NOAA SIMP Compliance Guide(2024, 24개월=50 CFR §300.324(e)) / FDA 수입거부 약 20%·1위는 미국 농무부 경제연구소(USDA ERS) 2005~2013 분석 기준(최신 연도 미갱신)",
      }}
      customBody={
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', width: '100%' }}>
          ...
          <div style={{
            ...
            <span style={{ fontSize: '0.72rem', color: '#e2e8f0', fontWeight: 600 }}>수산물 = FDA 수입거부 상위 식품군</span>
            <span style={{ fontSize: '0.88rem', fontWeight: 800, color: '#f87171' }}>약 20%·1위 (USDA ERS 2005~2013 기준)</span>
          </div>
